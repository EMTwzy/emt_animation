...
var Hu = Te((a0, Wu) => {
    var Vu = pt(), zr = ju(), qu = Vu.process, Mu = Vu.Deno, Ru = qu && qu.versions || Mu && Mu.version,
        $u = Ru && Ru.v8, dt, cr;
    $u && (dt = $u.split("."), cr = dt[0] > 0 && dt[0] < 4 ? 1 : +(dt[0] + dt[1]));
    !cr && zr && (dt = zr.match(/Edge\/(\d+)/), (!dt || dt[1] >= 74) && (dt = zr.match(/Chrome\/(\d+)/), dt && (cr = +dt[1])));
    Wu.exports = cr
});
var Xr = Te((o0, Uu) => {
    var Gu = Hu(), Qo = Dt();
...
var bt = Te((F0, ds) => {
    var bl = pt(), Tl = tn(), ps = Ct(), Bl = rn(), fs = Xr(), ms = Kr(), Pt = Tl("wks"), xt = bl.Symbol,
        Ds = xt && xt.for, Nl = ms ? xt : xt && xt.withoutSetter || Bl;
...
var vs = Te((A0, hs) => {
    ...
    hs.exports = function (e, r) {
        ...
        var t = _l(e, Ll), s;
        if (t) {
            if (r === void 0 && (r = "default"), s = wl(t, e, r), !gs(s) || ys(s)) return s;
...
var sn = Te(bs => {
    var Wl = yt(), Hl = At(), Gl = gu(), Ul = ar(), Jl = lr(), zl = gr(), Xl = Ct(), Kl = un(),
...
var It = Te(_s => {
    var rc = yt(), nc = un(), uc = Bs(), yr = Tt(), ws = gr(), sc = TypeError, an = Object.defineProperty,
        ic = Object.getOwnPropertyDescriptor, on = "enumerable", ln = "configurable", cn = "writable";
    _s.f = rc ? uc ? function (r, t, s) {
        if (yr(r), t = ws(t), yr(s), typeof r == "function" && t === "prototype" && "value" in s && cn in s && !s[cn]) {
            var a = ic(r, t);
            a && a[cn] && (r[t] = s.value, s = {
                configurable: ln in s ? s[ln] : a[ln],
                enumerable: on in s ? s[on] : a[on],
                writable: !1
            })
        }
        return an(r, t, s)
    } : an : function (r, t, s) {
        if (yr(r), t = ws(t), yr(s), nc) try {
            return an(r, t, s)
        } catch {
        }
...
var Ls = Te((P0, ks) => {
    var fn = yt(), cc = Ct(), Is = Function.prototype, pc = fn && Object.getOwnPropertyDescriptor, Dn = cc(Is, "name"),
        fc = Dn && function () {
...
var Js = Te((j0, Us) => {
    var Ec = Ms(), Gs = pt(), Fc = St(), Ac = pn(), yn = Ct(), hn = mr(), Sc = Vs(), xc = gn(),
        Hs = "Object already initialized", vn = Gs.TypeError, bc = Gs.WeakMap, hr, Wt, vr, Tc = function (e) {
            return vr(e) ? Wt(e) : hr(e, {})
        }, Bc = function (e) {
            return function (r) {
                var t;
                if (!Fc(r) || (t = Wt(r)).type !== e) throw vn("Incompatible receiver, " + e + " required");
                return t
            }
        };
    Ec || hn.state ? (gt = hn.state || (hn.state = new bc), gt.get = gt.get, gt.has = gt.has, gt.set = gt.set, hr = function (e, r) {
        if (gt.has(e)) throw vn(Hs);
        return r.facade = e, gt.set(e, r), r
    }, Wt = function (e) {
        return gt.get(e) || {}
    }, vr = function (e) {
        return gt.has(e)
    }) : (Bt = Sc("state"), xc[Bt] = !0, hr = function (e, r) {
        if (yn(e, Bt)) throw vn(Hs);
    ...
    var gt, Bt;
    Us.exports = {set: hr, get: Wt, has: vr, enforce: Tc, getterFor: Bc}
});
var En = Te((q0, Xs) => {
    var Nc = Dt(), wc = ot(), Cr = Ct(), Cn = yt(), _c = Ls().CONFIGURABLE, Pc = dn(), zs = Js(), Ic = zs.enforce,
        kc = zs.get, Er = Object.defineProperty, Lc = Cn && !Nc(function () {
            return Er(function () {
            }, "length", {value: 8}).length !== 8
        }), Oc = String(String).split("String"), jc = Xs.exports = function (e, r, t) {
            String(r).slice(0, 7) === "Symbol(" && (r = "[" + String(r).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), t && t.getter && (r = "get " + r), t && t.setter && (r = "set " + r), (!Cr(e, "name") || _c && e.name !== r) && (Cn ? Er(e, "name", {
                value: r,
                configurable: !0
            }) : e.name = r), Lc && t && Cr(t, "arity") && e.length !== t.arity && Er(e, "length", {value: t.arity});
            try {
...
var Ys = Te((M0, Ks) => {
    ...
    Ks.exports = function (e, r, t, s) {
        ...
        if (qc(t) && Rc(t, n, s), s.global) a ? e[r] = t : $c(r, t); else {
            try {
...
var oi = Te((G0, ai) => {
    ...
    ai.exports = {includes: ii(!0), indexOf: ii(!1)}
});
var pi = Te((U0, ci) => {
...
var vi = Te((K0, hi) => {
    var ap = $t(), op = mt(), lp = di(), cp = yi(), pp = Tt(), fp = op([].concat);
...
var Si = Te((Q0, Ai) => {
    var gp = Dt(), yp = ot(), hp = /#|\.prototype\./, Ht = function (e, r) {
        var t = Cp[vp(e)];
        return t == Fp ? !0 : t == Ep ? !1 : yp(r) ? gp(r) : !!r
...
var bn = Te((uy, ki) => {
    ...
    var jp = Sn(), qp = kt(), Mp = Bi(), Rp = xn(), Ii = function (e, r, t, s, a, n, u, i) {
        for (var l = a, p = 0, d = u ? Rp(u, i) : !1, y, g; p < s;) p in t && (y = d ? d(t[p], p, r) : t[p], n > 0 && jp(y) ? (g = qp(y), l = Ii(e, r, y, g, l, n - 1) - 1) : (Mp(l + 1), e[l] = y), l++), p++;
        return l
    };
    ki.exports = Ii
});
...
var Tn = Te((iy, qi) => {
    var Wp = ji(), Hp = ot(), Ar = Rt(), Gp = bt(), Up = Gp("toStringTag"), Jp = Object, zp = Ar(function () {
        return arguments
...
var Hi = Te((ay, Wi) => {
    var Kp = mt(), Yp = Dt(), Mi = ot(), Qp = Tn(), Zp = $t(), ef = dn(), Ri = function () {
        }, tf = [], $i = Zp("Reflect", "construct"), Bn = /^\s*(?:class|function)\b/, rf = Kp(Bn.exec), nf = !Bn.exec(Ri),
        Ut = function (r) {
            if (!Mi(r)) return !1;
            try {
                return $i(Ri, tf, r), !0
...
var ca = Te((dy, la) => {
    var If = xn(), kf = At(), Lf = Tt(), Of = pr(), jf = Qi(), qf = kt(), ia = Jr(), Mf = ra(), Rf = _n(), aa = sa(),
        $f = TypeError, Sr = function (e, r) {
            this.stopped = e, this.result = r
        }, oa = Sr.prototype;
    la.exports = function (e, r, t) {
        var s = t && t.that, a = !!(t && t.AS_ENTRIES), n = !!(t && t.IS_RECORD), u = !!(t && t.IS_ITERATOR),
            i = !!(t && t.INTERRUPTED), l = If(r, s), p, d, y, g, c, f, E, _ = function (F) {
                return p && aa(p, "normal", F), new Sr(!0, F)
            }, w = function (F) {
        ...
        if (n) p = e.iterator; else if (u) p = e; else {
            ...
            if (jf(d)) {
                for (y = 0, g = qf(e); g > y; y++) if (c = w(e[y]), c && ia(oa, c)) return c;
                return new Sr(!1)
            }
            p = Mf(e, d)
        }
        for (f = n ? e.next : p.next; !(E = kf(f, p)).done;) {
            ...
            if (typeof c == "object" && c && ia(oa, c)) return c
        }
        return new Sr(!1)
    }
});
...
var da = Te((yy, ma) => {
    ...
    ma.exports = function (e, r, t) {
        return t.get && Da(t.get, r, {getter: !0}), t.set && Da(t.set, r, {setter: !0}), zf.f(e, r, t)
    }
});
var ya = Te((hy, ga) => {
    "use strict";
...
var Ca = Te(() => {
    var rD = Gt(), Pn = pt();
    rD({global: !0, forced: Pn.globalThis !== Pn}, {globalThis: Pn})
});
var cf = Gt(), pf = bn(), ff = Vt(), Df = dr(), mf = kt(), df = Nn();
cf({target: "Array", proto: !0}, {
    flatMap: function (r) {
...
var Kf = pt(), Yf = yt(), Qf = da(), Zf = ya(), eD = Dt(), ha = Kf.RegExp, va = ha.prototype,
    tD = Yf && eD(function () {
        var e = !0;
        try {
            ha(".", "d")
...
var DD = Object.create, Nr = Object.defineProperty, mD = Object.getOwnPropertyDescriptor,
    Vn = Object.getOwnPropertyNames, dD = Object.getPrototypeOf, gD = Object.prototype.hasOwnProperty,
    ht = (e, r) => function () {
        return e && (r = (0, e[Vn(e)[0]])(e = 0)), r
    }, te = (e, r) => function () {
        return r || (0, e[Vn(e)[0]])((r = {exports: {}}).exports, r), r.exports
    }, zt = (e, r) => {
        for (var t in r) Nr(e, t, {get: r[t], enumerable: !0})
    }, Sa = (e, r, t, s) => {
        if (r && typeof r == "object" || typeof r == "function") for (let a of Vn(r)) !gD.call(e, a) && a !== t && Nr(e, a, {
            get: () => r[a],
            enumerable: !(s = mD(r, a)) || s.enumerable
        });
        return e
    }, yD = (e, r, t) => (t = e != null ? DD(dD(e)) : {}, Sa(r || !e || !e.__esModule ? Nr(t, "default", {
        value: e,
        enumerable: !0
    }) : t, e)), ft = e => Sa(Nr({}, "__esModule", {value: !0}), e), Nt, ne = ht({
        "<define:process>"() {
            Nt = {env: {}, argv: []}
        }
    }), xa = te({
        ...
        "node_modules/diff/lib/diff/base.js"(e) {
            ...
            r.prototype = {
                diff: function (n, u) {
                    ...
                    var y = u.length, g = n.length, c = 1, f = y + g, E = [{newPos: -1, components: []}],
                        _ = this.extractCommon(E[0], u, n, 0);
                    if (E[0].newPos + 1 >= y && _ + 1 >= g) return d([{value: this.join(u), count: u.length}]);
                    ...
                    function w() {
                        for (var N = -1 * c; N <= c; N += 2) {
                            ...
                            if (!D || T && I.newPos < P.newPos ? (x = s(P), p.pushComponent(x.components, void 0, !0)) : (x = I, x.newPos++, p.pushComponent(x.components, !0, void 0)), $ = p.extractCommon(x, u, n, N), x.newPos + 1 >= y && $ + 1 >= g) return d(t(p, x.components, u, n, p.useLongestToken));
                            E[N] = x
                        }
                        c++
                    }
        ...
        "src/document/doc-builders.js"(e, r) {
            ...
            var f = {type: "line-suffix-boundary"}, E = {type: "break-parent"}, _ = {type: "trim"},
                w = {type: "line", hard: !0}, F = {type: "line", hard: !0, literal: !0}, N = {type: "line"},
                x = {type: "line", soft: !0}, I = t([w, E]), P = t([F, E]),
            ...
            r.exports = {
                ...
                literallineWithoutBreakParent: F,
                label: m
            }
        }
    }), Hn = te({
...
var Ta, BD = ht({
    ...
    "src/document/doc-utils.js"(e, r) {
        "use strict";
        ne();
        var t = lt(), {literalline: s, join: a} = Wn(), n = o => Array.isArray(o) || o && o.type === "concat",
            u = o => {
        ...
        function l(o, h, v, S) {
            ...
            for (; b.length > 0;) {
                ...
                if (v && b.push(B, i), !h || h(B) !== !1) if (n(B) || B.type === "fill") {
                    let k = u(B);
                    for (let M = k.length, R = M - 1; R >= 0; --R) b.push(k[R])
                } else if (B.type === "if-break") B.flatContents && b.push(B.flatContents), B.breakContents && b.push(B.breakContents); else if (B.type === "group" && B.expandedStates) if (S) for (let k = B.expandedStates.length, M = k - 1; M >= 0; --M) b.push(B.expandedStates[M]); else b.push(B.contents); else B.contents && b.push(B.contents)
            }
        }
...
`)).parts
    ...
    "src/document/doc-printer.js"(e, r) {
        "use strict";
        ne();
        var {convertEndOfLineToChars: t} = Hn(), s = lt(), a = Ba(), {
            fill: n,
            cursor: u,
            indent: i
        } = Wn(), {isConcat: l, getDocParts: p} = Xt(), d, y = 1, g = 2;
        ...
        function E(x, I, P) {
            return I === Number.NEGATIVE_INFINITY ? x.root || c() : I < 0 ? _(x, {type: "dedent"}, P) : I ? I.type === "root" ? Object.assign(Object.assign({}, x), {}, {root: x}) : _(x, {
        ...
        function F(x, I, P, $, D) {
            ...
            for (; P >= 0;) {
                ...
                if (typeof h == "string") C.push(h), P -= a(h); else if (l(h) || h.type === "fill") {
                    let v = p(h);
        ...
        function N(x, I) {
            d = {};
            let P = I.printWidth, $ = t(I.endOfLine), D = 0, T = [{ind: c(), mode: y, doc: x}], m = [], C = !1, o = [];
            for (; T.length > 0;) {
...
` ? b.replace(/\n/g, $) : b;
                    ...
                    case"group":
                        switch (S) {
                            ...
                            case y: {
                                ...
                                if (!b.break && F(B, T, k, M)) T.push(B); else if (b.expandedStates) {
                    ...
                    case"fill": {
                        let B = P - D, {parts: k} = b;
                        if (k.length === 0) break;
                        let [M, R] = k, q = {ind: v, mode: g, doc: M}, J = {ind: v, mode: y, doc: M},
                            L = F(q, [], B, o.length > 0, !0);
                        if (k.length === 1) {
                            L ? T.push(q) : T.push(J);
                            break
                        }
            ...
            if (h !== -1) {
                let v = m.indexOf(u.placeholder, h + 1), S = m.slice(0, h).join(""), b = m.slice(h + 1, v).join(""),
                    B = m.slice(v + 1).join("");
    ...
    "src/document/doc-debug.js"(e, r) {
        ...
        function a(u) {
            ...
            return u.type === "if-break" ? Object.assign(Object.assign({}, u), {}, {
                ...
                type: "fill",
                parts: u.parts.map(a)
            } : u.contents ? Object.assign(Object.assign({}, u), {}, {contents: a(u.contents)}) : u
        }

        function n(u) {
            let i = Object.create(null), l = new Set;
            return p(a(u));
...
var PD = ht({
    ...
    "node_modules/semver/internal/parse-options.js"(e, r) {
        ...
        var t = ["includePrerelease", "loose", "rtl"],
            s = a => a ? typeof a != "object" ? {loose: !0} : t.filter(n => a[n]).reduce((n, u) => (n[u] = !0, n), {}) : {};
        r.exports = s
    }
}), LD = te({
    ...
    "node_modules/semver/classes/semver.js"(e, r) {
        ne();
        var t = wa(), {MAX_LENGTH: s, MAX_SAFE_INTEGER: a} = _a(), {re: n, t: u} = ID(),
            i = kD(), {compareIdentifiers: l} = LD(), p = class {
                constructor(d, y) {
    ...
    "node_modules/outdent/lib/index.js"(e, r) {
        ...
        function a() {
            return {
                add: t, delete: t, get: t, set: t, has: function (F) {
                    return !1
                }
            }
        }
        ...
        function c(F, N, x) {
            ...
            var $ = "(\\r\\n|\\r|\\n).{0," + I + "}", D = new RegExp($, "g");
            N && (F = F.slice(1));
            var T = x.newline, m = x.trimLeadingNewline, C = x.trimTrailingNewline, o = typeof T == "string",
                h = F.length, v = F.map(function (S, b) {
        ...
        function _(F) {
            ...
            function I($) {
                ...
                if (E($)) {
                    var m = $, C = (D[0] === I || D[0] === w) && g.test(m[0]) && d.test(m[1]), o = C ? x : N,
                        h = o.get(m);
    ...
    "src/main/core-options.js"(e, r) {
        "use strict";
        ne();
        var {outdent: t} = RD(), s = "Config", a = "Editor", n = "Format", u = "Other", i = "Output", l = "Global",
            p = "Special", d = {
                cursorOffset: {
                    since: "1.4.0",
                    category: p,
    ...
    `,
        ...
        `
                ...
                pluginSearchDirs: {
                    since: "1.13.0", type: "path", array: !0, default: [{value: []}], category: l, description: t`
      Custom directory that contains prettier plugins in node_modules subdirectory.
      Overrides default behavior when plugins are searched relatively to the location of Prettier.
      Multiple values are accepted.
    `, exception: y => typeof y == "string" || typeof y == "object", cliName: "plugin-search-dir", cliCategory: s
                },
                printWidth: {
                    since: "0.0.0",
                    category: l,
    ...
    `,
                ...
                requirePragma: {
                    since: "1.7.0", category: p, type: "boolean", default: !1, description: t`
    ...
    "src/main/support.js"(e, r) {
        ...
        function u() {
            let {
                    ...
                    showDeprecated: d = !1,
                    showInternal: y = !1
                } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, g = a.split("-", 1)[0],
                c = l.flatMap(F => F.languages || []).filter(E), f = s(Object.assign({}, ...l.map(F => {
                    let {options: N} = F;
                    return N
                }), n), "name").filter(F => E(F) && _(F)).sort((F, N) => F.name === N.name ? 0 : F.name < N.name ? -1 : 1).map(w).map(F => {
                    F = Object.assign({}, F), Array.isArray(F.default) && (F.default = F.default.length === 1 ? F.default[0].value : F.default.filter(E).sort((x, I) => t.compare(I.since, x.since))[0].value), Array.isArray(F.choices) && (F.choices = F.choices.filter(x => E(x) && _(x)), F.name === "parser" && i(F, c, l));
        ...
        function i(l, p, d) {
            ...
            for (let g of p) if (g.parsers) {
                for (let c of g.parsers) if (!y.has(c)) {
                    y.add(c);
                    let f = d.find(_ => _.parsers && _.parsers[c]), E = g.name;
...
` || i === "\r" || i === "\u2028" || i === "\u2029") return a + 1
    ...
    "src/common/util.js"(e, r) {
        "use strict";
        ne();
        var {default: t} = (PD(), ft(Na)), s = lt(), {getSupportInfo: a} = Un(), n = Jn(), u = Ba(), {
            skipWhitespace: i,
            skipSpaces: l,
            skipToLineEnd: p,
            skipEverythingButNewLine: d
        } = wr(), y = Pa(), g = Ia(), c = ka(), f = VD(), E = V => V[V.length - 2];
        ...
        function w(V, j) {
            let Y = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
                ie = l(V, Y.backwards ? j - 1 : j, Y), ee = c(V, ie, Y);
            return ie !== ee
        }
...
`) return !0;
        ...
        function N(V, j, Y) {
            let ie = Y(j) - 1;
            ie = l(V, ie, {backwards: !0}), ie = c(V, ie, {backwards: !0}), ie = l(V, ie, {backwards: !0});
            let ee = c(V, ie, {backwards: !0});
            return ie !== ee
        }
...
`);
        ...
        function C(V, j) {
            let Y = {quote: '"', regex: /"/g, escaped: "&quot;"}, ie = {quote: "'", regex: /'/g, escaped: "&apos;"},
                ee = j === "'" ? ie : Y, ce = ee === ie ? Y : ie, W = ee;
...
var Ea, _r, Ln, On, Va, Wa, WD = ht({
    "node-modules-polyfills:path"() {
        ne(), Ea = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/, _r = function (e) {
            ...
            normalize: zn,
            resolve: Br
        }, Wa = "ab".substr(-1) === "b" ? function (e, r, t) {
            return e.substr(r, t)
        } : function (e, r, t) {
...
var br, Tr, Et = ht({
    ...
    "node_modules/vnopts/lib/descriptors/api.js"(e) {
        "use strict";
        ne(), Object.defineProperty(e, "__esModule", {value: !0}), e.apiDescriptor = {
    ...
    "node_modules/vnopts/node_modules/leven/index.js"(e, r) {
        ...
        r.exports = function (a, n) {
            ...
            for (var d, y, g, c, f = 0, E = 0; f < i;) s[p + f] = a.charCodeAt(p + f), t[f] = ++f;
            for (; E < l;) for (d = n.charCodeAt(p + E), g = E++, y = E, f = 0; f < i; f++) c = d === s[p + f] ? g : g + 1, g = t[f], y = t[f] = g > y ? c > y ? y + 1 : c : c > g ? g + 1 : c;
            return y
        }
    }
}), za = te({
    "node_modules/vnopts/lib/handlers/unknown/leven.js"(e) {
        ...
        e.levenUnknownHandler = (s, a, n) => {
            let {descriptor: u, logger: i, schemas: l} = n,
                p = [`Ignored unknown option ${r.default.yellow(u.pair({key: s, value: a}))}.`],
                d = Object.keys(l).sort().find(y => t(s, y) < 3);
    ...
    "node_modules/vnopts/lib/utils.js"(e) {
        ...
        function r(c, f) {
            ...
            for (let _ of c) {
                let w = _[f];
                if (E[w]) throw new Error(`Duplicate ${f} ${JSON.stringify(w)}`);
                E[w] = _
            }
            return E
        }
        ...
        function t(c, f) {
            ...
            for (let _ of c) {
                let w = _[f];
                if (E.has(w)) throw new Error(`Duplicate ${f} ${JSON.stringify(w)}`);
                E.set(w, _)
            }
            return E
        }
        ...
        function a(c, f) {
            let E = [], _ = [];
            for (let w of c) f(w) ? E.push(w) : _.push(w);
            return [E, _]
        }
        ...
        function p(c, f) {
            ...
            return c === !1 ? !1 : c === !0 ? E ? !0 : [{value: f}] : "value" in c ? [c] : c.length === 0 ? !1 : c
        }

        e.normalizeDeprecatedResult = p;

        function d(c, f) {
            return typeof c == "string" || "key" in c ? {from: f, to: c} : "from" in c ? {
                from: c.from,
                to: c.to
            } : {from: f, to: c.to}
        }
        ...
        function y(c, f) {
            return c === void 0 ? [] : Array.isArray(c) ? c.map(E => d(E, f)) : [d(c, f)]
        }

        e.normalizeForwardResult = y;

        function g(c, f) {
            let E = y(typeof c == "object" && "redirect" in c ? c.redirect : c, f);
            return E.length === 0 ? {
                remain: f,
                redirect: E
            } : typeof c == "object" && "remain" in c ? {remain: c.remain, redirect: E} : {redirect: E}
        }
        ...
        var s = class {
            constructor(a, n) {
                let {
                    ...
                    deprecated: d = r.defaultDeprecatedHandler
                } = n || {};
                this._utils = {
                    descriptor: i,
                    logger: u || {
            ...
            _applyNormalization(a, n) {
                ...
                for (let p of i) {
                    let d = this._utils.schemas[p], y = d.preprocess(a[p], this._utils),
                        g = t.normalizeValidateResult(d.validate(y, this._utils), y);
                    if (g !== !0) {
                    ...
                    let c = w => {
                        ...
                        let {value: F, redirectTo: N} = w,
                            x = t.normalizeDeprecatedResult(d.deprecated(F, this._utils), y, !0);
                        if (x !== !1) if (x === !0) this._hasDeprecationWarned(p) || this._utils.logger.warn(this._deprecatedHandler(p, N, this._utils)); else for (let {value: I} of x) {
                            let P = {key: p, value: I};
    ...
    "src/main/options-normalizer.js"(e, r) {
        ...
        ne();
        var t = bm(), s = lt(), a = {
            key: g => g.length === 1 ? `-${g}` : `--${g}`, value: g => t.apiDescriptor.value(g), pair: g => {
                let {key: c, value: f} = g;
        ...
        function i(g, c) {
            let {
                    ...
                    passThrough: _ = !1,
                    colorsModule: w = null,
                    levenshteinDistance: F = null
                } = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
                N = _ ? Array.isArray(_) ? (T, m) => _.includes(T) ? {[T]: m} : void 0 : (T, m) => ({[T]: m}) : (T, m, C) => {
                    let o = C.schemas, {_: h} = o, v = $n(o, cD);
                    return t.levenUnknownHandler(T, m, Object.assign(Object.assign({}, C), {}, {schemas: v}))
                }, x = E ? a : t.apiDescriptor, I = l(c, {isCLI: E, colorsModule: w, levenshteinDistance: F}),
                P = new t.Normalizer(I, {logger: f, unknown: N, descriptor: x}), $ = f !== !1;
            $ && u && (P._hasDeprecationWarned = u);
            let D = P.normalize(g);
            return $ && (u = P._hasDeprecationWarned), E && D["plugin-search"] === !1 && (D["plugin-search-dir"] = !1), D
        }

        function l(g, c) {
            let {isCLI: f, colorsModule: E, levenshteinDistance: _} = c, w = [];
            f && w.push(t.AnySchema.create({name: "_"}));
            for (let F of g) w.push(p(F, {
                isCLI: f,
                optionInfos: g,
                colorsModule: E,
                levenshteinDistance: _
            })), F.alias && f && w.push(t.AliasSchema.create({name: F.alias, sourceName: F.name}));
            return w
        }

        function p(g, c) {
            let {isCLI: f, optionInfos: E, colorsModule: _, levenshteinDistance: w} = c, {name: F} = g;
            if (F === "plugin-search-dir" || F === "pluginSearchDirs") return t.AnySchema.create({
                name: F,
                preprocess(P) {
            ...
            switch (g.type) {
                ...
                case"flag":
                    ...
                    }), N.flags = E.flatMap(P => [P.alias, P.description && P.name, P.oppositeDescription && `no-${P.name}`].filter(Boolean));
                    break;
                case"path":
                    x = t.StringSchema;
                    break;
        ...
        function y(g, c, f) {
            return i(g, c, Object.assign({isCLI: !0}, f))
        }
    ...
    "src/language-js/loc.js"(e, r) {
        ...
        function s(l) {
            var p, d;
            let y = l.range ? l.range[0] : l.start,
                g = (p = (d = l.declaration) === null || d === void 0 ? void 0 : d.decorators) !== null && p !== void 0 ? p : l.decorators;
    ...
    "scripts/build/shims/babel-highlight.cjs"(e, r) {
        "use strict";
        ne();
        var t = Pr(), s = {shouldHighlight: () => !1, getChalk: () => t};
        r.exports = s
    }
}), wm = te({
    "node_modules/@babel/code-frame/lib/index.js"(e) {
        ...
        function n(l, p, d) {
            let y = Object.assign({column: 0, line: -1}, l.start), g = Object.assign({}, y, l.end), {
                    linesAbove: c = 2,
                    linesBelow: f = 3
                } = d || {}, E = y.line, _ = y.column, w = g.line, F = g.column, N = Math.max(E - (c + 1), 0),
                x = Math.min(p.length, w + f);
            E === -1 && (N = 0), w === -1 && (x = p.length);
            let I = w - E, P = {};
            if (I) for (let $ = 0; $ <= I; $++) {
                let D = $ + E;
                if (!_) P[D] = !0; else if ($ === 0) {
                    let T = p[D - 1].length;
                    P[D] = [_, T - _ + 1]
                } else if ($ === I) P[D] = [0, F]; else {
                    let T = p[D - $].length;
                    P[D] = [0, T]
                }
            } else _ === F ? _ ? P[E] = [_, 0] : P[E] = !0 : P[E] = [_, F - _];
            return {start: N, end: x, markerLines: P}
        }

        function u(l, p) {
            let d = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
                y = (d.highlightCode || d.forceColor) && (0, r.shouldHighlight)(d), g = (0, r.getChalk)(d), c = s(g),
                f = ($, D) => y ? $(D) : D, E = l.split(a), {start: _, end: w, markerLines: F} = n(p, E, d),
                N = p.start && typeof p.start.column == "number", x = String(w).length,
                P = (y ? (0, r.default)(l, d) : l).split(a, w).slice(_, w).map(($, D) => {
...
${P}`), y ? g.reset(P) : P
        ...
        function i(l, p, d) {
            ...
            if (!t) {
                ...
                if (Nt.emitWarning) Nt.emitWarning(c, "DeprecationWarning"); else {
                    let f = new Error(c);
    ...
    "src/main/parser.js"(e, r) {
        "use strict";
        ne();
        var {ConfigError: t} = Kt(), s = ut(), a = Bm(), {locStart: n, locEnd: u} = s, i = Object.getOwnPropertyNames,
            l = Object.getOwnPropertyDescriptor;

        function p(g) {
            let c = {};
            for (let f of g.plugins) if (f.parsers) for (let E of i(f.parsers)) Object.defineProperty(c, E, l(f.parsers, E));
            return c
        }
        ...
        function y(g, c) {
            let f = p(c), E = Object.defineProperties({}, Object.fromEntries(Object.keys(f).map(w => [w, {
                enumerable: !0, get() {
                    return f[w].parse
                }
            }]))), _ = d(c, f);
...
` + w.codeFrame, w
    ...
    "src/main/options.js"(e, r) {
        "use strict";
        ne();
        var t = HD(), {UndefinedParserError: s} = Kt(), {getSupportInfo: a} = Un(), n = Tm(), {resolveParser: u} = Qn(),
            i = {astFormat: "estree", printer: {}, originalText: void 0, locStart: null, locEnd: null};

        function l(y) {
            let g = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, c = Object.assign({}, y),
                f = a({plugins: y.plugins, showUnreleased: !0, showDeprecated: !0}).options,
                E = Object.assign(Object.assign({}, i), Object.fromEntries(f.filter(x => x.default !== void 0).map(x => [x.name, x.default])));
            if (!c.parser) {
                if (!c.filepath) (g.logger || console).warn("No parser and no filepath given, using 'babel' the parser now but this will throw an error in the future. Please specify a parser or a filepath so one can be inferred."), c.parser = "babel"; else if (c.parser = d(c.filepath, c.plugins), !c.parser) throw new s(`No parser could be inferred for file: ${c.filepath}`)
            }
            let _ = u(n.normalizeApiOptions(c, [f.find(x => x.name === "parser")], {passThrough: !0, logger: !1}));
            c.astFormat = _.astFormat, c.locEnd = _.locEnd, c.locStart = _.locStart;
            let w = p(c);
            c.printer = w.printers[c.astFormat];
            let F = Object.fromEntries(f.filter(x => x.pluginDefaults && x.pluginDefaults[w.name] !== void 0).map(x => [x.name, x.pluginDefaults[w.name]])),
                N = Object.assign(Object.assign({}, E), F);
        ...
        function d(y, g) {
            let c = t.basename(y).toLowerCase(),
                E = a({plugins: g}).languages.filter(_ => _.since !== null).find(_ => _.extensions && _.extensions.some(w => c.endsWith(w)) || _.filenames && _.filenames.some(w => w.toLowerCase() === c));
    ...
    "src/main/comments.js"(e, r) {
        ...
        function I(k, M, R, q) {
            ...
            let J = [], {locStart: L, locEnd: Q, printer: {handleComments: V = {}}} = q, {
                avoidAstMutation: j,
                ownLine: Y = x,
                endOfLine: ie = x,
                remaining: ee = x
            } = V, ce = k.map((W, K) => Object.assign(Object.assign({}, N(M, W, q)), {}, {
                comment: W,
                text: R,
                options: q,
                ast: M,
            ...
            for (let [W, K] of ce.entries()) {
                ...
                let ge;
                if (j ? ge = [K] : (de.enclosingNode = Fe, de.precedingNode = ue, de.followingNode = z, ge = [de, U, Z, se, fe]), $(U, Z, ce, W)) de.placement = "ownLine", Y(...ge) || (z ? f(z, de) : ue ? _(ue, de) : E(Fe || se, de)); else if (D(U, Z, ce, W)) de.placement = "endOfLine", ie(...ge) || (ue ? _(ue, de) : z ? f(z, de) : E(Fe || se, de)); else if (de.placement = "remaining", !ee(...ge)) if (ue && z) {
                    let he = J.length;
                    he > 0 && J[he - 1].followingNode !== z && T(J, U, Z), J.push(K)
                } else ue ? _(ue, de) : z ? f(z, de) : E(Fe || se, de)
            }
        ...
        function T(k, M, R) {
            let q = k.length;
            if (q === 0) return;
            let {precedingNode: J, followingNode: L, enclosingNode: Q} = k[0],
                V = R.printer.getGapRegex && R.printer.getGapRegex(Q) || /^[\s(]*$/, j = R.locStart(L), Y;
            for (Y = q; Y > 0; --Y) {
        ...
        function o(k, M) {
            ...
            if (J.isBlockComment && J.isBlockComment(R)) {
                let ie = d(L, V(R)) ? d(L, Q(R), {backwards: !0}) ? a : s : " ";
                q.push(ie)
            } else q.push(a);
            let Y = y(L, g(L, V(R)));
            return Y !== !1 && d(L, Y) && q.push(a), q
        }

        function h(k, M) {
            let R = k.getValue(), q = m(k, M), {printer: J, originalText: L, locStart: Q} = M,
                V = J.isBlockComment && J.isBlockComment(R);
            if (d(L, Q(R), {backwards: !0})) {
                let Y = c(L, R, Q);
                return i([a, Y ? a : "", q])
            }
            let j = [" ", q];
    ...
    "src/common/ast-path.js"(e, r) {
        ...
        var n = class {
            ...
            callParent(u) {
                let i = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, l = a(this.stack, i + 1),
                    p = this.stack.splice(l + 1), d = u(this);
    ...
    "src/main/multiparser.js"(e, r) {
        ...
        function u(i, l, p, d) {
            let {stripTrailingHardline: y = !1} = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : {},
                g = s(Object.assign(Object.assign(Object.assign({}, p), l), {}, {
                    parentParser: p.parser,
                    originalText: i
                }), {passThrough: !0}), c = Qn().parse(i, g), {ast: f} = c;
            i = c.text;
            let E = f.comments;
            delete f.comments, a.attach(E, f, i, g), g[Symbol.for("comments")] = E || [], g[Symbol.for("tokens")] = f.tokens || [];
            let _ = d(f, g);
    ...
    "src/main/ast-to-doc.js"(e, r) {
        ...
        function p(y, g) {
            let {originalText: c, [Symbol.for("comments")]: f, locStart: E, locEnd: _} = g, w = E(y), F = _(y),
                N = new Set;
            for (let x of f) E(x) >= w && _(x) <= F && (x.printed = !0, N.add(x));
            return {doc: c.slice(w, F), printedComments: N}
        }

        function d(y, g, c, f) {
            let E = y.getValue(), {printer: _} = g, w, F;
            if (_.hasPrettierIgnore && _.hasPrettierIgnore(y)) ({doc: w, printedComments: F} = p(E, g)); else {
                if (E) try {
    ...
    "src/main/range-util.js"(e, r) {
        ...
        function n(f, E) {
            let _ = [f.node, ...f.parentNodes], w = new Set([E.node, ...E.parentNodes]);
        ...
        function u(f) {
            ...
            for (; ;) {
                let _ = f[E];
                if (_ && (_.type === "Program" || _.type === "File")) E--; else break
            }
            return f.slice(0, E + 1)
        }

        function i(f, E, _) {
            let {locStart: w, locEnd: F} = _, N = f.node, x = E.node;
            if (N === x) return {startNode: N, endNode: x};
            let I = w(f.node);
            for (let $ of u(E.parentNodes)) if (w($) >= I) x = $; else break;
            let P = F(E.node);
        ...
        function l(f, E, _, w) {
            let F = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : [],
                N = arguments.length > 5 ? arguments[5] : void 0, {locStart: x, locEnd: I} = _, P = x(f), $ = I(f);
        ...
        var d = new Set(["ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]),
            y = new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
        ...
        function c(f, E, _) {
            let {rangeStart: w, rangeEnd: F, locStart: N, locEnd: x} = E;
            t.ok(F > w);
            let I = f.slice(w, F).search(/\S/), P = I === -1;
            if (!P) for (w += I; F > w && !/\S/.test(f[F - 1]); --F) ;
            let $ = l(_, w, E, (C, o) => g(E, C, o), [], "rangeStart"),
                D = P ? $ : l(_, F, E, C => g(E, C), [], "rangeEnd");
            if (!$ || !D) return {rangeStart: 0, rangeEnd: 0};
            let T, m;
            if (a(E)) {
                let C = n($, D);
                T = C, m = C
            } else ({startNode: T, endNode: m} = i($, D, E));
    ...
    "src/main/core.js"(e, r) {
        ...
        var {diffArrays: t} = vD(), {
            ...
            } = qe(), {getAlignmentSize: n} = Ue(), {
                guessEndOfLine: u,
                convertEndOfLineToChars: i,
                countEndOfLineChars: l,
                normalizeEndOfLine: p
            } = Hn(), d = Ka().normalize, y = _m(), g = et(), c = Qn(), f = km(), E = Lm(), _ = "\uFEFF",
            w = Symbol("cursor");
        ...
        function x(m, C) {
            let {ast: o, text: h} = c.parse(m, C), {rangeStart: v, rangeEnd: S} = E.calculateRange(h, C, o),
                b = h.slice(v, S), B = Math.min(v, h.lastIndexOf(`
`, v) + 1), k = h.slice(B, v).match(/^\s*/)[0], M = n(k, C.tabWidth), R = N(b, Object.assign(Object.assign({}, C), {}, {
                    rangeStart: 0,
                    rangeEnd: Number.POSITIVE_INFINITY,
                    cursorOffset: C.cursorOffset > v && C.cursorOffset <= S ? C.cursorOffset - v : -1,
                    endOfLine: "lf"
                }), M), q = R.formatted.trimEnd(), {cursorOffset: J} = C;
...
`)), L = L.replace(/\n/g, Q)
        ...
        function P(m, C) {
            ...
            return o = I(m, o, -1), h = I(m, h, 0), v = I(m, v, m.length), Object.assign(Object.assign({}, C), {}, {
                cursorOffset: o,
                rangeStart: h,
                rangeEnd: v
            })
...
`);
        ...
        function T(m, C) {
            let {hasBOM: o, text: h, options: v} = $(m, d(C));
            if (v.rangeStart >= v.rangeEnd && h !== "" || v.requirePragma && !D(h, v)) return {
                formatted: m,
        ...
        r.exports = {
            formatWithCursor: T, parse(m, C, o) {
                let {text: h, options: v} = $(m, d(C)), S = c.parse(h, v);
    ...
    "node_modules/esutils/lib/code.js"(e, r) {
        ne(), function () {
            ...
            function c(F) {
                ...
                var N = String.fromCharCode(Math.floor((F - 65536) / 1024) + 55296),
                    x = String.fromCharCode((F - 65536) % 1024 + 56320);
                return N + x
            }
    ...
    "node_modules/esutils/lib/keyword.js"(e, r) {
        ne(), function () {
            ...
            function p(f) {
                ...
                for (E = 1, _ = f.length; E < _; ++E) if (w = f.charCodeAt(E), !t.isIdentifierPartES5(w)) return !1;
                return !0
            }
            ...
            function y(f) {
                ...
                for (N = t.isIdentifierStartES6, E = 0, _ = f.length; E < _; ++E) {
                    if (w = f.charCodeAt(E), 55296 <= w && w <= 56319) {
                        if (++E, E >= _ || (F = f.charCodeAt(E), !(56320 <= F && F <= 57343))) return !1;
                        w = d(w, F)
                    }
                    if (!N(w)) return !1;
    ...
    "src/language-js/utils/index.js"(e, r) {
        "use strict";
        ne();
        var t = Rm().keyword.isIdentifierNameES5, {
                getLast: s,
                hasNewline: a,
                skipWhitespace: n,
                isNonEmptyArray: u,
                ...
                getStringWidth: l
            } = Ue(), {locStart: p, locEnd: d, hasSameLocStart: y} = ut(), g = _t(), c = $m(), f = "(?:(?=.)\\s)",
            E = new RegExp(`^${f}*:`), _ = new RegExp(`^${f}*::`);
        ...
        function Z(O, me) {
            return M(me) ? Oe(me) : Me(me, be.Leading, _e => a(O, d(_e)))
        }
...
`))
        ...
        function we(O, me) {
            return (O.type === "TemplateLiteral" && he(O) || O.type === "TaggedTemplateExpression" && he(O.quasi)) && !a(me, p(O), {backwards: !0})
        }
...
`)) && O.expressions.every(_e);
        ...
        var be = {
            ...
            if (typeof O == "function" && (me = O, O = 0), O || me) return (_e, He, Ge) => !(O & be.Leading && !_e.leading || O & be.Trailing && !_e.trailing || O & be.Dangling && (_e.leading || _e.trailing) || O & be.Block && !g(_e) || O & be.Line && !D(_e) || O & be.First && He !== 0 || O & be.Last && He !== Ge.length - 1 || O & be.PrettierIgnore && !Ie(_e) || me && !me(_e))
        };
    ...
    "src/language-js/print/template-literal.js"(e, r) {
        "use strict";
        ne();
        var t = lt(), {getStringWidth: s, getIndentSize: a} = Ue(), {
            builders: {
                join: n,
                hardline: u,
                softline: i,
                ...
                addAlignmentToDoc: g
            }, printer: {printDocToString: c}, utils: {mapDoc: f}
        } = qe(), {
            isBinaryish: E,
...
`) ? d(Number.NEGATIVE_INFINITY, V) : g(V, Q, J);
        ...
        function P(C, o, h) {
            ...
            if (S.length > 1 || S.some(b => b.length > 0)) {
                ...
                o.__inJestEach = !1;
                let B = [], k = b.map(L => "${" + c(L, Object.assign(Object.assign({}, o), {}, {
                    printWidth: Number.POSITIVE_INFINITY,
                    endOfLine: "lf"
                })).formatted + "}"), M = [{hasLineBreak: !1, cells: []}];
...
`) && M.push({hasLineBreak: !1, cells: []})
                ...
                let R = Math.max(S.length, ...M.map(L => L.cells.length)), q = Array.from({length: R}).fill(0),
                    J = [{cells: S}, ...M.filter(L => L.cells.length > 0)];
        ...
        function D(C, o) {
            return C.map(h => $(h, o), "expressions")
        }
    ...
    "src/language-js/embed/markdown.js"(e, r) {
        ...
        } = qe(), {escapeTemplateCharacters: u} = Lt();

        function i(p, d, y) {
            let c = p.getValue().quasis[0].value.raw.replace(/((?:\\\\)*)\\`/g, (w, F) => "\\".repeat(F.length / 2) + "`"),
                f = l(c), E = f !== "";
            E && (c = c.replace(new RegExp(`^${f}`, "gm"), ""));
            let _ = u(y(c, {parser: "markdown", __inJsTemplate: !0}, {stripTrailingHardline: !0}), !0);
    ...
    "src/language-js/embed/css.js"(e, r) {
        ...
        } = qe(), {printTemplateExpressions: p} = Lt();

        function d(c, f, E) {
            let _ = c.getValue(), w = _.quasis.map(P => P.value.raw), F = 0,
                N = w.reduce((P, $, D) => D === 0 ? $ : P + "@prettier-placeholder-" + F++ + "-id" + $, ""),
                x = E(N, {parser: "scss"}, {stripTrailingHardline: !0}), I = p(c, f);
            return y(x, _, I)
        }
        ...
        function g(c, f) {
            if (!t(f)) return c;
            let E = 0,
                _ = u(l(c), w => typeof w != "string" || !w.includes("@prettier-placeholder") ? w : w.split(/@prettier-placeholder-(\d+)-id/).map((F, N) => N % 2 === 0 ? i(F) : (E++, f[F])));
    ...
    "src/language-js/embed/graphql.js"(e, r) {
        "use strict";
        ne();
        var {builders: {indent: t, join: s, hardline: a}} = qe(), {
...
`), P = I.length, $ = f[_], D = P > 2 && I[0].trim() === "" && I[1].trim() === "",
        ...
        function l(p) {
            let d = [], y = !1, g = p.map(c => c.trim());
            for (let [c, f] of g.entries()) f !== "" && (g[c - 1] === "" && y ? d.push([a, f]) : d.push(f), y = !0);
    ...
    "src/language-js/embed/html.js"(e, r) {
        ...
        var {
            ...
            utils: {mapDoc: u}
        } = qe(), {printTemplateExpressions: i, uncookTemplateElementValue: l} = Lt(), p = 0;

        function d(y, g, c, f, E) {
            let {parser: _} = E, w = y.getValue(), F = p;
            p = p + 1 >>> 0;
            let N = h => `PRETTIER_HTML_PLACEHOLDER_${h}_${F}_IN_JS`,
                x = w.quasis.map((h, v, S) => v === S.length - 1 ? h.value.cooked : h.value.cooked + N(v)).join(""),
                I = i(y, g);
            if (I.length === 0 && x.trim().length === 0) return "``";
            let P = new RegExp(N("(\\d+)"), "g"), $ = 0, D = c(x, {
                    parser: _, __onHtmlRoot(h) {
                        $ = h.children.length
                    }
                }, {stripTrailingHardline: !0}), T = u(D, h => {
    ...
    "src/language-js/clean.js"(e, r) {
        ...
        function n(u, i, l) {
            ...
            if ((u.type === "Property" || u.type === "ObjectProperty" || u.type === "MethodDefinition" || u.type === "ClassProperty" || u.type === "ClassMethod" || u.type === "PropertyDefinition" || u.type === "TSDeclareMethod" || u.type === "TSPropertySignature" || u.type === "ObjectTypeProperty") && typeof u.key == "object" && u.key && (u.key.type === "Literal" || u.key.type === "NumericLiteral" || u.key.type === "StringLiteral" || u.key.type === "Identifier") && delete i.key, u.type === "JSXElement" && u.openingElement.name.name === "style" && u.openingElement.attributes.some(y => y.name.name === "jsx")) for (let {
                type: y,
                expression: g
            } of i.children) y === "JSXExpressionContainer" && g.type === "TemplateLiteral" && a(g);
...
function Za() {
    if (typeof xr > "u") {
        ...
        if (r[0] = 1, r[1] = 2, t[0] === 258) xr = "BE"; else if (t[0] === 513) xr = "LE"; else throw new Error("unable to figure out endianess")
    }
    return xr
}
...
`
    ...
    "node_modules/jest-docblock/build/index.js"(e) {
        ...
        function _(N) {
            ...
            let P = Object.create(null), $ = N.replace(d, "").replace(l, "").trimRight(), D;
            for (; D = d.exec(N);) {
                let T = D[2].replace(i, "");
        ...
        function w(N) {
            let {comments: x = "", pragmas: I = {}} = N, P = (0, t().default)(x) || r().EOL, $ = "/**", D = " *",
                T = " */", m = Object.keys(I),
                C = m.map(h => F(h, I[h])).reduce((h, v) => h.concat(v), []).map(h => `${D} ${h}${P}`).join("");
            if (!x) {
...
`);
    ...
    "src/language-js/pragma.js"(e, r) {
        ...
        function l(y) {
            ...
            let c = a(y), {pragmas: f, comments: E} = t(c);
        ...
        function d(y) {
            let {shebang: g, text: c, pragmas: f, comments: E} = l(y), _ = s(c),
                w = n({pragmas: Object.assign({format: ""}, f), comments: E.trimStart()});
            return (g ? `${g}
` : "") + u(w) + (_.startsWith(`
`) ? `
` : `
...
`) + _
    ...
    "src/language-js/comments.js"(e, r) {
        ...
        var {
            ...
            getNextNonSpaceNonCommentCharacterIndex: d,
            isNonEmptyArray: y
        } = Ue(), {
            getFunctionParameters: g,
            isPrettierIgnoreComment: c,
            isJsxNode: f,
            hasFlowShorthandAnnotationComment: E,
        ...
        } = Ke(), {locStart: C, locEnd: o} = ut(), h = _t(), v = td();
        ...
        function ie(De) {
            ...
            if (Y.has(re == null ? void 0 : re.type)) {
                if (y(re.decorators) && !(ye && ye.type === "Decorator")) return l(t(re.decorators), A), !0;
        ...
        function ue(De) {
            let {comment: A, enclosingNode: G, text: re} = De;
            return n(re, A, o) !== ")" ? !1 : G && (le(G) && g(G).length === 0 || F(G) && N(G).length === 0) ? (p(G, A), !0) : ((G == null ? void 0 : G.type) === "MethodDefinition" || (G == null ? void 0 : G.type) === "TSAbstractMethodDefinition") && g(G.value).length === 0 ? (p(G.value, A), !0) : !1
        }
        ...
        function ge(De) {
            ...
            return ye && ye.body && ye.body.length === 0 ? (Ce ? p(ye, A) : i(ye, A), !0) : (G == null ? void 0 : G.type) === "Program" && (G == null ? void 0 : G.body.length) === 0 && !y(G.directives) ? (Ce ? p(G, A) : i(G, A), !0) : (re == null ? void 0 : re.type) === "Program" && (re == null ? void 0 : re.body.length) === 0 && (G == null ? void 0 : G.type) === "ModuleExpression" ? (p(re, A), !0) : !1
        }
        ...
        function Pe(De) {
            let {comment: A, enclosingNode: G, followingNode: re} = De;
            return Re.has(G == null ? void 0 : G.type) && re && (Ne.has(re.type) || h(A)) ? (i(re, A), !0) : !1
        }
        ...
        function Ee(De) {
            ...
            return (A && (f(A) || E(A) || x(G) && re(A)) || G && (G.type === "JSXSpreadAttribute" || G.type === "JSXSpreadChild" || G.type === "UnionTypeAnnotation" || G.type === "TSUnionType" || (G.type === "ClassDeclaration" || G.type === "ClassExpression") && G.superClass === A)) && (!w(De) || G.type === "UnionTypeAnnotation" || G.type === "TSUnionType")
        }
        ...
        function w(D, T) {
            ...
            switch (m.type) {
                ...
                case"ArrowFunctionExpression": {
                    if (C === "body" && o.type !== "SequenceExpression" && d(o, S => S.type === "ObjectExpression")) return !0;
                    break
                }
            }
            switch (o.type) {
        ...
        function i(p, d, y) {
            ...
            if (d.__onHtmlBindingRoot && p.getName() === null && d.__onHtmlBindingRoot(g, d), g.type === "File") {
                if (d.__isVueForBindingLeft) return p.call(c => {
                    let f = t([",", s], c.map(y, "params")), {params: E} = c.getValue();
    ...
    "src/language-js/print/binaryish.js"(e, r) {
        "use strict";
        ne();
        var {printComments: t} = et(), {getLast: s} = Ue(), {
            builders: {
                join: a,
                line: n,
                softline: u,
                ...
                align: p,
                indentIfBreak: d
            }, utils: {cleanDoc: y, getDocParts: g, isConcat: c}
        } = qe(), {
        ...
        function T(o, h, v) {
            let S = o.getValue(), b = o.getParentNode(), B = o.getParentNode(1),
                k = S !== b.body && (b.type === "IfStatement" || b.type === "WhileStatement" || b.type === "SwitchStatement" || b.type === "DoWhileStatement"),
                M = $(h) && S.operator === "|>", R = m(o, v, h, !1, k);
            if (k) return R;
            if (M) return i(R);
            if (x(b) && b.callee === S || b.type === "UnaryExpression" || I(b) && !b.computed) return i([l([u, ...R]), u]);
            let q = b.type === "ReturnStatement" || b.type === "ThrowStatement" || b.type === "JSXExpressionContainer" && B.type === "JSXAttribute" || S.operator !== "|" && b.type === "JsExpressionRoot" || S.type !== "NGPipeExpression" && (b.type === "NGRoot" && h.parser === "__ng_binding" || b.type === "NGMicrosyntaxExpression" && B.type === "NGMicrosyntax" && B.body.length === 1) || S === b.body && b.type === "ArrowFunctionExpression" || S !== b.body && b.type === "ForStatement" || b.type === "ConditionalExpression" && B.type !== "ReturnStatement" && B.type !== "ThrowStatement" && !x(B) || b.type === "TemplateLiteral",
                ...
                L = E(S.left) && w(S.operator, S.left.operator);
            if (q || C(S) && !L || !C(S) && J) return i(R);
            if (R.length === 0) return "";
            let Q = _(S.right), V = R.findIndex(W => typeof W != "string" && !Array.isArray(W) && W.type === "group"),
                j = R.slice(0, V === -1 ? 1 : V + 1), Y = R.slice(j.length, Q ? -1 : void 0),
                ie = Symbol("logicalChain-" + ++D), ee = i([...j, l(Y)], {id: ie});
            if (!Q) return ee;
            let ce = s(R);
        ...
        function m(o, h, v, S, b) {
            ...
            if (!E(B)) return [i(h())];
            let k = [];
            w(B.operator, B.left.operator) ? k = o.call(Y => m(Y, h, v, !0, b), "left") : k.push(i(h("left")));
            let M = C(B),
                ...
                J = B.type === "NGPipeExpression" && B.arguments.length > 0 ? i(l([n, ": ", a([n, ": "], o.map(h, "arguments").map(Y => p(2, i(Y))))])) : "",
                L;
            if (M) L = [q, " ", h("right"), J]; else {
                let ie = $(v) && q === "|>" ? o.call(ee => m(ee, h, v, !0, b), "right") : h("right");
                L = [R ? n : "", q, R ? " " : n, ie, J]
            }
            let Q = o.getParentNode(), V = F(B.left, N.Trailing | N.Line),
    ...
    "src/language-js/print/angular.js"(e, r) {
        "use strict";
        ne();
        var {builders: {join: t, line: s, group: a}} = qe(), {
            hasNode: n,
            hasComment: u,
            getComments: i
        } = Ke(), {printBinaryishExpression: l} = Zn();

        function p(g, c, f) {
            let E = g.getValue();
            if (E.type.startsWith("NG")) switch (E.type) {
                case"NGRoot":
                ...
                case"NGMicrosyntax":
                    return g.map((_, w) => [w === 0 ? "" : d(_.getValue(), w, E) ? " " : [";", s], f()], "body");
                ...
                case"NGMicrosyntaxKeyedExpression": {
                    let _ = g.getName(), w = g.getParentNode(),
                        F = d(E, _, w) || (_ === 1 && (E.key.name === "then" || E.key.name === "else") || _ === 2 && E.key.name === "else" && w.body[_ - 1].type === "NGMicrosyntaxKeyedExpression" && w.body[_ - 1].key.name === "then") && w.body[0].type === "NGMicrosyntaxExpression";
    ...
    "src/language-js/print/jsx.js"(e, r) {
        "use strict";
        ne();
        var {printComments: t, printDanglingComments: s, printCommentsSeparately: a} = et(), {
            builders: {
                line: n,
                hardline: u,
                softline: i,
        ...
        } = qe(), {getLast: _, getPreferredQuote: w} = Ue(), {
            isJsxNode: F,
            rawText: N,
            isCallExpression: x,
            isStringLiteral: I,
        ...
        } = Ke(), m = Ot(), {willPrintOwnComments: C} = fo(), o = U => U === "" || U === n || U === u || U === i;
        ...
        function h(U, Z, se) {
            ...
            let we = fe.children.some(F), ke = fe.children.filter(A => A.type === "JSXExpressionContainer").length > 1,
                Re = fe.type === "JSXElement" && fe.openingElement.attributes.length > 1, Ne = E(ge) || we || Re || ke,
                Pe = U.getParentNode().rootMarker === "mdx", oe = Z.singleQuote ? "{' '}" : '{" "}',
                H = Pe ? " " : g([oe, i], " "),
                pe = fe.openingElement && fe.openingElement.name && fe.openingElement.name.name === "fbt",
                X = v(U, Z, se, H, pe), le = fe.children.some(A => ue(A));
            for (let A = X.length - 2; A >= 0; A--) {
                let G = X[A] === "" && X[A + 1] === "", re = X[A] === u && X[A + 1] === "" && X[A + 2] === u,
            ...
            let Ee = le ? y(Ae) : l(Ae, {shouldBreak: !0});
            if (Pe) return Ee;
...
`)), we = Z.singleAttributePerLine && fe.attributes.length > 1 ? u : n;
        ...
        var ee = ` 
\r	`, ce = new RegExp("([" + ee + "]+)"), W = new RegExp("[^" + ee + "]"),
    ...
    "src/language-js/print/misc.js"(e, r) {
        ...
        } = qe(), {isFlowAnnotationComment: u} = Ke();
    ...
    "src/language-js/print/array.js"(e, r) {
        ...
        } = Ke(), {locStart: F} = ut(), {printOptionalToken: N, printTypeAnnotation: x} = ct();

        function I(T, m, C) {
            let o = T.getValue(), h = [], v = o.type === "TupleExpression" ? "#[" : "[", S = "]";
            if (o.elements.length === 0) c(o, f.Dangling) ? h.push(u([v, t(T, m), a, S])) : h.push(v, S); else {
                let b = d(o.elements), B = !(b && b.type === "RestElement"), k = b === null, M = Symbol("array"),
                ...
                h.push(u([v, i([a, q ? D(T, m, C, J) : [$(T, m, "elements", C), J], t(T, m, !0)]), a, S], {
                    shouldBreak: R,
                    id: M
                }))
            }
        ...
        function P(T, m) {
            return T.elements.length > 1 && T.elements.every(C => C && (_(C) || w(C) && !c(C.argument)) && !c(C, f.Trailing | f.Line, o => !y(m.originalText, F(o), {backwards: !0})))
        }

        function $(T, m, C, o) {
            let h = [], v = [];
            return T.each(S => {
                h.push(v, u(o())), v = [",", s], S.getValue() && E(S.getValue(), m) && v.push(a)
            }, C), h
        }
        ...
        function D(T, m, C, o) {
            ...
            return T.each((v, S, b) => {
                let B = S === b.length - 1;
                h.push([C(), B ? o : ","]), B || h.push(E(v.getValue(), m) ? [n, n] : c(b[S + 1], f.Leading | f.Line) ? n : s)
            }, "elements"), p(h)
        }
    ...
    "src/language-js/print/call-arguments.js"(e, r) {
        "use strict";
        ne();
        var {printDanglingComments: t} = et(), {getLast: s, getPenultimate: a} = Ue(), {
            getFunctionParameters: n,
            hasComment: u,
            CommentCheckFlags: i,
            isFunctionCompositionArgs: l,
            isJsxNode: p,
            isLongCurriedCallExpression: d,
            shouldPrintComma: y,
            getCallArguments: g,
        ...
        function v(q, J, L) {
            ...
            if (de || ue) {
                ...
                try {
                    q.try(() => {
                        c(q, (U, Z) => {
                            de && Z === 0 && (z = [[L([], {expandFirstArg: !0}), ce.length > 1 ? "," : "", ie ? x : N, ie ? x : ""], ...ce.slice(1)]), ue && Z === ee && (z = [...ce.slice(0, -1), L([], {expandLastArg: !0})])
                        })
                    })
                } catch (U) {
                ...
                return [ce.some(C) ? m : "", D([["(", ...z, ")"], de ? ["(", P(z[0], {shouldBreak: !0}), ...z.slice(1), ")"] : ["(", ...ce.slice(0, -1), P(s(z), {shouldBreak: !0}), ")"], K()])]
            }
            let Fe = ["(", $([I, ...ce]), T(W), I, ")"];
        ...
        function S(q) {
            ...
            return q.type === "ObjectExpression" && (q.properties.length > 0 || u(q)) || q.type === "ArrayExpression" && (q.elements.length > 0 || u(q)) || q.type === "TSTypeAssertion" && S(q.expression) || F(q) && S(q.expression) || q.type === "FunctionExpression" || q.type === "ArrowFunctionExpression" && (!q.returnType || !q.returnType.typeAnnotation || q.returnType.typeAnnotation.type !== "TSTypeReference" || M(q.body)) && (q.body.type === "BlockStatement" || q.body.type === "ArrowFunctionExpression" && S(q.body, !0) || q.body.type === "ObjectExpression" || q.body.type === "ArrayExpression" || !J && (E(q.body) || q.body.type === "ConditionalExpression") || p(q.body)) || q.type === "DoExpression" || q.type === "ModuleExpression"
        }
    ...
    "src/language-js/print/member.js"(e, r) {
        "use strict";
        ne();
        var {builders: {softline: t, group: s, indent: a, label: n}} = qe(), {
            isNumericLiteral: u,
            isMemberExpression: i,
            isCallExpression: l
        } = Ke(), {printOptionalToken: p} = ct();

        function d(g, c, f) {
            let E = g.getValue(), _ = g.getParentNode(), w, F = 0;
            do w = g.getParentNode(F), F++; while (w && (i(w) || w.type === "TSNonNullExpression"));
            let N = f("object"), x = y(g, c, f),
        ...
        function y(g, c, f) {
            let E = f("property"), _ = g.getValue(), w = p(g);
    ...
    "src/language-js/print/member-chain.js"(e, r) {
        ...
        } = qe(), m = mo(), {printMemberLookup: C} = go(), {
            printOptionalToken: o,
            printFunctionTypeParameters: h,
        ...
        function S(b, B, k) {
            ...
            function L(Ne) {
                let Pe = Ne.getValue();
                i(Pe) && (y(Pe.callee) || i(Pe.callee)) ? (q.unshift({
                    node: Pe,
                    printed: [t(Ne, [o(Ne), h(Ne, B, k), m(Ne, B, k)], B), J(Pe) ? N : ""]
                }), Ne.call(oe => L(oe), "callee")) : y(Pe) ? (q.unshift({
                    node: Pe,
                    needsParens: u(Ne, B),
                    ...
                    node: Pe,
                    printed: t(Ne, "!", B)
                }), Ne.call(oe => L(oe), "expression")) : q.unshift({node: Pe, printed: k()})
            }
            ...
            let Fe = V.map(de), z = Fe, U = K ? 3 : 2, Z = V.flat(),
                se = Z.slice(1, -1).some(Ne => f(Ne.node, E.Leading)) || Z.slice(0, -1).some(Ne => f(Ne.node, E.Trailing)) || V[U] && f(V[U][0].node, E.Leading);
            if (V.length <= U && !se) return d(b) ? z : x(z);
            let fe = s(V[K ? 1 : 0]).node, ge = !i(fe) && J(fe),
                he = [de(V[0]), K ? V.slice(1, 2).map(de) : "", ge ? N : "", ue(V.slice(K ? 2 : 1))], we = q.map(Ne => {
                    let {node: Pe} = Ne;
                    return Pe
                }).filter(i);
    ...
    "src/language-js/print/call-expression.js"(e, r) {
        "use strict";
        ne();
        var {builders: {join: t, group: s}} = qe(), a = Ot(), {
            getCallArguments: n,
            hasFlowAnnotationComment: u,
            isCallExpression: i,
            isMemberish: l,
            isStringLiteral: p,
            isTemplateOnItsOwnLine: d,
            isTestCall: y,
            iterateCallArgumentsPath: g
        } = Ke(), c = sd(), f = mo(), {printOptionalToken: E, printFunctionTypeParameters: _} = ct();

        function w(N, x, I) {
            let P = N.getValue(), $ = N.getParentNode(), D = P.type === "NewExpression",
                T = P.type === "ImportExpression", m = E(N), C = n(P);
            if (C.length > 0 && (!T && !D && F(P, $) || C.length === 1 && d(C[0], x.originalText) || !D && y(P, $))) {
                let v = [];
                return g(N, () => {
                    v.push(I())
    ...
    "src/language-js/print/assignment.js"(e, r) {
        ...
        var {isNonEmptyArray: t, getStringWidth: s} = Ue(), {
            ...
            }, utils: {cleanDoc: p, willBreak: d, canBreak: y}
        } = qe(), {
            ...
            isObjectProperty: $
        } = Ke(), {shouldInlineLogicalExpression: D} = Zn(), {printCallExpression: T} = yo();
        ...
        function h(W, K, de, ue, Fe) {
            ...
            if (S(z) || k(z) || q(z) || J(z) && y(ue)) return "break-lhs";
            let ge = ie(z, ue, K);
        ...
        function V(W, K, de) {
            let ue = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, Fe = W.getValue(),
                z = () => V(W, K, de, !0);
...
`) : E(W)
    ...
    "src/language-js/print/function-parameters.js"(e, r) {
        "use strict";
        ne();
        var {getNextNonSpaceNonCommentCharacter: t} = Ue(), {printDanglingComments: s} = et(), {
            builders: {
                line: a,
                hardline: n,
                softline: u,
                ...
                indent: l,
                ifBreak: p
            }, utils: {removeLines: d, willBreak: y}
        } = qe(), {
            getFunctionParameters: g,
            ...
            isObjectType: w,
            isObjectTypePropertyAFunction: F,
            hasRestParameter: N,
            shouldPrintComma: x,
            hasComment: I,
            isNextLineEmpty: P
        } = Ke(), {locEnd: $} = ut(), {ArgExpansionBailout: D} = Kt(), {printFunctionTypeParameters: T} = ct();
    ...
    "src/language-js/print/type-annotation.js"(e, r) {
        "use strict";
        ne();
        var {printComments: t, printDanglingComments: s} = et(), {isNonEmptyArray: a} = Ue(), {
            builders: {
                group: n,
                join: u,
                line: i,
        ...
        function m(b, B, k) {
            let M = b.getValue(), R = b.map(k, "types"), q = [], J = !1;
            for (let L = 0; L < R.length; ++L) L === 0 ? q.push(R[L]) : E(M.types[L - 1]) && E(M.types[L]) ? q.push([" & ", J ? p(R[L]) : R[L]]) : !E(M.types[L - 1]) && !E(M.types[L]) ? q.push(p([" &", i, R[L]])) : (L > 1 && (J = !0), q.push(" & ", L > 1 ? p(R[L]) : R[L]));
            return n(q)
        }

        function C(b, B, k) {
            let M = b.getValue(), R = b.getParentNode(),
        ...
        function o(b, B, k) {
            let M = b.getValue(), R = [], q = b.getParentNode(0), J = b.getParentNode(1), L = b.getParentNode(2),
        ...
        function h(b, B, k) {
            let M = b.getValue(), R = M.type === "TSTupleType" ? "elementTypes" : "types", q = M[R], J = a(q),
                L = J ? l : "";
            return n(["[", p([L, P(b, B, R, k)]), y(J && F(B, "all") ? "," : ""), s(b, B, !0), L, "]"])
        }
    ...
    "src/language-js/print/type-parameters.js"(e, r) {
        ...
        var {printDanglingComments: t} = et(), {
            ...
            } = Ke(), {createGroupIdMapper: F} = Ue(), {shouldHugType: N} = kr(), {isArrowFunctionVariableDeclarator: x} = Zt(),
            I = F("typeParameters");
        ...
        function P(T, m, C, o) {
            ...
            let v = T.getNode(2), S = v && d(v),
                b = T.match(M => !(M[o].length === 1 && _(M[o][0])), void 0, (M, R) => R === "typeAnnotation", M => M.type === "Identifier", x);
            if (h[o].length === 0 || !b && (S || h[o].length === 1 && (h[o][0].type === "NullableTypeAnnotation" || N(h[o][0])))) return ["<", s(", ", T.map(C, o)), $(T, m), ">"];
    ...
    "src/language-js/print/property.js"(e, r) {
        "use strict";
        ne();
        var {printComments: t} = et(), {printString: s, printNumber: a} = Ue(), {
            isNumericLiteral: n,
            isSimpleNumber: u,
            isStringLiteral: i,
            isStringPropSafeToUnquote: l,
            rawText: p
        } = Ke(), {printAssignment: d} = Zt(), y = new WeakMap;
        ...
        function g(f, E, _) {
            ...
            if (E.quoteProps === "consistent" && !y.has(F)) {
                let x = (F.properties || F.body || F.members).some(I => !I.computed && I.key && i(I.key) && !l(I, E));
                y.set(F, x)
            }
            if ((N.type === "Identifier" || n(N) && u(a(p(N))) && String(N.value) === a(p(N)) && !(E.parser === "typescript" || E.parser === "babel-ts")) && (E.parser === "json" || E.quoteProps === "consistent" && y.get(F))) {
                let x = s(JSON.stringify(N.type === "Identifier" ? N.name : N.value.toString()), E);
                return f.call(I => t(I, x, E), "key")
            }
            return l(w, E) && (E.quoteProps === "as-needed" || E.quoteProps === "consistent" && !y.get(F)) ? f.call(x => t(x, /^\d/.test(N.value) ? a(N.value) : N.value, E), "key") : _("key")
        }
    ...
    "src/language-js/print/function.js"(e, r) {
        "use strict";
        ne();
        var t = Yt(), {printDanglingComments: s, printCommentsSeparately: a} = et(),
            n = lt(), {getNextNonSpaceNonCommentCharacterIndex: u} = Ue(), {
                builders: {
                    line: i,
                    softline: l,
                    group: p,
                    ...
                    join: c,
                    indentIfBreak: f
                }, utils: {removeLines: E, willBreak: _}
            } = qe(), {ArgExpansionBailout: w} = Kt(), {
            ...
            } = Ir(), {printPropertyKey: J} = er(), {printFunctionTypeParameters: L} = ct();

        function Q(U, Z, se, fe) {
            let ge = U.getValue(), he = !1;
        ...
        function j(U, Z, se) {
            let fe = U.getNode(), ge = R(U, se, Z), he = K(U, se, Z), we = q(fe, he),
        ...
        function ie(U, Z, se, fe, ge, he) {
            let we = U.getName(), ke = U.getParentNode(), Re = v(ke) && we === "callee",
                ...
                oe = Re && Pe || Z && Z.assignmentLayout === "chain-tail-arrow-chain", H = Symbol("arrow-chain");
            return he.body.type === "SequenceExpression" && (ge = p(["(", d([l, ge]), l, ")"])), p([p(d([Re || Ne ? l : "", p(c([" =>", i], se), {shouldBreak: fe})]), {
                id: H,
                shouldBreak: oe
            }), " =>", f(Pe ? d([i, ge]) : [" ", ge], {groupId: H}), Re ? y(l, "", {groupId: H}) : ""])
        }

        function ee(U, Z, se, fe) {
            let ge = U.getValue(), he = [], we = [], ke = !1;
            if (function H() {
                let pe = Y(U, Z, se, fe);
        ...
        function de(U, Z, se) {
            ...
            return Re && he.push(ge), C(fe, h.Dangling) && he.push(" ", s(U, Z, !0)), Re || he.push(ge), he
        }
    ...
    "src/language-js/print/decorators.js"(e, r) {
        ...
        } = qe(), {locStart: p, locEnd: d} = ut(), {getParentExportDeclaration: y} = Ke();

        function g(w, F, N) {
            let x = w.getValue();
            return l([u(a, w.map(N, "decorators")), E(x, F) ? n : a])
        }
    ...
    "src/language-js/print/class.js"(e, r) {
        ...
        var {isNonEmptyArray: t, createGroupIdMapper: s} = Ue(), {
            ...
            hasComment: c,
            CommentCheckFlags: f
        } = Ke(), {getTypeParametersGroupId: E} = Lr(), {printMethod: _} = Or(), {
            printOptionalToken: w,
            printTypeAnnotation: F,
            printDefiniteToken: N
        } = ct(), {printPropertyKey: x} = er(), {printAssignment: I} = Zt(), {printClassMemberDecorators: P} = eu();
        ...
        function o(b, B, k, M) {
            ...
            return [C(R) ? g(" ", i, {groupId: E(R.typeParameters)}) : i, q, q && l, M, d(y([i, u([",", i], b.map(k, M))]))]
        }
    ...
    "src/language-js/print/interface.js"(e, r) {
        ...
        var {isNonEmptyArray: t} = Ue(), {
            ...
            identity: p,
            CommentCheckFlags: d
        } = Ke(), {getTypeParametersGroupId: y} = Lr(), {printTypeScriptModifiers: g} = ct();
    ...
    "src/language-js/print/module.js"(e, r) {
        ...
        function P(S, b, B) {
            ...
            return M.push("export"), (k.default || R === "ExportDefaultDeclaration") && M.push(" default"), y(k, g.Dangling) && (M.push(" ", d(S, b, !0)), f(k) && M.push(p)), J ? M.push(" ", B("declaration")) : M.push(q === "type" ? " type" : "", m(S, b, B), T(S, b, B), o(S, b, B)), D(k, b) && M.push(";"), M
        }
        ...
        function h(S, b, B) {
            ...
            q && q !== "value" && R.push(q, " ");
            let J = M.startsWith("Import"), L = J ? "imported" : "local", Q = J ? "local" : "exported", V = k[L],
                j = k[Q], Y = "", ie = "";
        ...
        function v(S) {
            ...
            if (b.type !== B.type || !F(b, B)) return !1;
            if (E(b)) return b.value === B.value && _(b) === _(B);
            switch (b.type) {
                case"Identifier":
    ...
    "src/language-js/print/object.js"(e, r) {
        ...
        } = qe(), {getLast: p, hasNewlineInRange: d, hasNewline: y, isNonEmptyArray: g} = Ue(), {
            shouldPrintComma: c,
            hasComment: f,
            getComments: E,
            CommentCheckFlags: _,
            isNextLineEmpty: w
        } = Ke(), {locStart: F, locEnd: N} = ut(), {
            printOptionalToken: x,
            printTypeAnnotation: I
        } = ct(), {shouldHugFunctionParameters: P} = Ir(), {shouldHugType: $} = kr(), {printHardlineAfterHeritage: D} = tr();
        ...
        function T(m, C, o) {
            ...
            let k = B.map(W => v[W][0]).sort((W, K) => F(W) - F(K))[0], M = m.getParentNode(0),
                ...
                J = R ? ";" : v.type === "TSInterfaceBody" || v.type === "TSTypeLiteral" ? i(h, ";") : ",",
    ...
    "src/language-js/print/flow.js"(e, r) {
        "use strict";
        ne();
        var t = Yt(), {printDanglingComments: s} = et(), {
            printString: a,
            printNumber: n
        } = Ue(), {builders: {hardline: u, softline: i, group: l, indent: p}} = qe(), {
            getParentExportDeclaration: d,
            isFunctionNotation: y,
            isGetterOrSetter: g,
            rawText: c,
            shouldPrintComma: f
        } = Ke(), {
            locStart: E,
            locEnd: _
        } = ut(), {replaceTextEndOfLine: w} = Xt(), {printClass: F} = tr(), {
            printOpaqueType: N,
            printTypeAlias: x,
        ...
        } = kr(), {printInterface: m} = ho(), {
            printTypeParameter: C,
            printTypeParameters: o
        } = Lr(), {
            printExportDeclaration: h,
            printExportAllDeclaration: v
        } = vo(), {printArrayItems: S} = Qt(), {printObject: b} = tu(), {printPropertyKey: B} = er(), {
        ...
        function q(L, Q, V) {
            ...
            switch (j.type) {
                ...
                case"TypeParameterInstantiation": {
                    ...
                    if (Q.parser === "flow") {
                        let ce = E(j), W = _(j), K = Q.originalText.lastIndexOf("/*", ce),
    ...
    "src/language-js/print/ternary.js"(e, r) {
        ...
        } = Ke(), {locStart: l, locEnd: p} = ut(), d = _t(), {
            builders: {
                line: y,
                softline: g,
                group: c,
        ...
        function x(D, T, m) {
            let C = D.getValue(), o = C.type === "ConditionalExpression", h = o ? "alternate" : "falseType",
                v = D.getParentNode(), S = o ? m("test") : [m("checkType"), " ", "extends", " ", m("extendsType")];
            return v.type === C.type && v[h] === C ? E(2, S) : S
        }
        ...
        function $(D, T, m) {
            let C = D.getValue(), o = C.type === "ConditionalExpression", h = o ? "consequent" : "trueType",
                v = o ? "alternate" : "falseType", S = o ? ["test"] : ["checkType", "extendsType"], b = C[h], B = C[v],
                k = [], M = !1, R = D.getParentNode(), q = R.type === C.type && S.some(ue => R[ue] === C),
                J = R.type === C.type && !q, L, Q, V = 0;
            ...
            if (o && (s(C[S[0]]) || s(b) || s(B) || N(Y))) {
                ...
                let ue = [y, "? ", b.type === C.type ? _("", "(") : "", E(2, m(h)), b.type === C.type ? _("", ")") : "", y, ": ", B.type === C.type ? m(v) : E(2, m(v))];
                k.push(R.type !== C.type || R[v] === C || q ? ue : T.useTabs ? w(f(ue)) : E(Math.max(0, T.tabWidth - 2), ue))
            }
            let ee = [...S.map(ue => a(C[ue])), a(b), a(B)].flat().some(ue => d(ue) && t(T.originalText, l(ue), p(ue))),
                ce = ue => R === j ? c(ue, {shouldBreak: ee}) : ee ? [ue, F] : ue,
                W = !M && (u(R) || R.type === "NGPipeExpression" && R.left === C) && !R.computed, K = P(D),
    ...
    "src/language-js/print/statement.js"(e, r) {
        "use strict";
        ne();
        var {builders: {hardline: t}} = qe(), s = Ot(), {
            ...
            CommentCheckFlags: p,
            isNextLineEmpty: d
        } = Ke(), {shouldPrintParamsWithoutParens: y} = Or();
        ...
        function g(x, I, P, $) {
            ...
            return x.each((o, h, v) => {
                ...
                let b = P();
                !I.semi && !m && !i(I, o) && f(o, I) ? l(S, p.Leading) ? T.push(P([], {needsSemi: !0})) : T.push(";", b) : T.push(b), !I.semi && m && F(S) && N(S, v[h + 1]) && T.push(";"), S !== C && (T.push(t), d(S, I) && T.push(t))
            }, $), T
        }
        ...
        function f(x, I) {
            return x.getNode().type !== "ExpressionStatement" ? !1 : x.call($ => E($, I), "expression")
        }
        ...
        function E(x, I) {
            ...
            return s(x, I) ? !0 : n(P) ? x.call($ => E($, I), ...a(x, P)) : !1
        }
        ...
        function N(x, I) {
            ...
            if (F(I) && I.variance && !I.static && !I.declare) return !0;
            switch (I.type) {
                case"ClassProperty":
    ...
    "src/language-js/print/block.js"(e, r) {
        "use strict";
        ne();
        var {printDanglingComments: t} = et(), {isNonEmptyArray: s} = Ue(), {
            builders: {
                hardline: a,
                indent: n
            }
            ...
            CommentCheckFlags: i,
            isNextLineEmpty: l
        } = Ke(), {printHardlineAfterHeritage: p} = tr(), {printBody: d} = Eo();
        ...
        function g(c, f, E) {
            let _ = c.getValue(), w = s(_.directives), F = _.body.some(I => I.type !== "EmptyStatement"),
                N = u(_, i.Dangling);
            if (!w && !F && !N) return "";
            let x = [];
            if (w && c.each((I, P, $) => {
                x.push(E()), (P < $.length - 1 || F || N) && (x.push(a), l(I.getValue(), f) && x.push(a))
            }, "directives"), F && x.push(d(c, f, E)), N && x.push(t(c, f, !0)), _.type === "Program") {
    ...
    "src/language-js/print/typescript.js"(e, r) {
        "use strict";
        ne();
        var {printDanglingComments: t} = et(), {hasNewlineInRange: s} = Ue(), {
            builders: {
                join: a,
                line: n,
                hardline: u,
        ...
        } = Ke(), w = ad(), {locStart: F, locEnd: N} = ut(), {
            printOptionalToken: x,
            printTypeScriptModifiers: I
        } = ct(), {printTernary: P} = Co(), {
            printFunctionParameters: $,
            shouldGroupFunctionParameters: D
        } = Ir(), {printTemplateLiteral: T} = Lt(), {printArrayItems: m} = Qt(), {printObject: C} = tu(), {
            printClassProperty: o,
            printClassMethod: h
        } = tr(), {
            printTypeParameter: v,
            printTypeParameters: S
        } = Lr(), {printPropertyKey: b} = er(), {
            printFunction: B,
            printMethodInternal: k
        } = Or(), {printInterface: M} = ho(), {printBlock: R} = Fo(), {
            printTypeAlias: q,
        ...
        function ie(ee, ce, W) {
            ...
            switch (K.type) {
                ...
                case"TSIndexSignature": {
                    let Fe = ee.getParentNode(), z = K.parameters.length > 1 ? y(f(ce) ? "," : "") : "",
                ...
                case"TSMethodSignature": {
                    ...
                    let z = $(ee, W, ce, !1, !0), U = K.returnType ? "returnType" : "typeAnnotation", Z = K[U],
                        se = Z ? W(U) : "", fe = D(K, se);
                ...
                case"TSModuleDeclaration": {
                    let Fe = ee.getParentNode(), z = g(K.id), U = Fe.type === "TSModuleDeclaration",
    ...
    "src/language-js/print/comment.js"(e, r) {
        ...
        } = qe(), {isLineComment: u} = Ke(), {locStart: i, locEnd: l} = ut(), p = _t();

        function d(c, f) {
            let E = c.getValue();
            if (u(E)) return f.originalText.slice(i(E), l(E)).trimEnd();
            if (p(E)) {
                if (y(E)) {
                    let F = g(E);
...
`);
    ...
    "src/language-js/printer-estree.js"(e, r) {
        "use strict";
        ne();
        var {printDanglingComments: t} = et(), {hasNewline: s} = Ue(), {
            builders: {
                join: a,
                line: n,
                hardline: u,
                ...
                group: l,
                indent: p
            }, utils: {replaceTextEndOfLine: d}
        } = qe(), y = Um(), g = Jm(), {insertPragma: c} = po(), f = fo(), E = Ot(), _ = Do(), {
            hasFlowShorthandAnnotationComment: w,
            hasComment: F,
            CommentCheckFlags: N,
        ...
        } = Ke(), {locStart: o, locEnd: h} = ut(), v = _t(), {
            printHtmlBinding: S,
            isVueEventBindingExpression: b
        } = rd(), {printAngular: B} = nd(), {
            printJsx: k,
            hasJsxIgnoreComment: M
        } = ud(), {printFlow: R} = id(), {printTypescript: q} = od(), {
        ...
        } = vo(), {printTernary: de} = Co(), {printTemplateLiteral: ue} = Lt(), {printArray: Fe} = Qt(), {printObject: z} = tu(), {
            printClass: U,
            printClassMethod: Z,
            printClassProperty: se
        } = tr(), {printProperty: fe} = er(), {
            printFunction: ge,
            printArrowFunction: he,
            printMethod: we,
            printReturnStatement: ke,
            printThrowStatement: Re
        } = Or(), {printCallExpression: Ne} = yo(), {
            printVariableDeclarator: Pe,
            printAssignmentExpression: oe
        } = Zt(), {printBinaryishExpression: H} = Zn(), {printSwitchCaseConsequent: pe} = Eo(), {printMemberExpression: X} = go(), {
            printBlock: le,
            printBlockBody: Ae
        } = Fo(), {printComment: Ee} = ld(), {printLiteral: De} = cd(), {printDecorators: A} = eu();

        function G(Ce, Be, ve, ze) {
            let xe = re(Ce, Be, ve, ze);
            if (!xe) return "";
            let Ye = Ce.getValue(), {type: Se} = Ye;
            if (Se === "ClassMethod" || Se === "ClassPrivateMethod" || Se === "ClassProperty" || Se === "ClassAccessorProperty" || Se === "AccessorProperty" || Se === "TSAbstractAccessorProperty" || Se === "PropertyDefinition" || Se === "TSAbstractPropertyDefinition" || Se === "ClassPrivateProperty" || Se === "MethodDefinition" || Se === "TSAbstractMethodDefinition" || Se === "TSDeclareMethod") return xe;
            let Ie = [xe], Oe = A(Ce, Be, ve), Je = Ye.type === "ClassExpression" && Oe;
            if (Oe && (Ie = [...Oe, xe], !Je)) return l(Ie);
            if (!E(Ce, Be)) return ze && ze.needsSemi && Ie.unshift(";"), Ie.length === 1 && Ie[0] === xe ? xe : Ie;
            ...
            switch (xe.type) {
                ...
                case"ExpressionStatement": {
                    if (Be.parser === "__vue_event_binding" || Be.parser === "__vue_ts_event_binding") {
                        ...
                        if (Oe.type === "Program" && Oe.body.length === 1 && Oe.body[0] === xe) return [ve("expression"), b(xe.expression) ? ";" : ""]
                    }
                    let Ie = t(Ce, Be, !0, Oe => {
                        let {marker: Je} = Oe;
                        return Je === C
                ...
                case"ParenthesizedExpression":
                    return !F(xe.expression) && (xe.expression.type === "ObjectExpression" || xe.expression.type === "ArrayExpression") ? ["(", ve("expression"), ")"] : l(["(", p([i, ve("expression")]), i, ")"]);
                case"AssignmentExpression":
                    return oe(Ce, Be, ve);
                ...
                case"BindExpression":
                    return xe.object && Se.push(ve("object")), Se.push(l(p([i, L(Ce, Be, ve)]))), Se;
                case"Identifier":
                ...
                case"SequenceExpression": {
                    ...
                    if (Ie.type === "ExpressionStatement" || Ie.type === "ForStatement") {
                        ...
                        return Ce.each((Je, be) => {
                            be === 0 ? Oe.push(ve()) : Oe.push(",", p([n, ve()]))
                        }, "expressions"), l(Oe)
                    }
                ...
                case"UnaryExpression":
                    return Se.push(xe.operator), /[a-z]$/.test(xe.operator) && Se.push(" "), F(xe.argument) ? Se.push(l(["(", p([i, ve("argument")]), i, ")"])) : Se.push(ve("argument")), Se;
                case"UpdateExpression":
                    return Se.push(ve("argument"), xe.operator), xe.prefix && Se.reverse(), Se;
                case"ConditionalExpression":
                    return de(Ce, Be, ve);
                case"VariableDeclaration": {
                    let Ie = Ce.map(ve, "declarations"), Oe = Ce.getParentNode(),
                        Je = Oe.type === "ForStatement" || Oe.type === "ForInStatement" || Oe.type === "ForOfStatement",
                        be = xe.declarations.some(Me => Me.init), je;
                    return Ie.length === 1 && !F(xe.declarations[0]) ? je = Ie[0] : Ie.length > 0 && (je = p(Ie[0])), Se = [xe.declare ? "declare " : "", xe.kind, je ? [" ", je] : "", p(Ie.slice(1).map(Me => [",", be && !Je ? u : n, Me]))], Je && Oe.body !== xe || Se.push(Ye), l(Se)
                }
                case"WithStatement":
                    return l(["with (", ve("object"), ")", V(xe.body, ve("body"))]);
                case"IfStatement": {
                    let Ie = V(xe.consequent, ve("consequent")), Oe = l(["if (", l([p([i, ve("test")]), i]), ")", Ie]);
                    if (Se.push(Oe), xe.alternate) {
                        let Je = F(xe.consequent, N.Trailing | N.Line) || $(xe),
                            be = xe.consequent.type === "BlockStatement" && !Je;
                ...
                case"ForStatement": {
                    let Ie = V(xe.body, ve("body")), Oe = t(Ce, Be, !0), Je = Oe ? [Oe, i] : "";
                    return !xe.init && !xe.test && !xe.update ? [Je, l(["for (;;)", Ie])] : [Je, l(["for (", l([p([i, ve("init"), ";", n, ve("test"), ";", n, ve("update")]), i]), ")", Ie])]
                }
                case"WhileStatement":
                    return l(["while (", l([p([i, ve("test")]), i]), ")", V(xe.body, ve("body"))]);
                case"ForInStatement":
                ...
                case"CatchClause":
                    if (xe.param) {
                        let Ie = F(xe.param, Je => !v(Je) || Je.leading && s(Be.originalText, h(Je)) || Je.trailing && s(Be.originalText, o(Je), {backwards: !0})),
                            Oe = ve("param");
                        return ["catch ", Ie ? ["(", p([i, Oe]), i, ") "] : ["(", Oe, ") "], ve("body")]
                    }
                    return ["catch ", ve("body")];
                case"SwitchStatement":
                    return [l(["switch (", p([i, ve("discriminant")]), i, ")"]), " {", xe.cases.length > 0 ? p([u, a(u, Ce.map((Ie, Oe, Je) => {
                        let be = Ie.getValue();
    ...
    "src/language-js/printer-estree-json.js"(e, r) {
        ...
        function p(d, y) {
            ...
            if (g === "ObjectProperty") {
                let {key: c} = d;
                c.type === "Identifier" ? y.key = {
                    type: "StringLiteral",
                    value: c.name
                } : c.type === "NumericLiteral" && (y.key = {type: "StringLiteral", value: String(c.value)});
                return
            }
    ...
    "src/language-js/options.js"(e, r) {
        ...
        r.exports = {
            ...
            trailingComma: {
                ...
                category: s,
                type: "choice",
                default: [{since: "0.0.0", value: !1}, {since: "0.19.0", value: "none"}, {
                    since: "2.0.0",
                    value: "es5"
                }],
    ...
    "src/language-js/index.js"(e, r) {
        ...
        var t = wt(), s = pd(), a = fd(), n = Dd(), u = md(), i = [t(In(), p => ({
                ...
                parsers: ["json"],
                vscodeLanguageIds: ["json"],
                extensions: p.extensions.filter(d => d !== ".jsonl")
            })), t(yd(), p => ({
                since: "1.5.0",
                parsers: ["json"],
                vscodeLanguageIds: ["jsonc"],
                filenames: [...p.filenames, ".eslintrc", ".swcrc"]
            })), t(hd(), () => ({since: "1.13.0", parsers: ["json5"], vscodeLanguageIds: ["json5"]}))],
            l = {estree: s, "estree-json": a};
    ...
    "src/language-css/clean.js"(e, r) {
        "use strict";
        ne();
        var {isFrontMatterNode: t} = Ue(), s = lt(),
        ...
        function n(i, l, p) {
            ...
            if (i.type === "css-atrule" && i.name.toLowerCase() === "supports" && delete l.value, i.type === "selector-unknown" && delete l.value, i.type === "value-comma_group") {
                ...
                d !== -1 && (l.groups[d].unit = "", l.groups.splice(d + 1, 0, {
                    type: "value-word",
                    value: "...",
                    isColor: !1,
                    isHex: !1
            ...
            if (i.type === "value-comma_group" && i.groups.some(d => d.type === "value-atword" && d.value.endsWith("[") || d.type === "value-word" && d.value.startsWith("]"))) return {
                type: "value-atword",
                value: i.groups.map(d => d.value).join(""),
    ...
    "src/utils/front-matter/print.js"(e, r) {
        ...
        function a(n, u) {
            if (n.lang === "yaml") {
                let i = n.value.trim(), l = i ? u(i, {parser: "yaml"}, {stripTrailingHardline: !0}) : "";
...
` : "") + t.insertPragma(l)
    ...
    "src/language-css/utils/index.js"(e, r) {
        ...
        r.exports = {
            ...
            getPropOfDeclNode: n,
            maybeToLowerCase: p,
            insideValueFunctionNode: d,
            insideICSSRuleNode: y,
            insideAtRuleNode: g,
            ...
            isForKeywordNode: w,
            isURLFunctionNode: f,
            isIfElseKeywordNode: F,
            hasComposesNode: B,
            hasParensAroundNode: k,
            hasEmptyRawBefore: M,
            isDetachedRulesetCallNode: h,
...
`, a) + 1;
    ...
    "src/language-css/loc.js"(e, r) {
        ...
        function d(c) {
            let f = "initial", E = "initial", _, w = !1, F = [];
...
` || x === "\r") && (w && F.push([_, N]), f = "initial", w = !1);
    ...
    "src/language-css/printer-postcss.js"(e, r) {
        ...
        var t = lt(), {
            ...
            isParenGroupNode: le
        } = Ad(), {locStart: Ae, locEnd: Ee} = xd(), De = bd(), A = Td(), G = Nd();
        ...
        function ye(be, je, Me) {
            ...
            switch (ae.type) {
                ...
                case"css-decl": {
                    let Ve = be.getParentNode(), {between: We} = ae.raws, Xe = We.trim(), st = Xe === ":",
                ...
                case"css-atrule": {
                    ...
                    if (De(je)) {
                        ...
                        if (ae.variable) return ["@", ae.name, ": ", ae.value ? Me("value") : "", ae.raws.between.trim() ? ae.raws.between.trim() + " " : "", ae.nodes ? ["{", E([ae.nodes.length > 0 ? g : "", Ce(be, je, Me)]), g, "}"] : "", We ? "" : ";"]
                    }
                ...
                case"media-query":
                    return [p(" ", be.map(Me, "nodes")), B(be, ae) ? "" : ","];
                case"media-type":
                ...
                case"media-unknown":
                    return ae.value;
                case"selector-root":
                    return c([h(be, "custom-selector") ? [D(be, "css-atrule").customSelector, d] : "", p([",", h(be, ["extend", "custom-selector", "nest"]) ? d : y], be.map(Me, "nodes"))]);
                case"selector-selector":
                    return c(E(be.map(Me, "nodes")));
                ...
                case"selector-pseudo":
                    return [m(ae.value), l(ae.nodes) ? c(["(", E([g, p([",", d], be.map(Me, "nodes"))]), g, ")"]) : ""];
                ...
                case"value-comma_group": {
                    let Ve = be.getParentNode(), We = be.getParentNode(1), Xe = T(be),
                        st = Xe && Ve.type === "value-value" && (Xe === "grid" || Xe.startsWith("grid-template")),
                        O = D(be, "css-atrule"), me = O && k(O), _e = ae.groups.some(at => ge(at)),
                        He = be.map(Me, "groups"), Ge = [], it = C(be, "url"), Qe = !1, rt = !1;
                    for (let at = 0; at < ae.groups.length; ++at) {
                        var tt;
                        Ge.push(He[at]);
                        let Ze = ae.groups[at - 1], Le = ae.groups[at], $e = ae.groups[at + 1], nr = ae.groups[at + 2];
                        if (it) {
                            ($e && Q($e) || Q(Le)) && Ge.push(" ");
                            continue
                        }
                        if (h(be, "forward") && Le.type === "value-word" && Le.value && Ze !== void 0 && Ze.type === "value-word" && Ze.value === "as" && $e.type === "value-operator" && $e.value === "*" || !$e || Le.type === "value-word" && Le.value.endsWith("-") && pe($e)) continue;
                        ...
                        let qr = j(Le), su = j($e);
                        if ((qr && he($e) || su && ke(Le)) && de($e) || !Ze && L(Le) || C(be, "calc") && (Q(Le) || Q($e) || V(Le) || V($e)) && de($e)) continue;
                        let No = (Q(Le) || V(Le)) && at === 0 && ($e.type === "value-number" || $e.isHex) && We && oe(We) && !de($e),
                            iu = nr && nr.type === "value-func" || nr && Re(nr) || Le.type === "value-func" || Re(Le),
                            au = $e.type === "value-func" || Re($e) || Ze && Ze.type === "value-func" || Ze && Re(Ze);
                ...
                case"value-paren_group": {
                    let Ve = be.getParentNode();
                    if (Ve && ee(Ve) && (ae.groups.length === 1 || ae.groups.length > 0 && ae.groups[0].type === "value-comma_group" && ae.groups[0].groups.length > 0 && ae.groups[0].groups[0].type === "value-word" && ae.groups[0].groups[0].value.startsWith("data:"))) return [ae.open ? Me("open") : "", p(",", be.map(Me, "groups")), ae.close ? Me("close") : ""];
                    if (!ae.open) {
                        let it = be.map(Me, "groups"), Qe = [];
                        for (let rt = 0; rt < it.length; rt++) rt !== 0 && Qe.push([",", d]), Qe.push(it[rt]);
                        return c(E(f(Qe)))
                    }
                    let We = fe(be), Xe = t(ae.groups), st = Xe && Xe.type === "value-comment", O = Fe(ae, Ve),
                        me = X(ae, Ve), _e = me || We && !O, He = me || O,
                        Ge = c([ae.open ? Me("open") : "", E([g, p([d], be.map((it, Qe) => {
                ...
                case"value-func":
                    return [ae.value, h(be, "supports") && Pe(ae) ? " " : "", Me("group")];
                case"value-paren":
                    return ae.value;
                case"value-number":
        ...
        function Ce(be, je, Me) {
            ...
            return be.each((nt, tt, Ve) => {
                ...
                tt !== Ve.length - 1 && (Ve[tt + 1].type === "css-comment" && !n(je.originalText, Ae(Ve[tt + 1]), {backwards: !0}) && !u(Ve[tt]) || Ve[tt + 1].type === "css-atrule" && Ve[tt + 1].name === "else" && Ve[tt].type !== "css-comment" ? ae.push(" ") : (ae.push(je.__isHTMLStyleAttribute ? d : y), i(je.originalText, nt.getValue(), Ee) && !u(Ve[tt]) && ae.push(y)))
            }, "nodes"), ae
        }

        var Be = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gs, ve = /(?:\d*\.\d+|\d+\.?)(?:[Ee][+-]?\d+)?/g, ze = /[A-Za-z]+/g,
            xe = /[$@]?[A-Z_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/g,
            Ye = new RegExp(Be.source + `|(${xe.source})?(${ve.source})(${ze.source})?`, "g");

        function Se(be, je) {
            return be.replace(Be, Me => a(Me, je))
        }
        ...
        function Oe(be) {
            return be.replace(Ye, (je, Me, ae, nt, tt) => !ae && nt ? Je(nt) + m(tt || "") : je)
        }
    ...
    "src/language-css/index.js"(e, r) {
        "use strict";
        ne();
        var t = wt(), s = wd(), a = _d(), n = Pd(), u = [t(Id(), l => ({
            since: "1.4.0",
            parsers: ["css"],
        ...
        })), t(Od(), () => ({since: "1.4.0", parsers: ["scss"], vscodeLanguageIds: ["scss"]}))], i = {postcss: s};
    ...
    "src/language-handlebars/utils.js"(e, r) {
        ...
        function p(x) {
            return x.selfClosing === !0 || l(x.tag) || u(x) && x.children.every(I => d(I))
        }
        ...
        function E(x, I) {
            var P, $, D, T;
            let m = x.getValue(), C = (P = x.getParentNode(0)) !== null && P !== void 0 ? P : {},
    ...
    "src/language-handlebars/printer-glimmer.js"(e, r) {
        ...
        var {
            builders: {
                ...
                line: p,
                softline: d
            }, utils: {getDocParts: y, replaceTextEndOfLine: g}
        } = qe(), {getPreferredQuote: c, isNonEmptyArray: f} = Ue(), {locStart: E, locEnd: _} = qd(), w = Md(), {
            getNextNode: F,
            getPreviousNode: N,
            hasPrettierIgnore: x,
        ...
        function h(H, pe, X) {
            let le = H.getValue();
            if (!le) return "";
            if (x(H)) return pe.originalText.slice(E(le), _(le));
            ...
            switch (le.type) {
                ...
                case"ElementNode": {
                    let Ee = a(S(H, X)),
                        De = pe.htmlWhitespaceSensitivity === "ignore" && P(H, ["ElementNode"]) ? d : "";
                ...
                case"AttrNode": {
                    ...
                    if (Ee && le.value.chars === "" && E(le.value) === _(le.value)) return le.name;
                ...
                case"TextNode": {
                    ...
                    if (De) {
                        if (De === "class") {
                            let Ye = Ee.trim().split(/\s+/).join(" "), Se = !1, Ie = !1;
                    ...
                    let ze = "", xe = "";
                    return ve === 0 && P(H, ["MustacheStatement"]) && (xe = " "), Be === 0 && T(H, ["MustacheStatement"]) && (ze = " "), re && (Be = 0, ze = ""), ye && (ve = 0, xe = ""), Ee = Ee.replace(/^[\t\n\f\r ]+/g, ze).replace(/[\t\n\f\r ]+$/, xe), [...ge(Be), s(Fe(Ee)), ...ge(ve)]
                }
                case"MustacheCommentStatement": {
                    let Ee = E(le), De = _(le), A = pe.originalText.charAt(Ee + 2) === "~",
                        G = pe.originalText.charAt(De - 3) === "~", re = le.value.includes("}}") ? "--" : "";
        ...
        function S(H, pe) {
            let X = H.getValue(), le = ["attributes", "modifiers", "comments"].filter(Ee => f(X[Ee])),
        ...
        function k(H) {
            let pe = H.escaped === !1 ? "{{{" : "{{", X = H.strip && H.strip.open ? "~" : "";
            return [pe, X]
        }
        ...
        function j(H, pe) {
            ...
            return Ae && le.push(a(Ae)), f(X.program.blockParams) && le.push(oe(X.program)), a([R(X), Ne(H, pe), le.length > 0 ? i([p, l(p, le)]) : "", d, q(X)])
        }
        ...
        function ie(H, pe, X) {
            ...
            return a([Q(Ae), ["else", " ", X], i([p, a(Pe(H, pe)), ...f(le.program.blockParams) ? [p, oe(le.program)] : []]), d, V(Ae)])
        }
...
`).length - 1
    ...
    "src/language-handlebars/index.js"(e, r) {
        ...
        ne();
        var t = wt(), s = Vd(), a = Wd(),
            n = [t(Hd(), () => ({since: "2.3.0", parsers: ["glimmer"], vscodeLanguageIds: ["handlebars"]}))],
            u = {glimmer: s};
...
` + a
    ...
    "src/language-graphql/printer-graphql.js"(e, r) {
        ...
        } = qe(), {isNextLineEmpty: p, isNonEmptyArray: d} = Ue(), {insertPragma: y} = Ud(), {
            locStart: g,
            locEnd: c
        } = Jd();
        ...
        function f(P, $, D) {
            ...
            switch (T.kind) {
                case"Document": {
                    let m = [];
                    return P.each((C, o, h) => {
                        m.push(D()), o !== h.length - 1 && (m.push(s), p($.originalText, C.getValue(), c) && m.push(s))
                    }, "definitions"), [...m, s]
                }
                ...
                case"Field":
                    return u([T.alias ? [D("alias"), ": "] : "", D("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, D, "arguments"))]), n, ")"]) : "", E(P, D, T), T.selectionSet ? " " : "", D("selectionSet")]);
                case"Name":
                    return T.value;
                case"StringValue": {
                    if (T.block) {
...
`);
                ...
                case"ObjectTypeDefinition":
                    return [D("description"), T.description ? s : "", T.kind === "ObjectTypeExtension" ? "extend " : "", "type ", D("name"), T.interfaces.length > 0 ? [" implements ", ...N(P, $, D)] : "", E(P, D, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, D, "fields"))]), s, "}"] : ""];
                case"FieldDefinition":
                    return [D("description"), T.description ? s : "", D("name"), T.arguments.length > 0 ? u(["(", i([n, t([l("", ", "), n], _(P, $, D, "arguments"))]), n, ")"]) : "", ": ", D("type"), E(P, D, T)];
                ...
                case"EnumTypeDefinition":
                    return [D("description"), T.description ? s : "", T.kind === "EnumTypeExtension" ? "extend " : "", "enum ", D("name"), E(P, D, T), T.values.length > 0 ? [" {", i([s, t(s, _(P, $, D, "values"))]), s, "}"] : ""];
                ...
                case"InputObjectTypeDefinition":
                    return [D("description"), T.description ? s : "", T.kind === "InputObjectTypeExtension" ? "extend " : "", "input ", D("name"), E(P, D, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, D, "fields"))]), s, "}"] : ""];
                case"SchemaExtension":
                    return ["extend schema", E(P, D, T), ...T.operationTypes.length > 0 ? [" {", i([s, t(s, _(P, $, D, "operationTypes"))]), s, "}"] : []];
                case"SchemaDefinition":
                    return [D("description"), T.description ? s : "", "schema", E(P, D, T), " {", T.operationTypes.length > 0 ? i([s, t(s, _(P, $, D, "operationTypes"))]) : "", s, "}"];
                case"OperationTypeDefinition":
                    return [D("operation"), ": ", D("type")];
                case"InterfaceTypeExtension":
                case"InterfaceTypeDefinition":
                    return [D("description"), T.description ? s : "", T.kind === "InterfaceTypeExtension" ? "extend " : "", "interface ", D("name"), T.interfaces.length > 0 ? [" implements ", ...N(P, $, D)] : "", E(P, D, T), T.fields.length > 0 ? [" {", i([s, t(s, _(P, $, D, "fields"))]), s, "}"] : ""];
                case"FragmentSpread":
        ...
        function _(P, $, D, T) {
            return P.map((m, C, o) => {
                let h = D();
                return C < o.length - 1 && p($.originalText, m.getValue(), c) ? [h, s] : h
            }, T)
        }
        ...
        function N(P, $, D) {
            ...
            for (let h = 0; h < C.length; h++) {
                ...
                let S = C[h + 1];
                if (S) {
                    let b = $.originalText.slice(v.loc.end, S.loc.start), B = b.includes("#"),
                        k = b.replace(/#.*/g, "").trim();
                    m.push(k === "," ? "," : " &", B ? a : " ")
                }
            }
...
`) && ($.value = $.value.trim())
    ...
    "src/language-graphql/index.js"(e, r) {
        "use strict";
        ne();
        var t = wt(), s = zd(), a = Xd(), n = Kd(),
            u = [t(Yd(), () => ({since: "1.5.0", parsers: ["graphql"], vscodeLanguageIds: ["graphql"]}))],
            i = {graphql: s};
        r.exports = {languages: u, options: a, printers: i, parsers: n}
    }
}), So = te({
    ...
    "src/language-markdown/utils.js"(e, r) {
        "use strict";
        ne();
        var {getLast: t} = Ue(), {locStart: s, locEnd: a} = xo(), {
                cjkPattern: n,
                kPattern: u,
            ...
            p = [...l, "tableCell", "paragraph", "heading"], d = new RegExp(u), y = new RegExp(i);

        function g(F, N) {
            let x = "non-cjk", I = "cj-letter", P = "k-letter", $ = "cjk-punctuation", D = [],
                T = (N.proseWrap === "preserve" ? F : F.replace(new RegExp(`(${n})
(${n})`, "g"), "$1$2")).split(/([\t\n ]+)/);
...
` : " "
                ...
                for (let [v, S] of h.entries()) if (!((v === 0 || v === h.length - 1) && S === "")) {
                    if (v % 2 === 0) {
                        S !== "" && m({
                            ...
                            value: S,
                            kind: x,
                            hasLeadingPunctuation: y.test(S[0]),
                            hasTrailingPunctuation: y.test(t(S))
                        });
                        continue
                    }
                    m(y.test(S) ? {
            ...
            function m(C) {
                ...
                o && o.type === "word" && (o.kind === x && C.kind === I && !o.hasTrailingPunctuation || o.kind === I && C.kind === x && !C.hasLeadingPunctuation ? D.push({
                    type: "whitespace",
                    value: " "
                }) : !h(x, $) && ![o.value, C.value].some(v => /\u3000/.test(v)) && D.push({
                    type: "whitespace",
                    value: ""
                })), D.push(C);
        ...
        function f(F, N) {
            if (!F.ordered || F.children.length < 2) return !1;
            let x = Number(c(F.children[0], N.originalText).numberText),
                I = Number(c(F.children[1], N.originalText).numberText);
...
`) ? x.slice(0, -1) : x
        ...
        function w(F) {
            if ((F == null ? void 0 : F.type) !== "link" || F.children.length !== 1) return !1;
            let [N] = F.children;
    ...
    "src/language-markdown/embed.js"(e, r) {
        ...
        } = qe(), i = ru(), {getFencedCodeBlockValue: l} = nu();
        ...
        function p(d, y, g, c) {
            ...
            if (f.type === "code" && f.lang !== null) {
                ...
                if (E) {
                    ...
                    let N = g(l(f, c.originalText), F, {stripTrailingHardline: !0});
            ...
            switch (f.type) {
                case"front-matter":
                    return i(f, g);
                case"importExport":
                    return [g(f.value, {parser: "babel"}, {stripTrailingHardline: !0}), a];
                case"jsx":
                    return g(`<$>${f.value}</$>`, {
...
.*-->`].join("|"), "m"), l = n.match(i);
        ...
        r.exports = {
            startWithPragma: a, hasPragma: n => a(t(n).content.trimStart()), insertPragma: n => {
                let u = t(n), i = `<!-- @${s[0]} -->`;
...
${u.content}`
    ...
    "src/language-markdown/print-preprocess.js"(e, r) {
        ...
        function i(w, F) {
            return w = d(w, F), w = c(w), w = p(w, F), w = E(w, F), w = _(w, F), w = f(w, F), w = l(w), w = y(w), w
        }
        ...
        function y(w) {
            return g(w, (F, N) => F.type === "importExport" && N.type === "importExport", (F, N) => ({
                type: "importExport", value: F.value + `
...
` + N.value, position: {start: F.position.start, end: N.position.end}
        ...
        function g(w, F, N) {
            return a(w, x => {
                ...
                let I = x.children.reduce((P, $) => {
                    let D = t(P);
                    return D && F(D, $) ? P.splice(-1, 1, N(D, $)) : P.push($), P
                }, []);
        ...
        function c(w) {
            return g(w, (F, N) => F.type === "text" && N.type === "text", (F, N) => ({
                type: "text",
                value: F.value + N.value,
                position: {start: F.position.start, end: N.position.end}
            }))
        }
        ...
        function _(w, F) {
            ...
            function x(I) {
                ...
                let [P, $] = I.children;
                if (s(P, F.originalText).leadingSpaces.length > 1) return !0;
                let T = N(P);
                if (T === -1) return !1;
                if (I.children.length === 1) return T % F.tabWidth === 0;
                let m = N($);
                return T !== m ? !1 : T % F.tabWidth === 0 ? !0 : s($, F.originalText).leadingSpaces.length > 1
            }
        }
    ...
    "src/language-markdown/clean.js"(e, r) {
        "use strict";
        ne();
        var t = So(), {isFrontMatterNode: s} = Ue(), {startWithPragma: a} = bo(), n = new Set(["position", "raw"]);
    ...
    "src/language-markdown/printer-markdown.js"(e, r) {
        ...
        var t = So(), {
                ...
                }, utils: {normalizeDoc: I, replaceTextEndOfLine: P}, printer: {printDocToString: $}
            } = qe(), D = eg(), {insertPragma: T} = bo(), {locStart: m, locEnd: C} = xo(), o = tg(), h = rg(), {
                ...
                isAutolink: R
            } = nu(), q = new Set(["importExport"]), J = ["heading", "tableCell", "link", "wikiLink"],
            ...
            switch (X.type) {
                ...
                case"word": {
                    let le = X.value.replace(/\*/g, "\\$&").replace(new RegExp([`(^|${B})(_+)`, `(_+)(${B}|$)`].join("|"), "g"), (De, A, G, re, ye) => (G ? `${A}${G}` : `${re}${ye}`).replace(/_/g, "\\_")),
                        Ae = (De, A, G) => De.type === "sentence" && G === 0, Ee = (De, A, G) => R(De.children[G - 1]);
                ...
                case"whitespace": {
                    let le = oe.getParentNode(), Ae = le.children.indexOf(X), Ee = le.children[Ae + 1],
                ...
                case"emphasis": {
                    ...
                    if (R(X.children[0])) le = H.originalText[X.position.start.offset]; else {
                        let Ae = oe.getParentNode(), Ee = Ae.children.indexOf(X), De = Ae.children[Ee - 1],
                            A = Ae.children[Ee + 1];
...
`) return c;
        ...
        function K(oe, H, pe) {
            ...
            function G(ye) {
                return `| ${le.map((Be, ve) => {
                    let ze = X.align[ve], xe = ze === "center" || ze === "left" ? ":" : "-",
                        Ye = ze === "center" || ze === "right" ? ":" : "-", Se = ye ? "-" : "-".repeat(Be - 2);
                    return `${xe}${Se}${Ye}`
                }).join(" | ")} |`
            }
        ...
        function ue(oe, H, pe) {
            let X = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : {}, {postprocessor: le} = X,
                Ae = X.processor || (() => pe()), Ee = oe.getValue(), De = [], A;
            return oe.each((G, re) => {
        ...
        function Z(oe, H) {
            let pe = H.parts.length === 0, X = k.includes(oe.type),
        ...
        function we(oe, H) {
            ...
            let X = oe.split("'").length - 1, le = oe.split('"').length - 1,
    ...
    "src/language-markdown/index.js"(e, r) {
        "use strict";
        ne();
        var t = wt(), s = ng(), a = ug(), n = sg(), u = [t(Aa(), l => ({
            since: "1.8.0",
            parsers: ["markdown"],
    ...
    "src/language-html/utils/index.js"(e, r) {
        ...
        var {inferParserByLanguage: t, isFrontMatterNode: s} = Ue(), {
                ...
                CSS_DISPLAY_TAGS: p,
                CSS_DISPLAY_DEFAULT: d,
                CSS_WHITE_SPACE_TAGS: y,
                CSS_WHITE_SPACE_DEFAULT: g
            } = og(), c = lg(), f = new Set(["	", `
`, "\f", "\r", " "]), E = A => A.replace(/^[\t\n\f\r ]+/, ""), _ = A => A.replace(/[\t\n\f\r ]+$/, ""),
            w = A => E(_(A)), F = A => A.replace(/^[\t\f\r ]*\n/g, ""), N = A => F(_(A)),
            x = A => A.split(/[\t\n\f\r ]+/), I = A => A.match(/^[\t\n\f\r ]*/)[0], P = A => {
                let [, G, re, ye] = A.match(/^([\t\n\f\r ]*)(.*?)([\t\n\f\r ]*)$/s);
...
`);
        ...
        var D = typeof window < "u" && window,
            ...
            m = typeof globalThis < "u" && globalThis, C = m || D || T;
        e.global = C
    }
}), Dg = te({
    ...
    "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(e) {
        ...
        var r = cg(), t = Dg(), s = class {
            ...
            moveBy(d) {
                let y = this.file.content, g = y.length, c = this.offset, f = this.line, E = this.col;
...
` && ++_ == y));) ;
        ...
        function l(d, y) {
            let g = t.identifierModuleUrl(y),
                c = g != null ? `in ${d} ${t.identifierName(y)} in ${g}` : `in ${d} ${t.identifierName(y)}`,
                f = new a("", c);
    ...
    "src/language-html/print-preprocess.js"(e, r) {
        ...
        var {ParseSourceSpan: t} = mg(), {
            ...
            isLeadingSpaceSensitiveNode: d,
            isTrailingSpaceSensitiveNode: y,
            isWhitespaceSensitiveNode: g,
            isVueScriptTag: c
        } = qt(), f = [_, w, N, I, P, T, $, D, m, x, C];
...
` + a.replace(/^\s*\n/, "")
    ...
    "src/language-html/print/tag.js"(e, r) {
        "use strict";
        ne();
        var t = Yt(), {isNonEmptyArray: s} = Ue(), {
            builders: {indent: a, join: n, line: u, softline: i, hardline: l},
            utils: {replaceTextEndOfLine: p}
        } = qe(), {locStart: d, locEnd: y} = uu(), {
            isTextLikeNode: g,
            getLastDescendant: c,
            isPreLikeNode: f,
            hasPrettierIgnore: E,
        ...
        r.exports = {
            ...
            needsToBorrowNextOpeningTagStartMarker: h,
...
` || $ === "\f" || $ === "\r"
                ...
                function I() {
                    for (u(l), _ = "", w = "in descriptor"; ;) {
                        if (F = t.charAt(N), w === "in descriptor") if (n(F)) _ && (E.push(_), _ = "", w = "after descriptor"); else if (F === ",") {
                            N += 1, _ && E.push(_), P();
                            return
                        } else if (F === "(") _ = _ + F, w = "in parens"; else if (F === "") {
                            _ && E.push(_), P();
                            return
                        } else _ = _ + F; else if (w === "in parens") if (F === ")") _ = _ + F, w = "in descriptor"; else if (F === "") {
                            E.push(_), P();
                            return
                        } else _ = _ + F; else if (w === "after descriptor" && !n(F)) if (F === "") {
                            P();
                            return
                ...
                function P() {
                    var $ = !1, D, T, m, C, o = {}, h, v, S, b, B;
                    for (C = 0; C < E.length; C++) h = E[C], v = h[h.length - 1], S = h.substring(0, h.length - 1), b = parseInt(S, 10), B = parseFloat(S), g.test(S) && v === "w" ? ((D || T) && ($ = !0), b === 0 ? $ = !0 : D = b) : c.test(S) && v === "x" ? ((D || T || m) && ($ = !0), B < 0 ? $ = !0 : T = B) : g.test(S) && v === "h" ? ((m || T) && ($ = !0), b === 0 ? $ = !0 : m = b) : $ = !0;
                    $ ? a && a.error && a.error("Invalid srcset descriptor found in '" + t + "' at '" + h + "'.") : (o.url = f, D && (o.w = D), T && (o.d = T), m && (o.h = m), x.push(o))
                }
            }
        })
    }
    ...
    "src/language-html/syntax-attribute.js"(e, r) {
        ...
        function u(l) {
            ...
            let c = d ? "w" : y ? "h" : "d", f = d ? "w" : y ? "h" : "x", E = I => Math.max(...I),
                _ = p.map(I => I.url), w = E(_.map(I => I.length)),
                F = p.map(I => I[c]).map(I => I ? I.toString() : ""), N = F.map(I => {
                    let P = I.indexOf(".");
    ...
    "src/language-html/syntax-vue.js"(e, r) {
        ...
        function s(i, l) {
            ...
            })), " ", d, " ", l(y, {parser: "__js_expression"}, {stripTrailingHardline: !0})]
        }
        ...
        function a(i) {
            ...
            if (!E.some((_, w) => !_ && (w === 0 || E.slice(w + 1).some(Boolean)))) return {
                left: E.filter(Boolean).join(","),
                operator: y[2],
                right: g.for
            }
        }
        ...
        function n(i, l) {
            return l(`function _(${i}) {}`, {parser: "babel", __isVueBindings: !0})
        }
    ...
    "src/language-html/embed.js"(e, r) {
        ...
        ne();
        var {
            builders: {breakParent: t, group: s, hardline: a, indent: n, line: u, fill: i, softline: l},
            utils: {mapDoc: p, replaceTextEndOfLine: d}
        } = qe(), y = ru(), {
            printClosingTag: g,
            printClosingTagSuffix: c,
            needsToBorrowPrevClosingTagEndMarker: f,
            printOpeningTagPrefix: E,
            printOpeningTag: _
        } = rr(), {printImgSrcset: w, printClassNames: F} = hg(), {
            printVueFor: N,
            printVueBindings: x,
            ...
            isVueSfcBindingsAttribute: h,
            getTextValueParts: v
        } = qt(), S = To();

        function b(k, M, R) {
            let q = ee => new RegExp(ee.join("|")).test(k.fullName), J = () => C(k.value), L = !1, Q = (ee, ce) => {
                ...
                ie = (ee, ce) => M(ee, Object.assign({__onHtmlBindingRoot: Q, __embeddedInHtml: !0}, ce));
            ...
            if (k.fullName === "style" && !R.parentParser) {
                let ee = J();
                if (!ee.includes("{{")) return j(ie(ee, {parser: "css", __isHTMLStyleAttribute: !0}))
            }
            if (R.parser === "vue") {
                if (k.fullName === "v-for") return N(J(), ie);
                if (o(k) || h(k, R)) return x(J(), ie);
            ...
            if (R.parser === "angular") {
                let ee = (z, U) => ie(z, Object.assign(Object.assign({}, U), {}, {trailingComma: "none"})),
                    ce = ["^\\*"], W = ["^\\(.+\\)$", "^on-"],
                    K = ["^\\[.+\\]$", "^bind(on)?-", "^ng-(if|show|hide|class|style)$"], de = ["^i18n(-.+)?$"];
                ...
                if (ue.test(Fe)) {
                    let z = [];
                    for (let [U, Z] of Fe.split(ue).entries()) if (U % 2 === 0) z.push(d(Z)); else try {
                        z.push(s(["{{", n([u, ee(Z, {
                ...
                case"element": {
                    ...
                    if (!J.isSelfClosing && $(J, q)) {
                        ...
                        return V || (j = R(T(Q), {
                            parser: L,
                            __embeddedInHtml: !0
                        }, {stripTrailingHardline: !0}), V = j === ""), [E(J, q), s(_(k, q, M)), V ? "" : a, j, V ? "" : a, g(J, q), c(J, q)]
                    }
                    break
                }
                case"text": {
    ...
    "src/language-html/print/children.js"(e, r) {
        ...
        ne();
        var {
            builders: {breakParent: t, group: s, ifBreak: a, line: n, softline: u, hardline: i},
            utils: {replaceTextEndOfLine: l}
        } = qe(), {locStart: p, locEnd: d} = uu(), {
            forceBreakChildren: y,
            forceNextEmptyLine: g,
            isTextLikeNode: c,
            hasPrettierIgnore: f,
            preferHardlineAsLeadingSpaces: E
        } = qt(), {
            printOpeningTagPrefix: _,
            needsToBorrowNextOpeningTagStartMarker: w,
            printOpeningTagStartMarker: F,
    ...
    "src/language-html/print/element.js"(e, r) {
        ...
        function D(T, m, C) {
            ...
            let h = o.children.length === 1 && o.firstChild.type === "interpolation" && o.firstChild.isLeadingSpaceSensitive && !o.firstChild.hasLeadingSpaces && o.lastChild.isTrailingSpaceSensitive && !o.lastChild.hasTrailingSpaces,
                v = Symbol("element-attr-group-id"), S = M => a([a(F(T, m, C), {id: v}), M, x(o, m)]),
                b = M => h ? u(M, {groupId: v}) : (c(o) || f(o, m)) && o.parent.type === "root" && m.parser === "vue" && !m.vueIndentScriptAndStyle ? M : i(M),
                B = () => h ? n(p, "", {groupId: v}) : o.firstChild.hasLeadingSpaces && o.firstChild.isLeadingSpaceSensitive ? l : o.firstChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive ? s(p) : p,
                k = () => (o.next ? I(o.next) : P(o.parent)) ? o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? " " : "" : h ? n(p, "", {groupId: v}) : o.lastChild.hasTrailingSpaces && o.lastChild.isTrailingSpaceSensitive ? l : (o.lastChild.type === "comment" || o.lastChild.type === "text" && o.isWhitespaceSensitive && o.isIndentationSensitive) && new RegExp(`\\n[\\t ]{${m.tabWidth * E(T, R => R.parent && R.parent.type !== "root")}}$`).test(o.lastChild.value) ? "" : p;
    ...
    "src/language-html/printer-html.js"(e, r) {
        ...
        var {
                ...
                utils: {cleanDoc: u, getDocParts: i, isConcat: l, replaceTextEndOfLine: p}
            } = qe(), d = ag(), {countChars: y, unescapeQuoteEntities: g, getTextValueParts: c} = qt(),
            f = dg(), {insertPragma: E} = gg(), {locStart: _, locEnd: w} = uu(), F = Cg(), {
                printClosingTagSuffix: N,
                printClosingTagEnd: x,
                printOpeningTagPrefix: I,
                printOpeningTagStart: P
            } = rr(), {printElement: $} = Eg(), {printChildren: D} = Bo();
    ...
    "src/language-html/index.js"(e, r) {
        "use strict";
        ne();
        var t = wt(), s = Fg(), a = Ag(), n = Sg(), u = [t(kn(), () => ({
            name: "Angular",
            since: "1.15.0",
            parsers: ["angular"],
            ...
            extensions: [],
            filenames: []
        })), t(xg(), () => ({since: "1.10.0", parsers: ["vue"], vscodeLanguageIds: ["vue"]}))], i = {html: s};
...
` && m++, m === 1 && /\S/.test(h)) return !1;
        ...
        function p(D) {
            ...
            for (let C = 1; C < m; C++) {
                ...
                if (Array.isArray(h) && typeof o == "number" && o !== h.length - 1) return !1
            }
            return !0
        }
...
`).map((o, h, v) => h === 0 && h === v.length - 1 ? o : h !== 0 && h !== v.length - 1 ? o.trim() : h === 0 ? o.trimEnd() : o.trimStart());
        ...
        function P(D, T) {
            let {parentIndent: m, isLastDescendant: C, options: o} = T,
                h = D.position.start.line === D.position.end.line ? "" : o.originalText.slice(D.position.start.offset, D.position.end.offset).match(/^[^\n]*\n(.*)$/s)[1],
                v;
            if (D.indent === null) {
...
`).map(B => B.slice(v));
        ...
        r.exports = {
            ...
            getLastDescendantNode: d,
            hasPrettierIgnore: g,
            hasLeadingComments: E,
            hasMiddleComments: _,
            hasIndicatorComment: w,
            hasTrailingComment: F,
            hasEndComments: N
        }
    }
}), wg = te({
    ...
    "src/language-yaml/print/misc.js"(e, r) {
        "use strict";
        ne();
        var {builders: {softline: t, align: s}} = qe(), {hasEndComments: a, isNextLineEmpty: n, isNode: u} = Mt(),
            i = new WeakMap;

        function l(y, g) {
            let c = y.getValue(), f = y.stack[0], E;
            return i.has(f) ? E = i.get(f) : (E = new Set, i.set(f, E)), !E.has(c.position.end.line) && (E.add(c.position.end.line), n(c, g) && !p(y.getParentNode())) ? t : ""
        }
    ...
    "src/language-yaml/print/flow-mapping-sequence.js"(e, r) {
        "use strict";
        ne();
        var {builders: {ifBreak: t, line: s, softline: a, hardline: n, join: u}} = qe(), {
            isEmptyNode: i,
            getLast: l,
            hasEndComments: p
        } = Mt(), {printNextEmptyLine: d, alignWithSpaces: y} = jr();
        ...
        function g(f, E, _) {
            ...
            return [N, y(_.tabWidth, [I, c(f, E, _), _.trailingComma === "none" ? "" : t(","), p(w) ? [n, u(n, f.map(E, "endComments"))] : ""]), $ ? "" : I, x]
        }

        function c(f, E, _) {
            let w = f.getValue();
            return f.map((N, x) => [E(), x === w.children.length - 1 ? "" : [",", s, w.children[x].position.start.line !== w.children[x + 1].position.start.line ? d(N, _.originalText) : ""]], "children")
        }
    ...
    "src/language-yaml/print/mapping-item.js"(e, r) {
        ...
        var {
            ...
            hasMiddleComments: p,
            hasTrailingComment: d,
            hasEndComments: y,
            isNode: g,
            isEmptyNode: c,
            isInlineNode: f
        } = Mt(), {alignWithSpaces: E} = jr();

        function _(x, I, P, $, D) {
            let {key: T, value: m} = x, C = c(T), o = c(m);
            if (C && o) return ": ";
            let h = $("key"), v = F(x) ? " " : "";
            if (o) return x.type === "flowMappingItem" && I.type === "flowMapping" ? h : x.type === "mappingItem" && w(T.content, D) && !d(T.content) && (!I.tag || I.tag.value !== "tag:yaml.org,2002:set") ? [h, v, ":"] : ["? ", E(2, h)];
            let S = $("value");
            if (C) return [": ", E(2, S)];
            if (l(m) || !f(T.content)) return ["? ", E(2, h), a, u("", P.map($, "value", "leadingComments").map(q => [q, a])), ": ", E(2, S)];
            if (N(T.content) && !l(T.content) && !p(T.content) && !d(T.content) && !y(T) && !l(m.content) && !p(m.content) && !y(m) && w(m.content, D)) return [h, v, ": ", S];
            let b = Symbol("mappingKey"), B = s([n("? "), s(E(2, h), {id: b})]), k = [a, ": ", E(2, S)], M = [v, ":"];
...
`);
    ...
    "src/language-yaml/print/block.js"(e, r) {
        ...
        var {
            ...
            isNode: E
        } = Mt(), {alignWithSpaces: _} = jr();

        function w(F, N, x) {
            let I = F.getValue(), P = y(F, C => E(C, ["sequence", "mapping"])), $ = f(F),
            ...
            for (let [C, o] of T.entries()) C === 0 && m.push(n), m.push(a(d(u(i, o)))), C !== T.length - 1 ? m.push(o.length === 0 ? n : p(l)) : I.chomping === "keep" && $ && m.push(s(o.length === 0 ? n : l));
    ...
    "src/language-yaml/printer-yaml.js"(e, r) {
        ...
        var {
                builders: {
                    ...
                    lineSuffix: l,
                    literalline: p
                }, utils: {getDocParts: d, replaceTextEndOfLine: y}
            } = qe(), {isPreviousLineEmpty: g} = Ue(), {insertPragma: c, isPragma: f} = Tg(), {locStart: E} = Bg(),
            _ = Ng(), {
                getFlowScalarLineContents: w,
                getLastDescendantNode: F,
                ...
                alignWithSpaces: o,
                printNextEmptyLine: h,
                shouldPrintEndComments: v
            } = jr(), {printFlowMapping: S, printFlowSequence: b} = _g(), B = Pg(), k = Ig();
        ...
        function L(j, Y, ie, ee) {
            return ie.children[0] === j && /---(?:\s|$)/.test(ee.originalText.slice(E(j), E(j) + 4)) || j.head.children.length > 0 || P(j.head) || I(j.head) ? "head" : J(j, Y) ? !1 : Y ? "root" : !1
        }
    ...
    "src/language-yaml/index.js"(e, r) {
        "use strict";
        ne();
        var t = wt(), s = kg(), a = Lg(), n = Og(), u = [t(jg(), i => ({
            since: "1.14.0",
            parsers: ["yaml"],
    ...
    "src/standalone.js"(e, r) {
        ...
        function l(d) {
            ...
            return function () {
                ...
                let E = c[y] || {}, _ = E.plugins || [];
                return c[y] = Object.assign(Object.assign({}, E), {}, {plugins: [...u, ...Array.isArray(_) ? _ : Object.values(_)]}), d(...c)
            }
        }
        ...
        r.exports = {
            ...
            doc: i,
            getSupportInfo: l(a, 0),
            version: t,
            util: n,
            __debug: {
                parse: l(s.parse),
                formatAST: l(s.formatAST),
                formatDoc: l(s.formatDoc),
                printToDoc: l(s.printToDoc),
                printDocToString: l(s.printDocToString)
            }
        }
    }
}), Ty = Rg();
