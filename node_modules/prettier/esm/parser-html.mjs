...
var tr = y((ec, hu) => {
    ...
    hu.exports = function (e) {
        if (Is(e)) throw Rs("Can't call method on " + e);
        return e
    }
});
var ke = y((rc, pu) => {
...
var Nu = y((oc, wu) => {
    var bu = ue(), or = _u(), Su = bu.process, yu = bu.Deno, Tu = Su && Su.versions || yu && yu.version,
        Bu = Tu && Tu.v8, ne, Le;
...
var $u = y((dc, Lu) => {
    ...
    Lu.exports = function (e, r) {
        var u, n;
        if (r === "string" && pr(u = e.toString) && !fr(n = hr(u, e)) || pr(u = e.valueOf) && !fr(n = hr(u, e)) || r !== "string" && pr(u = e.toString) && !fr(n = hr(u, e))) return n;
...
var fe = y((_c, rt) => {
    var mi = ue(), gi = dr(), Ku = le(), Fi = Cr(), Ju = Dr(), et = lr(), Ce = gi("wks"), pe = mi.Symbol,
        Zu = pe && pe.for, Ai = et ? pe : pe && pe.withoutSetter || Fi;
...
var st = y((Sc, nt) => {
    ...
    nt.exports = function (e, r) {
        if (!ut(e) || tt(e)) return e;
        var u = _i(e, Bi), n;
        if (u) {
            if (r === void 0 && (r = "default"), n = vi(u, e, r), !ut(n) || tt(n)) return n;
            throw Ti("Can't convert object to primitive value")
        }
...
var Fr = y(ht => {
    var xi = De(), Pi = ce(), ki = uu(), Li = xe(), $i = ke(), Mi = Ge(), ji = le(), Ui = gr(),
        ct = Object.getOwnPropertyDescriptor;
    ht.f = xi ? ct : function (r, u) {
        if (r = $i(r), u = Mi(u), Ui) try {
            return ct(r, u)
        } catch {
        }
        if (ji(r, u)) return Li(!Pi(ki.f, r, u), r[u])
    }
});
var ft = y((wc, pt) => {
    var Gi = De(), Vi = ae();
...
var Se = y(Ct => {
    var Wi = De(), Yi = gr(), Qi = ft(), Ve = me(), Et = Ge(), Ki = TypeError, Ar = Object.defineProperty,
        Ji = Object.getOwnPropertyDescriptor, vr = "enumerable", _r = "configurable", Sr = "writable";
    Ct.f = Wi ? Qi ? function (r, u, n) {
        if (Ve(r), u = Et(u), Ve(n), typeof r == "function" && u === "prototype" && "value" in n && Sr in n && !n[Sr]) {
            var D = Ji(r, u);
            D && D[Sr] && (r[u] = n.value, n = {
                configurable: _r in n ? n[_r] : D[_r],
                enumerable: vr in n ? n[vr] : D[vr],
                writable: !1
            })
        }
        return Ar(r, u, n)
    } : Ar : function (r, u, n) {
        if (Ve(r), u = Et(u), Ve(n), Yi) try {
            return Ar(r, u, n)
        } catch {
        }
        if ("get" in n || "set" in n) throw Ki("Accessors not supported");
...
var At = y((Ic, Ft) => {
    var Tr = De(), ua = le(), gt = Function.prototype, ta = Tr && Object.getOwnPropertyDescriptor, Br = ua(gt, "name"),
        na = Br && function () {
...
var It = y((Lc, qt) => {
    var pa = yt(), Ot = ue(), fa = he(), da = yr(), Or = le(), qr = Ue(), Ea = bt(), Ca = Nr(),
        Nt = "Object already initialized", Ir = Ot.TypeError, ma = Ot.WeakMap, Xe, ye, He, ga = function (e) {
            return He(e) ? ye(e) : Xe(e, {})
        }, Fa = function (e) {
            return function (r) {
                var u;
                if (!fa(r) || (u = ye(r)).type !== e) throw Ir("Incompatible receiver, " + e + " required");
                return u
            }
        };
    pa || qr.state ? (se = qr.state || (qr.state = new ma), se.get = se.get, se.has = se.has, se.set = se.set, Xe = function (e, r) {
        if (se.has(e)) throw Ir(Nt);
        return r.facade = e, se.set(e, r), r
    }, ye = function (e) {
        return se.get(e) || {}
    }, He = function (e) {
        return se.has(e)
    }) : (de = Ea("state"), Ca[de] = !0, Xe = function (e, r) {
        if (Or(e, de)) throw Ir(Nt);
...
var Pt = y(($c, xt) => {
    var Aa = ae(), va = ee(), ze = le(), Rr = De(), _a = At().CONFIGURABLE, Sa = wr(), Rt = It(), ya = Rt.enforce,
        Ta = Rt.get, We = Object.defineProperty, Ba = Rr && !Aa(function () {
            return We(function () {
            }, "length", {value: 8}).length !== 8
        }), ba = String(String).split("String"), wa = xt.exports = function (e, r, u) {
            String(r).slice(0, 7) === "Symbol(" && (r = "[" + String(r).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), u && u.getter && (r = "get " + r), u && u.setter && (r = "set " + r), (!ze(e, "name") || _a && e.name !== r) && (Rr ? We(e, "name", {
                value: r,
                configurable: !0
            }) : e.name = r), Ba && u && ze(u, "arity") && e.length !== u.arity && We(e, "length", {value: u.arity});
            try {
...
var Lt = y((Mc, kt) => {
    ...
    kt.exports = function (e, r, u, n) {
        ...
        if (Na(u) && qa(u, s, n), n.global) D ? e[r] = u : Ia(r, u); else {
            try {
...
var Yt = y((Hc, Wt) => {
    var Ga = ke(), Va = Gt(), Xa = Te(), zt = function (e) {
        return function (r, u, n) {
            ...
            if (e && u != u) {
                for (; s > a;) if (f = D[a++], f != f) return !0
            } else for (; s > a; a++) if ((e || a in D) && D[a] === u) return e || a || 0;
            return !e && -1
        }
    };
    Wt.exports = {includes: zt(!0), indexOf: zt(!1)}
});
var Jt = y((zc, Kt) => {
    var Ha = te(), Pr = le(), za = ke(), Wa = Yt().indexOf, Ya = Nr(), Qt = Ha([].push);
    Kt.exports = function (e, r) {
        var u = za(e), n = 0, D = [], s;
        for (s in u) !Pr(Ya, s) && Pr(u, s) && Qt(D, s);
        for (; r.length > n;) Pr(u, s = r[n++]) && (~Wa(D, s) || Qt(D, s));
        return D
    }
});
var en = y((Wc, Zt) => {
...
var hn = y((Zc, cn) => {
    var oo = ae(), Do = ee(), lo = /#|\.prototype\./, Be = function (e, r) {
        var u = ho[co(e)];
        return u == fo ? !0 : u == po ? !1 : Do(r) ? oo(r) : !!r
...
var Ye = y((e2, pn) => {
    ...
    pn.exports = function (e, r) {
        ...
        if (n ? a = kr : D ? a = kr[u] || go(u, {}) : a = (kr[u] || {}).prototype, a) for (f in r) {
...
var fn = y(() => {
    var vo = Ye(), Lr = ue();
    vo({global: !0, forced: Lr.globalThis !== Lr}, {globalThis: Lr})
});
var $r = y((t2, dn) => {
    var _o = Ae();
...
var Cn = y((n2, En) => {
    ...
    En.exports = function (e) {
        if (e > yo) throw So("Maximum allowed index exceeded");
        return e
    }
});
var gn = y((s2, mn) => {
...
var Sn = y((a2, _n) => {
    ...
    var Oo = $r(), qo = Te(), Io = Cn(), Ro = Mr(), vn = function (e, r, u, n, D, s, a, f) {
        for (var c = D, v = 0, i = a ? Ro(a, f) : !1, l, p; v < n;) v in u && (l = i ? i(u[v], v, r) : u[v], s > 0 && Oo(l) ? (p = qo(l), c = vn(e, r, l, p, c, s - 1) - 1) : (Io(c + 1), e[c] = l), c++), v++;
        return c
    };
    _n.exports = vn
});
...
var Rn = y((l2, In) => {
    var Vo = te(), Xo = ae(), wn = ee(), Ho = jr(), zo = ve(), Wo = wr(), Nn = function () {
        }, Yo = [], On = zo("Reflect", "construct"), Ur = /^\s*(?:class|function)\b/, Qo = Vo(Ur.exec), Ko = !Ur.exec(Nn),
        be = function (r) {
            if (!wn(r)) return !1;
            try {
                return On(Nn, Yo, r), !0
...
var Vr = y((d2, Xn) => {
    ...
    Xn.exports = function (e) {
        if (!fD(e)) return Vn(e, CD) || Vn(e, "@@iterator") || dD[pD(e)]
    }
});
var zn = y((E2, Hn) => {
...
var rs = y((m2, es) => {
    var TD = Mr(), BD = ce(), bD = me(), wD = $e(), ND = Gn(), OD = Te(), Kn = ar(), qD = zn(), ID = Vr(), Jn = Qn(),
        RD = TypeError, Ke = function (e, r) {
            this.stopped = e, this.result = r
        }, Zn = Ke.prototype;
    es.exports = function (e, r, u) {
        var n = u && u.that, D = !!(u && u.AS_ENTRIES), s = !!(u && u.IS_RECORD), a = !!(u && u.IS_ITERATOR),
            f = !!(u && u.INTERRUPTED), c = TD(r, n), v, i, l, p, m, C, g, B = function (F) {
                return v && Jn(v, "normal", F), new Ke(!0, F)
            }, O = function (F) {
                return D ? (bD(F), f ? c(F[0], F[1], B) : c(F[0], F[1])) : f ? c(F, B) : c(F)
            };
        if (s) v = e.iterator; else if (a) v = e; else {
            if (i = ID(e), !i) throw RD(wD(e) + " is not iterable");
            if (ND(i)) {
                for (l = 0, p = OD(e); p > l; l++) if (m = O(e[l]), m && Kn(Zn, m)) return m;
                return new Ke(!1)
            }
            v = qD(e, i)
        }
        for (C = s ? e.next : v.next; !(g = BD(C, v)).done;) {
            ...
            if (typeof m == "object" && m && Kn(Zn, m)) return m
        }
        return new Ke(!1)
    }
});
...
var VD = Object.create, Je = Object.defineProperty, XD = Object.getOwnPropertyDescriptor,
    Xr = Object.getOwnPropertyNames, HD = Object.getPrototypeOf, zD = Object.prototype.hasOwnProperty,
    ge = (e, r) => function () {
        return e && (r = (0, e[Xr(e)[0]])(e = 0)), r
    }, I = (e, r) => function () {
        return r || (0, e[Xr(e)[0]])((r = {exports: {}}).exports, r), r.exports
    }, is = (e, r) => {
        for (var u in r) Je(e, u, {get: r[u], enumerable: !0})
    }, as = (e, r, u, n) => {
        if (r && typeof r == "object" || typeof r == "function") for (let D of Xr(r)) !zD.call(e, D) && D !== u && Je(e, D, {
            get: () => r[D],
            enumerable: !(n = XD(r, D)) || n.enumerable
        });
        return e
    }, WD = (e, r, u) => (u = e != null ? VD(HD(e)) : {}, as(r || !e || !e.__esModule ? Je(u, "default", {
        value: e,
        enumerable: !0
    }) : u, e)), os = e => as(Je({}, "__esModule", {value: !0}), e), we, N = ge({
        "<define:process>"() {
            we = {env: {}, argv: []}
        }
    }), Ds = I({
        ...
        "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
            ...
            function u(o) {
                return o.replace(r, function () {
                    for (var d = arguments.length, h = new Array(d), A = 0; A < d; A++) h[A] = arguments[A];
            ...
            e.ValueTransformer = v, e.SyncAsync = {
                assertSync: o => {
                    if (R(o)) throw new Error("Illegal state: value cannot be a promise");
                    return o
...
`);
            ...
            var k = typeof window < "u" && window,
                j = typeof self < "u" && typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && self,
                L = typeof globalThis < "u" && globalThis, t = L || k || j;
            e.global = t
        }
    }), KD = I({
        "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
            ...
            var B = class {
                constructor(h) {
                    ...
                    if (this.encapsulation = A, this.template = q, this.templateUrl = P, this.htmlAst = G, this.styles = R(X), this.styleUrls = R(Q), this.externalStylesheets = R(H), this.animations = W ? k(W) : [], this.ngContentSelectors = K || [], J && J.length != 2) throw new Error("'interpolation' should have a start and an end symbol.");
        ...
        "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(e) {
            ...
            var r = Ds(), u = KD(), n = class {
                ...
                moveBy(i) {
                    ...
                    for (; m > 0 && i < 0;) if (m--, i++, l.charCodeAt(m) == r.$LF) {
                        C--;
...
` && ++B == l));) ;
            ...
            function c(i, l) {
                let p = u.identifierModuleUrl(l),
                    m = p != null ? `in ${i} ${u.identifierName(l)} in ${p}` : `in ${i} ${u.identifierName(l)}`,
                    C = new D("", m);
        ...
        "src/utils/front-matter/parse.js"(e, r) {
            ...
            function n(D) {
                ...
                if (a === "+++" && (i = "toml"), i !== "yaml" && a !== v) return {content: D};
                let [l] = s;
                return {
                    frontMatter: {
                        type: "front-matter",
...
var rl = ge({
    ...
    "node_modules/semver/internal/parse-options.js"(e, r) {
        N();
        var u = ["includePrerelease", "loose", "rtl"],
            n = D => D ? typeof D != "object" ? {loose: !0} : u.filter(s => D[s]).reduce((s, a) => (s[a] = !0, s), {}) : {};
        r.exports = n
    }
}), nl = I({
    ...
    "node_modules/semver/classes/semver.js"(e, r) {
        N();
        var u = hs(), {MAX_LENGTH: n, MAX_SAFE_INTEGER: D} = ps(), {re: s, t: a} = ul(),
            f = tl(), {compareIdentifiers: c} = nl(), v = class {
                constructor(i, l) {
                    ...
                    if (i.length > n) throw new TypeError(`version is longer than ${n} characters`);
                    ...
                    if (this.raw = i, this.major = +p[1], this.minor = +p[2], this.patch = +p[3], this.major > D || this.major < 0) throw new TypeError("Invalid major version");
                ...
                comparePre(i) {
                    if (i instanceof v || (i = new v(i, this.options)), this.prerelease.length && !i.prerelease.length) return -1;
                    ...
                    do {
                        ...
                        if (u("prerelease compare", l, p, m), p === void 0 && m === void 0) return 0;
    ...
    "node_modules/outdent/lib/index.js"(e, r) {
        ...
        function u() {
            for (var F = [], w = 0; w < arguments.length; w++) F[w] = arguments[w]
        }
        ...
        function D() {
            return {
                add: u, delete: u, get: u, set: u, has: function (F) {
                    return !1
                }
            }
        }
        ...
        function m(F, w, b) {
            ...
            w && (F = F.slice(1));
            var j = b.newline, L = b.trimLeadingNewline, t = b.trimTrailingNewline, o = typeof j == "string",
                d = F.length, h = F.map(function (A, q) {
        ...
        function C(F, w) {
            for (var b = "", M = 0, R = F.length; M < R; M++) b += F[M], M < R - 1 && (b += w[M]);
            return b
        }
        ...
        function B(F) {
            ...
            function M(U) {
                ...
                if (g(U)) {
                    var L = U, t = (k[0] === M || k[0] === O) && p.test(L[0]) && i.test(L[1]), o = t ? b : w,
                        d = o.get(L);
                    if (d || (d = m(L, t, F), o.set(L, d)), k.length === 0) return d[0];
                    var h = C(d, t ? k.slice(1) : k);
                    return h
                } else return B(f(f({}, F), U || {}))
            }
        ...
        if (e.outdent = O, e.default = O, typeof r < "u") try {
    ...
    "src/main/core-options.js"(e, r) {
        "use strict";
        N();
        var {outdent: u} = ll(), n = "Config", D = "Editor", s = "Format", a = "Other", f = "Output", c = "Global",
            v = "Special", i = {
                cursorOffset: {
                    since: "1.4.0",
                    category: v,
    ...
    `,
        ...
        `
                ...
                pluginSearchDirs: {
                    since: "1.13.0", type: "path", array: !0, default: [{value: []}], category: c, description: u`
      Custom directory that contains prettier plugins in node_modules subdirectory.
      Overrides default behavior when plugins are searched relatively to the location of Prettier.
      Multiple values are accepted.
    `, exception: l => typeof l == "string" || typeof l == "object", cliName: "plugin-search-dir", cliCategory: n
                },
                printWidth: {
                    since: "0.0.0",
                    category: c,
    ...
    `,
                ...
                requirePragma: {
                    since: "1.7.0", category: v, type: "boolean", default: !1, description: u`
    ...
    "src/main/support.js"(e, r) {
        ...
        function a() {
            let {
                    ...
                    showDeprecated: i = !1,
                    showInternal: l = !1
                } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, p = D.split("-", 1)[0],
                m = c.flatMap(F => F.languages || []).filter(g), C = n(Object.assign({}, ...c.map(F => {
                    let {options: w} = F;
                    return w
        ...
        function f(c, v, i) {
            ...
            for (let p of v) if (p.parsers) {
                for (let m of p.parsers) if (!l.has(m)) {
                    l.add(m);
...
function Al(e) {
    if (typeof e != "string" || e.length === 0 || (e = El(e), e.length === 0)) return 0;
...
var ds, vl = ge({
            ...
            return (c, v, i) => {
                ...
                for (; m >= 0 && m < p;) {
                    ...
                    if (f instanceof RegExp) {
                        if (!f.test(C)) return m
                    } else if (!f.includes(C)) return m;
                    l ? m-- : m++
                }
                return m === -1 || m === p ? m : !1
            }
    ...
    "src/utils/text/skip-trailing-comment.js"(e, r) {
        ...
        function n(D, s) {
            return s === !1 ? !1 : D.charAt(s) === "/" && D.charAt(s + 1) === "/" ? u(D, s) : s
        }
...
` || f === "\r" || f === "\u2028" || f === "\u2029") return D + 1
    ...
    "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(e, r) {
        ...
        function a(f, c) {
            let v = null, i = c;
            for (; i !== v;) v = i, i = s(f, i), i = u(f, i), i = D(f, i), i = n(f, i);
            return i
        }
    ...
    "src/common/util.js"(e, r) {
        "use strict";
        N();
        var {default: u} = (rl(), os(cs)), n = ls(), {getSupportInfo: D} = hl(), s = pl(), a = _l(), {
            skipWhitespace: f,
            skipSpaces: c,
            skipToLineEnd: v,
            skipEverythingButNewLine: i
        } = zr(), l = Es(), p = Cs(), m = ms(), C = Sl(), g = S => S[S.length - 2];
            ...
            return (E, _, T) => {
                ...
                for (; V >= 0 && V < $;) {
                    ...
                    if (S instanceof RegExp) {
                        if (!S.test(z)) return V
                    } else if (!S.includes(z)) return V;
                    x ? V-- : V++
                }
                return V === -1 || V === $ ? V : !1
            }
        ...
        function O(S, E) {
            let _ = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {},
                T = c(S, _.backwards ? E - 1 : E, _), x = m(S, T, _);
            return T !== x
        }

        function F(S, E, _) {
            for (let T = E; T < _; ++T) if (S.charAt(T) === `
`) return !0;
            return !1
        }
        ...
        function w(S, E, _) {
            let T = _(E) - 1;
            T = c(S, T, {backwards: !0}), T = m(S, T, {backwards: !0}), T = c(S, T, {backwards: !0});
            let x = m(S, T, {backwards: !0});
            return T !== x
        }

        function b(S, E) {
            let _ = null, T = E;
            for (; T !== _;) _ = T, T = v(S, T), T = l(S, T), T = c(S, T);
            return T = p(S, T), T = m(S, T), T !== !1 && O(S, T)
        }
        ...
        function j(S, E) {
            ...
            for (let x = _; x < S.length; ++x) S[x] === "	" ? T = T + E - T % E : T++;
            return T
        }
...
`);
        ...
        function t(S, E) {
            let _ = {quote: '"', regex: /"/g, escaped: "&quot;"}, T = {quote: "'", regex: /'/g, escaped: "&apos;"},
                x = E === "'" ? T : _, $ = x === T ? _ : T, V = x;
        ...
        function o(S, E) {
            let _ = S.slice(1, -1),
                T = E.parser === "json" || E.parser === "json5" && E.quoteProps === "preserve" && !E.singleQuote ? '"' : E.__isInHtmlAttribute ? "'" : t(_, E.singleQuote ? "'" : '"').quote;
            return d(_, T, !(E.parser === "css" || E.parser === "less" || E.parser === "scss" || E.__embeddedInHtml))
        }

        function d(S, E, _) {
            let T = E === '"' ? "'" : '"', x = /\\(.)|(["'])/gs,
                $ = S.replace(x, (V, z, Y) => z === T ? z : Y === E ? "\\" + Y : Y || (_ && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(z) ? z : "\\" + z));
            return E + $ + E
        }
        ...
        function q(S, E) {
            ...
            for (let $ = 1; $ < x; $++) if (!T.get($)) return $;
            return x + 1
        }

        function P(S, E) {
            (S.comments || (S.comments = [])).push(E), E.printed = !1, E.nodeDescription = J(S)
        }

        function G(S, E) {
            E.leading = !0, E.trailing = !1, P(S, E)
        }

        function X(S, E, _) {
            E.leading = !1, E.trailing = !1, _ && (E.marker = _), P(S, E)
        }

        function Q(S, E) {
            E.leading = !1, E.trailing = !0, P(S, E)
        }
        ...
        function J(S) {
            let E = S.type || S.kind || "(unknown type)",
                _ = String(S.name || S.id && (typeof S.id == "object" ? S.id.name : S.id) || S.key && (typeof S.key == "object" ? S.key.name : S.key) || S.value && (typeof S.value == "object" ? "" : String(S.value)) || S.operator || "");
    ...
    "src/language-html/utils/map-object.js"(e, r) {
        ...
        function u(n, D) {
            ...
            for (let [a, f] of Object.entries(n)) s[a] = D(f, a);
            return s
        }
...
` + D.replace(/^\s*\n/, "")
    ...
    "src/language-html/ast.js"(e, r) {
        "use strict";
        N();
        var u = {attrs: !0, children: !0}, n = new Set(["parent"]), D = class {
            constructor() {
                let a = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
                for (let f of new Set([...n, ...Object.keys(a)])) this.setProperty(f, a[f])
            }
            ...
            walk(a) {
                for (let f in u) {
                    let c = this[f];
                    if (c) for (let v = 0; v < c.length; v++) c[v].walk(a)
                }
                a(this)
            }
    ...
    "src/language-html/conditional-comment.js"(e, r) {
        "use strict";
        N();
        var {ParseSourceSpan: u} = Ne(), n = [{regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: s}, {
            regex: /^\[if([^\]]*)]><!$/,
            parse: a
        }, {regex: /^<!\s*\[endif]$/, parse: f}];

        function D(c, v) {
            if (c.value) for (let {regex: i, parse: l} of n) {
        ...
        function s(c, v, i) {
            let [, l, p, m] = i, C = 4 + l.length, g = c.sourceSpan.start.moveBy(C),
                B = g.moveBy(m.length), [O, F] = (() => {
                    try {
            ...
            return {
                ...
                startSourceSpan: new u(c.sourceSpan.start, g),
                endSourceSpan: new u(B, c.sourceSpan.end)
            }
        }
    ...
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/tags.js"(e) {
        ...
        function u(c) {
            ...
            let v = c.indexOf(":", 1);
            if (v == -1) throw new Error(`Unsupported format "${c}" expecting ":namespace:name"`);
        ...
        e.mergeNsAndName = f, e.NAMED_ENTITIES = {
            Aacute: "\xC1",
            aacute: "\xE1",
            Abreve: "\u0102",
            abreve: "\u0103",
...
`,
    ...
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_tags.js"(e) {
        ...
        var r = Ze(), u = class {
            constructor() {
                ...
                this.closedByChildren = {}, this.closedByParent = !1, this.canSelfClose = !1, a && a.length > 0 && a.forEach(p => this.closedByChildren[p] = !0), this.isVoid = i, this.closedByParent = v || i, this.implicitNamespacePrefix = f || null, this.contentType = c, this.ignoreFirstLf = l
            }
        ...
        function s(a) {
            return D || (n = new u, D = {
                ...
                tbody: new u({closedByChildren: ["tbody", "tfoot"], closedByParent: !0}),
                tfoot: new u({closedByChildren: ["tbody"], closedByParent: !0}),
                tr: new u({closedByChildren: ["tr"], closedByParent: !0}),
                td: new u({closedByChildren: ["td", "th"], closedByParent: !0}),
                th: new u({closedByChildren: ["td", "th"], closedByParent: !0}),
                col: new u({isVoid: !0}),
                svg: new u({implicitNamespacePrefix: "svg"}),
                math: new u({implicitNamespacePrefix: "math"}),
                li: new u({closedByChildren: ["li"], closedByParent: !0}),
                dt: new u({closedByChildren: ["dt", "dd"]}),
                dd: new u({closedByChildren: ["dt", "dd"], closedByParent: !0}),
                rb: new u({closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0}),
                rt: new u({closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0}),
                rtc: new u({closedByChildren: ["rb", "rtc", "rp"], closedByParent: !0}),
                rp: new u({closedByChildren: ["rb", "rt", "rtc", "rp"], closedByParent: !0}),
                optgroup: new u({closedByChildren: ["optgroup"], closedByParent: !0}),
                option: new u({closedByChildren: ["option", "optgroup"], closedByParent: !0}),
                ...
                title: new u({contentType: r.TagContentType.ESCAPABLE_RAW_TEXT}),
                textarea: new u({contentType: r.TagContentType.ESCAPABLE_RAW_TEXT, ignoreFirstLf: !0})
            }), D[a] || n
        }
    ...
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(e) {
        ...
        var a = class {
            constructor(C, g, B) {
                let O = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null,
                    F = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null,
                    w = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null;
        ...
        var f = class {
            constructor(C, g, B, O) {
                let F = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null,
                    w = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null,
                    b = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : null,
        ...
        function i(C, g) {
            let B = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : null, O = [],
                F = C.visit ? w => C.visit(w, B) || w.visit(C, B) : w => w.visit(C, B);
            return g.forEach(w => {
                let b = F(w);
                b && O.push(b)
            }), O
        ...
        function p(C) {
            ...
            return C instanceof f && (C.endSourceSpan ? B = C.endSourceSpan.end.offset : C.children && C.children.length && (B = p(C.children[C.children.length - 1]).end)), {
                start: g,
                end: B
            }
        }
        ...
        function m(C, g) {
            let B = [], O = new class extends l {
                visit(F, w) {
                    let b = p(F);
                    if (b.start <= g && g < b.end) B.push(F); else return !0
                }
            };
    ...
    "node_modules/angular-html-parser/lib/compiler/src/assertions.js"(e) {
        ...
        function r(D, s) {
            if (s != null) {
                ...
                for (let a = 0; a < s.length; a += 1) if (typeof s[a] != "string") throw new Error(`Expected '${D}' to be an array of strings.`)
            }
        }
        ...
        function n(D, s) {
            ...
            if (s != null) {
                let a = s[0], f = s[1];
                u.forEach(c => {
                    if (c.test(a) || c.test(f)) throw new Error(`['${a}', '${f}'] contains unusable interpolation symbol.`)
                })
            }
        }
...
`)
            ...
            tokenize() {
                for (; this._cursor.peek() !== r.$EOF;) {
                    ...
                    try {
                        if (this._attemptCharCode(r.$LT)) if (this._attemptCharCode(r.$BANG)) this._attemptStr("[CDATA[") ? this._consumeCdata(t) : this._attemptStr("--") ? this._consumeComment(t) : this._attemptStrCaseInsensitive("doctype") ? this._consumeDocType(t) : this._consumeBogusComment(t); else if (this._attemptCharCode(r.$SLASH)) this._consumeTagClose(t); else {
            ...
            _tokenizeExpansionForm() {
                ...
                if (b(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
            ...
            handleError(t) {
                if (t instanceof L && (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))), t instanceof m) this.errors.push(t.error); else throw t
            }
            ...
            _attemptCharCodeCaseInsensitive(t) {
                return M(this._cursor.peek(), t) ? (this._cursor.advance(), !0) : !1
            }
            ...
            _attemptStr(t) {
                ...
                for (let h = 0; h < o; h++) if (!this._attemptCharCode(t.charCodeAt(h))) return this._cursor = d, !1;
                return !0
            }

            _attemptStrCaseInsensitive(t) {
                for (let o = 0; o < t.length; o++) if (!this._attemptCharCodeCaseInsensitive(t.charCodeAt(o))) return !1;
                return !0
            }
            ...
            _requireCharCodeUntilFn(t, o) {
                let d = this._cursor.clone();
                if (this._attemptCharCodeUntilFn(t), this._cursor.clone().diff(d) < o) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan(d))
            }
            ...
            _decodeEntity() {
                ...
                if (this._cursor.advance(), this._attemptCharCode(r.$HASH)) {
                    ...
                    if (this._attemptCharCodeUntilFn(F), this._cursor.peek() != r.$SEMICOLON) throw this._createError(l(this._cursor.peek()), this._cursor.getSpan());
                    ...
                    let o = this._cursor.clone();
                    if (this._attemptCharCodeUntilFn(w), this._cursor.peek() != r.$SEMICOLON) return this._cursor = o, "&";
                    let d = this._cursor.getChars(o);
                    this._cursor.advance();
                    let h = D.NAMED_ENTITIES[d];
                    if (!h) throw this._createError(p(d), this._cursor.getSpan(t));
                    return h
                }
            }
            ...
            _consumeComment(t) {
                this._beginToken(s.COMMENT_START, t), this._endToken([]), this._consumeRawText(!1, () => this._attemptStr("-->")), this._beginToken(s.COMMENT_END), this._requireStr("-->"), this._endToken([])
            }

            _consumeBogusComment(t) {
                this._beginToken(s.COMMENT_START, t), this._endToken([]), this._consumeRawText(!1, () => this._cursor.peek() === r.$GT), this._beginToken(s.COMMENT_END), this._cursor.advance(), this._endToken([])
            }

            _consumeCdata(t) {
                this._beginToken(s.CDATA_START, t), this._endToken([]), this._consumeRawText(!1, () => this._attemptStr("]]>")), this._beginToken(s.CDATA_END), this._requireStr("]]>"), this._endToken([])
            }

            _consumeDocType(t) {
                this._beginToken(s.DOC_TYPE_START, t), this._endToken([]), this._consumeRawText(!1, () => this._cursor.peek() === r.$GT), this._beginToken(s.DOC_TYPE_END), this._cursor.advance(), this._endToken([])
            }

            _consumePrefixAndName() {
                let t = this._cursor.clone(), o = "";
                for (; this._cursor.peek() !== r.$COLON && !O(this._cursor.peek());) this._cursor.advance();
                let d;
            ...
            _consumeTagOpen(t) {
                ...
                this._handleFullNameStackForTagOpen(d, o), G === D.TagContentType.RAW_TEXT ? this._consumeRawTextWithTagClose(d, o, !1) : G === D.TagContentType.ESCAPABLE_RAW_TEXT && this._consumeRawTextWithTagClose(d, o, !0)
            }

            _consumeRawTextWithTagClose(t, o, d) {
                let h = this._consumeRawText(d, () => !this._attemptCharCode(r.$LT) || !this._attemptCharCode(r.$SLASH) || (this._attemptCharCodeUntilFn(g), !this._attemptStrCaseInsensitive(t ? `${t}:${o}` : o)) ? !1 : (this._attemptCharCodeUntilFn(g), this._attemptCharCode(r.$GT)));
            ...
            _consumeTagClose(t) {
                if (this._beginToken(s.TAG_CLOSE, t), this._attemptCharCodeUntilFn(g), this._allowHtmComponentClosingTags && this._attemptCharCode(r.$SLASH)) this._attemptCharCodeUntilFn(g), this._requireCharCode(r.$GT), this._endToken([]); else {
            ...
            _consumeText() {
                ...
                let o = [];
                do this._interpolationConfig && this._attemptStr(this._interpolationConfig.start) ? (o.push(this._interpolationConfig.start), this._inInterpolation = !0) : this._interpolationConfig && this._inInterpolation && this._attemptStr(this._interpolationConfig.end) ? (o.push(this._interpolationConfig.end), this._inInterpolation = !1) : o.push(this._readChar(!0)); while (!this._isTextEnd());
        ...
        var k = class {
            constructor(t, o) {
                if (t instanceof k) this.file = t.file, this.input = t.input, this.end = t.end, this.state = Object.assign({}, t.state); else {
                    if (!o) throw new Error("Programming error: the range argument must be provided with a file argument.");
                    this.file = t, this.input = t.content, this.end = o.endPos, this.state = {
                        peek: -1,
                        offset: o.startPos,
                        line: o.startLine,
                        column: o.startCol
            ...
            advanceState(t) {
                if (t.offset >= this.end) throw this.state = t, new L('Unexpected character "EOF"', this);
            ...
            processEscapeSequence() {
                ...
                if (t() === r.$BACKSLASH) if (this.internalState = Object.assign({}, this.state), this.advanceState(this.internalState), t() === r.$n) this.state.peek = r.$LF; else if (t() === r.$r) this.state.peek = r.$CR; else if (t() === r.$v) this.state.peek = r.$VTAB; else if (t() === r.$t) this.state.peek = r.$TAB; else if (t() === r.$b) this.state.peek = r.$BSPACE; else if (t() === r.$f) this.state.peek = r.$FF; else if (t() === r.$u) if (this.advanceState(this.internalState), t() === r.$LBRACE) {
                    ...
                    for (; r.isOctalDigit(t()) && d < 3;) h = this.clone(), o += String.fromCodePoint(t()), this.advanceState(this.internalState), d++;
            ...
            decodeHexDigits(t, o) {
                ...
                if (isNaN(h)) throw t.state = t.internalState, new L("Invalid hexadecimal escape sequence", t);
                return h
            }
        }, L = class {
            constructor(t, o) {
    ...
    "node_modules/angular-html-parser/lib/compiler/src/ml_parser/parser.js"(e) {
        ...
        var f = class {
            ...
            parse(i, l, p) {
                let m = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1,
                    C = arguments.length > 4 ? arguments[4] : void 0, g = k => function (j) {
                        for (var L = arguments.length, t = new Array(L > 1 ? L - 1 : 0), o = 1; o < L; o++) t[o - 1] = arguments[o];
                        return k(j.toLowerCase(), ...t)
                    }, B = m ? this.getTagDefinition : g(this.getTagDefinition), O = k => B(k).contentType,
                    F = m ? C : g(C), w = C ? (k, j, L, t) => {
                        let o = F(k, j, L, t);
                        return o !== void 0 ? o : O(k)
                    } : O, b = n.tokenize(i, l, w, p), M = p && p.canSelfClose || !1,
                    R = p && p.allowHtmComponentClosingTags || !1, U = new c(b.tokens, B, M, R, m).build();
        ...
        var c = class {
            ...
            _consumeComment(i) {
                let l = this._advanceIf(n.TokenType.RAW_TEXT), p = this._advanceIf(n.TokenType.COMMENT_END),
                    m = l != null ? l.parts[0].trim() : null,
                    C = new r.ParseSourceSpan(i.sourceSpan.start, (p || l || i).sourceSpan.end);
                this._addToParent(new u.Comment(m, C))
            }

            _consumeDocType(i) {
                let l = this._advanceIf(n.TokenType.RAW_TEXT), p = this._advanceIf(n.TokenType.DOC_TYPE_END),
                    m = l != null ? l.parts[0].trim() : null,
                    C = new r.ParseSourceSpan(i.sourceSpan.start, (p || l || i).sourceSpan.end);
            ...
            _parseExpansionCase() {
                ...
                if (C.errors.length > 0) return this._errors = this._errors.concat(C.errors), null;
                let g = new r.ParseSourceSpan(i.sourceSpan.start, m.sourceSpan.end),
                    B = new r.ParseSourceSpan(l.sourceSpan.start, m.sourceSpan.end);
            ...
            _collectExpansionExpTokens(i) {
                ...
                for (; ;) {
                    if ((this._peek.type === n.TokenType.EXPANSION_FORM_START || this._peek.type === n.TokenType.EXPANSION_CASE_EXP_START) && p.push(this._peek.type), this._peek.type === n.TokenType.EXPANSION_CASE_EXP_END) if (v(p, n.TokenType.EXPANSION_CASE_EXP_START)) {
                        if (p.pop(), p.length == 0) return l
                    } else return this._errors.push(s.create(null, i.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
                    if (this._peek.type === n.TokenType.EXPANSION_FORM_END) if (v(p, n.TokenType.EXPANSION_FORM_START)) p.pop(); else return this._errors.push(s.create(null, i.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
                    if (this._peek.type === n.TokenType.EOF) return this._errors.push(s.create(null, i.sourceSpan, "Invalid ICU message. Missing '}'.")), null;
...
`) {
            ...
            _consumeStartTag(i) {
                ...
                for (; this._peek.type === n.TokenType.ATTR_NAME;) m.push(this._consumeAttr(this._advance()));
                let C = this._getElementFullName(l, p, this._getParentElement()), g = !1;
                ...
                } else this._peek.type === n.TokenType.TAG_OPEN_END && (this._advance(), g = !1);
                let B = this._peek.sourceSpan.start, O = new r.ParseSourceSpan(i.sourceSpan.start, B),
                    F = new r.ParseSourceSpan(i.sourceSpan.start.moveBy(1), i.sourceSpan.end),
                    w = new u.Element(C, m, [], O, O, void 0, F);
            ...
            _consumeEndTag(i) {
                ...
                if (this._getParentElement() && (this._getParentElement().endSourceSpan = i.sourceSpan), l && this.getTagDefinition(l).isVoid) this._errors.push(s.create(l, i.sourceSpan, `Void elements do not have end tags "${i.parts[1]}"`)); else if (!this._popElement(l)) {
            ...
            _popElement(i) {
                for (let l = this._elementStack.length - 1; l >= 0; l--) {
                    ...
                    if (!i || (D.getNsPrefix(p.name) ? p.name == i : p.name.toLowerCase() == i.toLowerCase())) return this._elementStack.splice(l, this._elementStack.length - l), !0;
            ...
            _getParentElementSkippingContainers() {
                let i = null;
                for (let l = this._elementStack.length - 1; l >= 0; l--) {
                    if (!D.isNgContainer(this._elementStack[l].name)) return {
                        parent: this._elementStack[l],
                        container: i
                    };
            ...
            _insertBeforeContainer(i, l, p) {
                if (!l) this._addToParent(p), this._elementStack.push(p); else {
                    if (i) {
    ...
    "node_modules/angular-html-parser/lib/angular-html-parser/src/index.js"(e) {
        ...
        function s(a) {
            ...
            return D().parse(a, "angular-html-parser", {
    ...
    "src/language-html/parser-html.js"(e, r) {
        N();
        var {ParseSourceSpan: u, ParseLocation: n, ParseSourceFile: D} = Ne(), s = JD(), a = ls(),
            f = ZD(), {inferParserByLanguage: c} = yl(), v = Bl(), i = Nl(),
            l = Ol(), {hasPragma: p} = ql(), {Node: m} = Il(), {parseIeConditionalComment: C} = Rl(), {
                locStart: g,
                locEnd: B
            } = xl();
        ...
        function O(b, M, R) {
            let {
                canSelfClose: U,
                normalizeTagName: k,
                normalizeAttributeName: j,
                allowHtmComponentClosingTags: L,
                isTagNameCaseSensitive: t,
                getTagContentType: o
            } = M, d = ss(), {
                RecursiveVisitor: h,
                visitAll: A
            } = As(), {ParseSourceSpan: q} = Ne(), {getHtmlTagDefinition: P} = Fs(), {
                rootNodes: G,
                errors: X
            } = d.parse(b, {
                canSelfClose: U,
            ...
            if (R.parser === "vue") if (G.some(_ => _.type === "docType" && _.value === "html" || _.type === "element" && _.name.toLowerCase() === "html")) {
                U = !0, k = !0, j = !0, L = !0, t = !1;
                ...
                if (G.some(_)) {
                    ...
                    for (let z = 0; z < G.length; z++) {
                        ...
                        if (ie === null) X = $().errors, G[z] = V(Y) || Y; else if (_(Y)) {
            ...
            let Q = E => {
                let _ = E.name.startsWith(":") ? E.name.slice(1).split(":")[0] : null, T = E.nameSpan.toString(),
                    x = _ !== null && T.startsWith(`${_}:`), $ = x ? T.slice(_.length + 1) : T;
                E.name = $, E.namespace = _, E.hasExplicitNamespace = x
            }, H = E => {
                switch (E.type) {
                    case"element":
                        Q(E);
                        for (let _ of E.attrs) Q(_), _.valueSpan ? (_.value = _.valueSpan.toString(), /["']/.test(_.value[0]) && (_.value = _.value.slice(1, -1))) : _.value = null;
                        break;
                    case"comment":
                ...
                if (E.type === "element" && (k && (!E.namespace || E.namespace === E.tagDefinition.implicitNamespacePrefix || l(E)) && (E.name = W(E.name, _ => _ in v)), j)) {
                    let _ = i[E.name] || Object.create(null);
                    for (let T of E.attrs) T.namespace || (T.name = W(T.name, x => E.name in i && (x in i["*"] || x in _)))
                }
            }, J = E => {
        ...
        function F(b, M, R) {
            let U = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, {
                    frontMatter: k,
                    content: j
                } = U ? s(b) : {frontMatter: null, content: b}, L = new D(b, M.filepath), t = new n(L, 0, 0, 0),
                o = t.moveBy(b.length), d = {type: "root", sourceSpan: new u(t, o), children: O(j, R, M)};
            if (k) {
        ...
        function w() {
            let {
                ...
                isTagNameCaseSensitive: j = !1,
                getTagContentType: L
            } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
            return {
                parse: (t, o, d) => F(t, Object.assign({parser: b}, d), {
                    canSelfClose: M,
                    normalizeTagName: R,
                    normalizeAttributeName: U,
                    allowHtmComponentClosingTags: k,
                    isTagNameCaseSensitive: j,
                    getTagContentType: L
                }), hasPragma: p, astFormat: "html", locStart: g, locEnd: B
            }
        }
        ...
        r.exports = {
            parsers: {
                ...
                angular: w({name: "angular", canSelfClose: !0}),
                vue: w({
                    name: "vue", canSelfClose: !0, isTagNameCaseSensitive: !0, getTagContentType: (b, M, R, U) => {
