var De = Object.defineProperty, ar = Object.getOwnPropertyDescriptor, ze = Object.getOwnPropertyNames,
    or = Object.prototype.hasOwnProperty, Y = (e, t) => function () {
        ...
        if (t && typeof t == "object" || typeof t == "function") for (let s of ze(t)) !or.call(e, s) && s !== r && De(e, s, {
            get: () => t[s],
            enumerable: !(n = ar(t, s)) || n.enumerable
        });
        return e
    }, Ne = e => cr(De({}, "__esModule", {value: !0}), e), L = Y({
        "<define:process>"() {
        }
    }), ur = W({
        ...
        "src/language-js/loc.js"(e, t) {
            ...
            function n(l) {
                var P, p;
                let x = l.range ? l.range[0] : l.start,
            ...
            t.exports = {locStart: n, locEnd: s, hasSameLocStart: a, hasSameLoc: h}
        }
    }), hr = W({
...
var ae, q, k, G, be, K, Oe, Je, oe, ce, ne, ue, le, he, pe, de, fe, $, ge, ve, me, B, F, xe, Se, ye, we, Pe, U, V, Le,
    Ye, Ze, wt, Pt, Ct, se, Et, At, _t, et = Y({
        "node_modules/@angular/compiler/esm2015/src/expression_parser/ast.js"() {
            L(), ae = class {
                ...
                constructor(e, t, r, n, s) {
                    super(e, t), this.prefix = r, this.uninterpretedExpression = n, this.location = s
                }
                ...
                constructor(e, t, r, n, s) {
                    super(e, t), this.condition = r, this.trueExp = n, this.falseExp = s
                }
                ...
                constructor(e, t, r, n, s) {
                    super(e, t, r), this.receiver = n, this.name = s
                }
                ...
                constructor(e, t, r, n, s, a) {
                    super(e, t, r), this.receiver = n, this.name = s, this.value = a
                }
                ...
                constructor(e, t, r, n, s) {
                    super(e, t), this.receiver = r, this.key = n, this.value = s
                }
                ...
                constructor(e, t, r, n, s, a) {
                    super(e, t, a), this.exp = r, this.name = n, this.args = s
                }
                ...
                constructor(e, t, r, n, s) {
                    super(e, t), this.operation = r, this.left = n, this.right = s
                }
                ...
                constructor(e, t, r, n, s, a, i) {
                    super(e, t, s, a, i), this.operator = r, this.expr = n
                }
                ...
                constructor(e, t, r, n, s, a, i) {
                    super(e, t, r), this.receiver = n, this.name = s, this.args = a, this.argumentSpan = i
                }
                ...
                constructor(e, t, r, n, s) {
                    super(new q(0, t === null ? 0 : t.length), new U(n, t === null ? n : n + t.length)), this.ast = e, this.source = t, this.location = r, this.errors = s
                }
                ...
                visitPropertyWrite(e, t) {
                    let r = e.receiver.visit(this), n = e.value.visit(this);
                ...
                visitMethodCall(e, t) {
                    let r = e.receiver.visit(this), n = this.visitAll(e.args);
                ...
                visitFunctionCall(e, t) {
                    let r = e.target && e.target.visit(this), n = this.visitAll(e.args);
                ...
                visitBinary(e, t) {
                    let r = e.left.visit(this), n = e.right.visit(this);
                ...
                visitConditional(e, t) {
                    let r = e.condition.visit(this), n = e.trueExp.visit(this), s = e.falseExp.visit(this);
                    return r !== e.condition || n !== e.trueExp || s !== e.falseExp ? new ce(e.span, e.sourceSpan, r, n, s) : e
                }

                visitPipe(e, t) {
                    let r = e.exp.visit(this), n = this.visitAll(e.args);
                    return r !== e.exp || n !== e.args ? new fe(e.span, e.sourceSpan, r, e.name, n, e.nameSpan) : e
                }

                visitKeyedRead(e, t) {
                    let r = e.receiver.visit(this), n = e.key.visit(this);
                    return r !== e.receiver || n !== e.key ? new he(e.span, e.sourceSpan, r, n) : e
                }

                visitKeyedWrite(e, t) {
                    let r = e.receiver.visit(this), n = e.key.visit(this), s = e.value.visit(this);
...
function vt(e) {
    return e === it || e === nt || e === Ht
}

var Ce, tt, It, Ot, kt, Nt, rt, bt, nt, Lt, st, Rt, Me, it, Ee, z, Tt, at, ee, ot, H, Re, X, te, $t, ie, Bt, je, Kt, Mt,
    ct, jt, ut, Ae, Ft, re, Ut, $e, lt, Wt, Gt, Vt, qt, Qt, Dt, zt, ht, Te, Fe, _e, pt, Ht, Xt = Y({
        "node_modules/@angular/compiler/esm2015/src/chars.js"() {
            L(), Ce = 0, tt = 9, It = 10, Ot = 11, kt = 12, Nt = 13, rt = 32, bt = 33, nt = 34, Lt = 35, st = 36, Rt = 37, Me = 38, it = 39, Ee = 40, z = 41, Tt = 42, at = 43, ee = 44, ot = 45, H = 46, Re = 47, X = 58, te = 59, $t = 60, ie = 61, Bt = 62, je = 63, Kt = 48, Mt = 57, ct = 65, jt = 69, ut = 90, Ae = 91, Ft = 92, re = 93, Ut = 94, $e = 95, lt = 97, Wt = 101, Gt = 102, Vt = 110, qt = 114, Qt = 116, Dt = 117, zt = 118, ht = 122, Te = 123, Fe = 124, _e = 125, pt = 160, Ht = 96
        }
    }), Jt = {};
He(Jt, {EOF: () => Ie, Lexer: () => Zt, Token: () => M, TokenType: () => S, isIdentifier: () => Yt});
...
function Ue(e) {
    return lt <= e && e <= ht || ct <= e && e <= ut || e == $e || e == st
}
...
var S, xt, Zt, M, Ie, Ge, er = Y({
    "node_modules/@angular/compiler/esm2015/src/expression_parser/lexer.js"() {
        L(), Xt(), function (e) {
        ...
        }(S || (S = {})), xt = ["var", "let", "as", "null", "undefined", "true", "false", "if", "else", "this"], Zt = class {
            tokenize(e) {
                let t = new Ge(e), r = [], n = t.scanToken();
        ...
        }, Ie = new M(-1, -1, S.Character, 0, ""), Ge = class {
            constructor(e) {
            ...
            scanToken() {
                let e = this.input, t = this.length, r = this.peek, n = this.index;
                for (; r <= rt;) if (++n >= t) {
                    r = Ce;
                    break
                } else r = e.charCodeAt(n);
                if (this.peek = r, this.index = n, n >= t) return null;
                if (Ue(r)) return this.scanIdentifier();
                ...
                switch (r) {
                    ...
                    case Me:
                        return this.scanComplexOperator(s, "&", Me, "&");
                    case Fe:
            ...
            scanComplexOperator(e, t, r, n, s, a) {
                this.advance();
                let i = t;
                return this.peek == r && (this.advance(), i += n), s != null && this.peek == s && (this.advance(), i += a), Be(e, this.index, i)
            }
            ...
            scanIdentifier() {
                ...
                return xt.indexOf(t) > -1 ? mr(e, this.index, t) : gr(e, this.index, t)
            }
            ...
            scanPrivateIdentifier() {
                ...
                let t = this.input.substring(e, this.index);
                return vr(e, this.index, t)
            }

            scanNumber(e) {
                let t = this.index === e, r = !1;
                for (this.advance(); ;) {
                    if (!Q(this.peek)) if (this.peek === $e) {
                        ...
                        r = !0
                    } else if (this.peek === H) t = !1; else if (wr(this.peek)) {
                        if (this.advance(), Pr(this.peek) && this.advance(), !Q(this.peek)) return this.error("Invalid exponent", -1);
                        t = !1
                    } else break;
                    this.advance()
                }
                ...
                r && (n = n.replace(/_/g, ""));
                let s = t ? Er(n) : parseFloat(n);
                return Sr(e, this.index, s)
            }

            scanString() {
                let e = this.index, t = this.peek;
                this.advance();
                let r = "", n = this.index, s = this.input;
                for (; this.peek != t;) if (this.peek == Ft) {
                    r += s.substring(n, this.index), this.advance();
                    let i;
                    if (this.peek = this.peek, this.peek == Dt) {
                        let h = s.substring(this.index + 1, this.index + 5);
                        if (/^[0-9a-f]+$/i.test(h)) i = parseInt(h, 16); else return this.error(`Invalid unicode escape [\\u${h}]`, 0);
                        for (let l = 0; l < 5; l++) this.advance()
                    } else i = Cr(this.peek), this.advance();
                    r += String.fromCharCode(i), n = this.index
                } else {
                    if (this.peek == Ce) return this.error("Unterminated quote", 0);
                    this.advance()
                }
                let a = s.substring(n, this.index);
                return this.advance(), xr(e, this.index, r + a)
            }

            scanQuestion(e) {
                this.advance();
                let t = "?";
                return (this.peek === je || this.peek === H) && (t += this.peek === H ? "." : "?", this.advance()), Be(e, this.index, t)
            }

            error(e, t) {
                let r = this.index + t;
                return yr(r, this.index, `Lexer Error: ${e} at column ${r} in expression [${this.input}]`)
            }
        }
    }
});
...
var tr, _r = Y({
    ...
    "node_modules/@angular/compiler/esm2015/src/ml_parser/interpolation_config.js"() {
        L(), _r(), Ke = class {
            ...
            static fromArray(e) {
                return e ? (Ar("interpolation", e), new Ke(e[0], e[1])) : J
            }
        }, J = new Ke("{{", "}}")
    }
}), rr = {};
...
var Ve, qe, Qe, nr, Z, D, St, yt, Or = Y({
    "node_modules/@angular/compiler/esm2015/src/expression_parser/parser.js"() {
        L(), Xt(), Ir(), et(), er(), Ve = class {
            ...
            parseAction(e, t, r) {
                let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : J;
                this._checkNoInterpolation(e, t, n);
                let s = this._stripComments(e), a = this._lexer.tokenize(this._stripComments(e)),
                    i = new D(e, t, r, a, s.length, !0, this.errors, e.length - s.length).parseChain();
                return new V(i, e, t, r, this.errors)
            }

            parseBinding(e, t, r) {
                let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : J,
                    s = this._parseBindingAst(e, t, r, n);
                return new V(s, e, t, r, this.errors)
            }
            ...
            parseSimpleBinding(e, t, r) {
                let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : J,
                    s = this._parseBindingAst(e, t, r, n), a = this.checkSimpleExpression(s);
                return a.length > 0 && this._reportError(`Host binding expression cannot contain ${a.join(" ")}`, e, t), new V(s, e, t, r, this.errors)
            }
            ...
            _parseQuote(e, t, r) {
                ...
                if (!Yt(s)) return null;
                let a = e.substring(n + 1), i = new q(0, e.length);
                return new be(i, i.toAbsolute(r), s, a, t)
            }

            parseTemplateBindings(e, t, r, n, s) {
            ...
            parseInterpolation(e, t, r) {
                let n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : J, {
                    ...
                    expressions: a,
                    offsets: i
                } = this.splitInterpolation(e, t, n);
                if (a.length === 0) return null;
                let h = [];
                for (let l = 0; l < a.length; ++l) {
                    let P = a[l].text, p = this._stripComments(P), x = this._lexer.tokenize(p),
            ...
            parseInterpolationExpression(e, t, r) {
                let n = this._stripComments(e), s = this._lexer.tokenize(n),
                    a = new D(e, t, r, s, n.length, !1, this.errors, 0).parseChain(), i = ["", ""];
                return this.createInterpolationAst(i, [a], e, t, r)
            }

            createInterpolationAst(e, t, r, n, s) {
                let a = new q(0, r.length), i = new me(a, a.toAbsolute(s), e, t);
                return new V(i, r, n, s, this.errors)
            }

            splitInterpolation(e, t) {
                let r = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : J, n = [], s = [], a = [],
                    i = 0, h = !1, l = !1, {start: P, end: p} = r;
                for (; i < e.length;) if (h) {
                    ...
                    R.trim().length === 0 && this._reportError("Blank expressions are not allowed in interpolated strings", e, `at column ${i} in`, t), s.push({
                        text: R,
                        start: x,
                        end: _
                    }), a.push(C), i = _, h = !1
                    ...
                    n.push({text: C, start: x, end: i}), h = !0
                }
                if (!h) if (l) {
                    let x = n[n.length - 1];
                    x.text += e.substring(i), x.end = e.length
                } else n.push({text: e.substring(i), start: i, end: e.length});
                return new Ve(n, s, a)
            }

            wrapLiteralPrimitive(e, t, r) {
                let n = new q(0, e == null ? 0 : e.length);
                return new V(new $(n, n.toAbsolute(r), e), e, t, r, this.errors)
            }
            ...
            _commentStart(e) {
                ...
                for (let r = 0; r < e.length - 1; r++) {
                    let n = e.charCodeAt(r), s = e.charCodeAt(r + 1);
                    if (n === Re && s == Re && t == null) return r;
                    t === n ? t = null : t == null && vt(n) && (t = n)
                }
                return null
            }

            _checkNoInterpolation(e, t, r) {
                let {start: n, end: s} = r, a = -1, i = -1;
                for (let h of this._forEachUnquotedChar(e, 0)) if (a === -1) e.startsWith(n) && (a = h); else if (i = this._getInterpolationEndIndex(e, s, h), i > -1) break;
                a > -1 && i > -1 && this._reportError(`Got interpolation (${n}${s}) where expression was expected`, e, `at column ${a} in`, t)
            }
            ...
            * _forEachUnquotedChar(e, t) {
                ...
                for (let s = t; s < e.length; s++) {
                    let a = e[s];
                    vt(e.charCodeAt(s)) && (r === null || r === a) && n % 2 === 0 ? r = r === null ? a : null : r === null && (yield s), n = a === "\\" ? n + 1 : 0
                }
            }
        }, nr = class extends Qe {
            constructor() {
                super(...arguments), this.simpleExpressionChecker = yt
            }
        }, function (e) {
            ...
            parseChain() {
                ...
                for (; this.index < this.tokens.length;) {
                    ...
                    if (e.push(r), this.consumeOptionalCharacter(te)) for (this.parseAction || this.error("Binding expression cannot contain chained expression"); this.consumeOptionalCharacter(te);) ; else this.index < this.tokens.length && this.error(`Unexpected token '${this.next}'`)
                }
                if (e.length == 0) {
                    let r = this.offset, n = this.offset + this.inputLength;
                    return new K(this.span(r, n), this.sourceSpan(r, n))
                }
            ...
            parsePipe() {
                ...
                if (this.consumeOptionalOperator("|")) {
                    ...
                    do {
                        let r = this.inputIndex, n = this.expectIdentifierOrKeyword(), s, a;
                        n !== null ? s = this.sourceSpan(r) : (n = "", a = this.next.index !== -1 ? this.next.index : this.inputLength + this.offset, s = new q(a, a).toAbsolute(this.absoluteOffset));
                        let i = [];
            ...
            parseConditional() {
                ...
                if (this.consumeOptionalOperator("?")) {
                    let r = this.parsePipe(), n;
                    if (this.consumeOptionalCharacter(X)) n = this.parsePipe(); else {
                        let s = this.inputIndex, a = this.input.substring(e, s);
                        this.error(`Conditional expression ${a} requires all 3 expressions`), n = new K(this.span(e), this.sourceSpan(e))
                    }
            ...
            parseCallChain() {
                ...
                for (; ;) if (this.consumeOptionalCharacter(H)) t = this.parseAccessMemberOrMethodCall(t, e, !1); else if (this.consumeOptionalOperator("?.")) t = this.consumeOptionalCharacter(Ae) ? this.parseKeyedReadOrWrite(t, e, !0) : this.parseAccessMemberOrMethodCall(t, e, !0); else if (this.consumeOptionalCharacter(Ae)) t = this.parseKeyedReadOrWrite(t, e, !1); else if (this.consumeOptionalCharacter(Ee)) {
            ...
            parsePrimary() {
                ...
                if (this.consumeOptionalCharacter(Ee)) {
                    ...
                    if (this.next.isKeywordThis()) return this.advance(), new Je(this.span(e), this.sourceSpan(e));
            ...
            parseExpressionList(e) {
                let t = [];
                do if (!this.next.isCharacter(e)) t.push(this.parsePipe()); else break; while (this.consumeOptionalCharacter(ee));
                return t
            }
            ...
            parseLiteralMap() {
                ...
                if (this.expectCharacter(Te), !this.consumeOptionalCharacter(_e)) {
                    ...
                    do {
                        let n = this.inputIndex, s = this.next.isString(), a = this.expectIdentifierOrKeywordOrString();
                        if (e.push({
                            key: a,
                            quoted: s
                        }), s) this.expectCharacter(X), t.push(this.parsePipe()); else if (this.consumeOptionalCharacter(X)) t.push(this.parsePipe()); else {
                            let i = this.span(n), h = this.sourceSpan(n);
            ...
            parseAccessMemberOrMethodCall(e, t, r) {
                let n = this.inputIndex, s = this.withContext(Z.Writable, () => {
                    var i;
            ...
            parseCallArguments() {
                ...
                let e = [];
                do e.push(this.parsePipe()); while (this.consumeOptionalCharacter(ee));
                return e
            }

            expectTemplateBindingKey() {
                let e = "", t = !1, r = this.currentAbsoluteOffset;
            ...
            parseTemplateBindings(e) {
                ...
                for (t.push(...this.parseDirectiveKeywordBindings(e)); this.index < this.tokens.length;) {
                    ...
                    if (r) t.push(r); else {
                        let n = this.expectTemplateBindingKey(), s = this.parseAsBinding(n);
            ...
            parseKeyedReadOrWrite(e, t, r) {
                return this.withContext(Z.Writable, () => {
                    ...
                    if (n instanceof K && this.error("Key access cannot be empty"), this.rbracketsExpected--, this.expectCharacter(re), this.consumeOptionalOperator("=")) if (r) this.error("The '?.' operator cannot be used in the assignment"); else {
                        let s = this.parseConditional();
                        return new de(this.span(t), this.sourceSpan(t), e, n, s)
                    } else return r ? new pe(this.span(t), this.sourceSpan(t), e, n) : new he(this.span(t), this.sourceSpan(t), e, n);
            ...
            parseDirectiveKeywordBindings(e) {
                ...
                let r = this.getDirectiveBoundTarget(), n = this.currentAbsoluteOffset, s = this.parseAsBinding(e);
                s || (this.consumeStatementTerminator(), n = this.currentAbsoluteOffset);
                let a = new U(e.span.start, n);
                return t.push(new Ye(a, e, r)), s && t.push(s), t
            }

            getDirectiveBoundTarget() {
                if (this.next === Ie || this.peekKeywordAs() || this.peekKeywordLet()) return null;
                let e = this.parsePipe(), {start: t, end: r} = e.span, n = this.input.substring(t, r);
                return new V(e, n, this.location, this.absoluteOffset + t, this.errors)
            }
            ...
            parseLetBinding() {
                ...
                let n = new U(e, this.currentAbsoluteOffset);
                return new Le(n, t, r)
            }
            ...
            skip() {
                let e = this.next;
                for (; this.index < this.tokens.length && !e.isCharacter(te) && !e.isOperator("|") && (this.rparensExpected <= 0 || !e.isCharacter(z)) && (this.rbracesExpected <= 0 || !e.isCharacter(_e)) && (this.rbracketsExpected <= 0 || !e.isCharacter(re)) && (!(this.context & Z.Writable) || !e.isOperator("="));) this.next.isError() && this.errors.push(new ae(this.next.toString(), this.input, this.locationText(), this.location)), this.advance(), e = this.next
            }
        }, St = class {
            constructor() {
                this.errors = []
    ...
    "node_modules/angular-estree-parser/lib/utils.js"(e) {
        "use strict";
        L(), Object.defineProperty(e, "__esModule", {value: !0}), e.getLast = e.toLowerCamelCase = e.findBackChar = e.findFrontChar = e.fitSpans = e.getNgType = e.parseNgInterpolation = e.parseNgTemplateBindings = e.parseNgAction = e.parseNgSimpleBinding = e.parseNgBinding = e.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX = void 0;
        var t = (et(), Ne(Xe)), r = (er(), Ne(Jt)), n = (Or(), Ne(rr)), s = "angular-estree-parser";
        ...
        function C(o) {
            let d = h(), {
                templateBindings: y,
                errors: E
            } = d.parseTemplateBindings(e.NG_PARSE_TEMPLATE_BINDINGS_FAKE_PREFIX, o, s, a, a);
            return R(E), y
        }
        ...
        function b(o) {
            let d = h(), {astInput: y, comments: E} = T(o, d), A = "{{", I = "}}", {
                ast: j,
                errors: ir
            } = d.parseInterpolation(A + y + I, ...i);
            R(ir);
            let ft = j.expressions[0], gt = new Set;
            return _(ft, ke => {
                gt.has(ke) || (ke.start -= A.length, ke.end -= A.length, gt.add(ke))
            }), {ast: ft, comments: E}
        }
        ...
        function T(o, d) {
            ...
            return y === null ? {astInput: o, comments: []} : {
        ...
        function N(o, d) {
            ...
            for (; I !== A && /\s/.test(d[I - 1]);) I--;
            for (; A !== I && /\s/.test(d[A]);) A++;
            return {start: A, end: I}
        }

        function c(o, d) {
            let {start: y, end: E} = o, A = y, I = E;
            for (; I !== d.length && /\s/.test(d[I]);) I++;
            for (; A !== 0 && /\s/.test(d[A - 1]);) A--;
            return {start: A, end: I}
        }
        ...
        function u(o, d, y) {
            ...
            return {
                hasParens: (y ? E - 1 : E) !== 0,
                outerSpan: N(y ? {start: A.start + 1, end: A.end - 1} : A, d),
                innerSpan: N(o, d)
            }
        }
        ...
        function v(o, d, y) {
            let E = d;
            for (; !o.test(y[E]);) if (--E < 0) throw new Error(`Cannot find front char ${o} from index ${d} in ${JSON.stringify(y)}`);
            return E
        }
        ...
        function m(o, d, y) {
            let E = d;
            for (; !o.test(y[E]);) if (++E >= y.length) throw new Error(`Cannot find back char ${o} from index ${d} in ${JSON.stringify(y)}`);
            return E
        }
    ...
    "node_modules/angular-estree-parser/lib/transform.js"(e) {
        ...
        var t = dt(), r = function (s, a) {
            let i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, h = t.getNgType(s);
            switch (h) {
                case"Unary": {
                ...
                case"Binary": {
                    let {left: c, operation: g, right: u} = s, v = u.span.start === u.span.end,
                        m = c.span.start === c.span.end;
                    if (v || m) {
                        ...
                        return p("UnaryExpression", {
                            ...
                            argument: o,
                            operator: v ? "+" : "-"
                        }, {start: s.span.start, end: N(o)}, {hasParentParens: i})
                    }
                    let f = l(c), w = l(u);
                    return p(g === "&&" || g === "||" ? "LogicalExpression" : "BinaryExpression", {
                        left: f,
                        right: w,
                        operator: g
                    }, {start: O(f), end: N(w)}, {hasParentParens: i})
                }
                case"BindingPipe": {
                    let {exp: c, name: g, args: u} = s, v = l(c), m = b(/\S/, b(/\|/, N(v)) + 1),
                        f = p("Identifier", {name: g}, {start: m, end: m + g.length}), w = u.map(l);
                    return p("NGPipeExpression", {left: v, right: f, arguments: w}, {
                        start: O(v),
                        end: N(w.length === 0 ? f : t.getLast(w))
                    }, {hasParentParens: i})
                }
                case"Chain": {
                    let {expressions: c} = s;
                ...
                case"Conditional": {
                    ...
                    return p("ConditionalExpression", {test: v, consequent: m, alternate: f}, {
                        start: O(v),
                        end: N(f)
                    }, {hasParentParens: i})
                }
                ...
                case"FunctionCall": {
                    ...
                    return p("CallExpression", {callee: v, arguments: u}, {
                        start: O(v),
                        end: s.span.end
                    }, {hasParentParens: i})
                }
                ...
                case"KeyedRead": {
                    let {key: c} = s, g = Object.prototype.hasOwnProperty.call(s, "receiver") ? s.receiver : s.obj,
                        u = l(c);
                    return x(g, u, {computed: !0, optional: !1}, {end: s.span.end, hasParentParens: i})
                }
                case"LiteralArray": {
                    let {expressions: c} = s;
                ...
                case"LiteralMap": {
                    let {keys: c, values: g} = s, u = g.map(m => l(m)), v = c.map((m, f) => {
                        let {key: w, quoted: o} = m, d = u[f],
                            y = b(/\S/, f === 0 ? s.span.start + 1 : b(/,/, N(u[f - 1])) + 1),
                            E = C(/\S/, C(/:/, O(d) - 1) - 1) + 1, A = {start: y, end: E},
                            I = o ? p("StringLiteral", {value: w}, A) : p("Identifier", {name: w}, A),
                            j = I.end < I.start;
                ...
                case"MethodCall":
                case"SafeMethodCall": {
                    let c = h === "SafeMethodCall", {receiver: g, name: u, args: v} = s,
                        m = v.length === 1 ? [P(v[0])] : v.map(l),
                        f = C(/\S/, C(/\(/, (m.length === 0 ? C(/\)/, s.span.end - 1) : O(m[0])) - 1) - 1) + 1,
                        w = p("Identifier", {name: u}, {start: f - u.length, end: f}),
                        o = x(g, w, {computed: !1, optional: c}), d = R(o);
                    return p(c || d ? "OptionalCallExpression" : "CallExpression", {
                        callee: o,
                        arguments: m
                    }, {start: O(o), end: s.span.end}, {hasParentParens: i})
                }
                case"NonNullAssert": {
                    let {expression: c} = s, g = l(c);
                    return p("TSNonNullExpression", {expression: g}, {
                        start: O(g),
                        end: s.span.end
                    }, {hasParentParens: i})
                }
                case"PrefixNot": {
                    let {expression: c} = s, g = l(c);
                    return p("UnaryExpression", {prefix: !0, operator: "!", argument: g}, {
                        start: s.span.start,
                        end: N(g)
                    }, {hasParentParens: i})
                }
                ...
                case"SafePropertyRead": {
                    let c = h === "SafePropertyRead", {receiver: g, name: u} = s, v = C(/\S/, s.span.end - 1) + 1,
                        m = p("Identifier", {name: u}, {start: v - u.length, end: v}, _(g) ? {hasParentParens: i} : {});
                    return x(g, m, {computed: !1, optional: c}, {hasParentParens: i})
                }
                case"KeyedWrite": {
                    let {key: c, value: g} = s,
                        u = Object.prototype.hasOwnProperty.call(s, "receiver") ? s.receiver : s.obj, v = l(c),
                        m = l(g), f = x(u, v, {computed: !0, optional: !1}, {end: b(/\]/, N(v)) + 1});
                    return p("AssignmentExpression", {left: f, operator: "=", right: m}, {
                        start: O(f),
                        end: N(m)
                    }, {hasParentParens: i})
                }
                case"PropertyWrite": {
                    let {receiver: c, name: g, value: u} = s, v = l(u), m = C(/\S/, C(/=/, O(v) - 1) - 1) + 1,
                        f = p("Identifier", {name: g}, {start: m - g.length, end: m}),
                        w = x(c, f, {computed: !1, optional: !1});
                    return p("AssignmentExpression", {left: w, operator: "=", right: v}, {
                        start: O(w),
                        end: N(v)
                    }, {hasParentParens: i})
                }
            ...
            function p(c, g, u) {
                let {
                    ...
                    f = Object.assign(Object.assign({type: c}, n(u, a, v, m)), g);
                switch (c) {
                    case"Identifier": {
                        let w = f;
        ...
        function n(s, a) {
            ...
            if (!i) {
                ...
                return {
                    ...
                    loc: {start: a.locator.locationForIndex(x), end: a.locator.locationForIndex(C)}
                }
            }
    ...
    "node_modules/angular-estree-parser/lib/transform-microsyntax.js"(e) {
        ...
        var t = (et(), Ne(Xe)), r = sr(), n = dt();

        function s(a, i) {
            a.forEach(N);
            let [h] = a, {key: l} = h,
                P = i.text.slice(h.sourceSpan.start, h.sourceSpan.end).trim().length === 0 ? a.slice(1) : a, p = [],
                x = null;
            for (let u = 0; u < P.length; u++) {
                let v = P[u];
                if (x && T(x) && O(v) && v.value && v.value.source === x.key.source) {
                    let m = _("NGMicrosyntaxKey", {name: v.key.source}, v.key.span),
                        f = (d, y) => Object.assign(Object.assign({}, d), r.transformSpan({start: d.start, end: y}, i)),
                        w = d => Object.assign(Object.assign({}, f(d, m.end)), {alias: m}), o = p.pop();
                    ...
                    } else throw new Error(`Unexpected type ${o.type}`)
                } else p.push(C(v, u));
                x = v
            }
            return _("NGMicrosyntax", {body: p}, p.length === 0 ? a[0].sourceSpan : {
                start: p[0].start,
            ...
            function c(u) {
                ...
                let v = i.text[u.start], m = !1;
                for (let f = u.start + 1; f < i.text.length; f++) switch (i.text[f]) {
                    case v:
                        if (!m) {
                            u.end = f + 1;
                            return
            ...
            function g(u) {
                ...
                let v = n.findBackChar(/\S/, u.sourceSpan.start, i.text);
    ...
    "node_modules/angular-estree-parser/lib/index.js"(e) {
        "use strict";
        L(), Object.defineProperty(e, "__esModule", {value: !0}), e.parseTemplateBindings = e.parseAction = e.parseInterpolation = e.parseSimpleBinding = e.parseBinding = void 0;
        var t = pr(), r = sr(), n = kr(), s = dt();
    ...
    "src/language-js/parse/angular.js"(e, t) {
        L();
        var {locStart: r, locEnd: n} = lr();

        function s(a) {
            return {
                astFormat: "estree", parse: (h, l, P) => {
                    let p = Nr(), x = a(h, p);
                    return {
                        type: "NGRoot",
                        node: P.parser === "__ng_action" && x.type !== "NGChainedExpression" ? Object.assign(Object.assign({}, x), {}, {
