...
var Es = v((Yf, vi) => {
    ...
    vi.exports = function (l) {
        if (Ih(l)) throw Nh("Can't call method on " + l);
        return l
    }
});
var Lt = v((Qf, Ei) => {
...
var Ui = v((ad, qi) => {
    var ji = he(), ws = Oi(), Bi = ji.process, Mi = ji.Deno, _i = Bi && Bi.versions || Mi && Mi.version,
        Ri = _i && _i.v8, fe, Ot;
...
var Qi = v((pd, Yi) => {
    ...
    Yi.exports = function (l, h) {
        var f, d;
        if (h === "string" && Fs(f = l.toString) && !Ls(d = Ds(f, l)) || Fs(f = l.valueOf) && !Ls(d = Ds(f, l)) || h !== "string" && Fs(f = l.toString) && !Ls(d = Ds(f, l))) return d;
...
var it = v((Ad, da) => {
    var fu = he(), du = Os(), ua = Ie(), mu = Ms(), ca = Is(), fa = Ns(), Ge = du("wks"), Be = fu.Symbol,
        pa = Be && Be.for, yu = fa ? Be : Be && Be.withoutSetter || mu;
...
var ga = v((Td, xa) => {
    ...
    xa.exports = function (l, h) {
        if (!ma(l) || ya(l)) return l;
        var f = gu(l, vu), d;
        if (f) {
            if (h === void 0 && (h = "default"), d = xu(f, l, h), !ma(d) || ya(d)) return d;
...
var js = v((Cd, Ea) => {
    ...
    Ea.exports = !wu && !Iu(function () {
        return Object.defineProperty(Nu("div"), "a", {
            get: function () {
                return 7
            }
        }).a != 7
...
var qs = v(ba => {
    var ku = ve(), Du = Ft(), Fu = pi(), Lu = Ps(), Ou = Lt(), Bu = _s(), Mu = Ie(), _u = js(),
        Ca = Object.getOwnPropertyDescriptor;
    ba.f = ku ? Ca : function (h, f) {
        if (h = Ou(h), f = Bu(f), _u) try {
            return Ca(h, f)
        } catch {
        }
        if (Mu(h, f)) return Lu(!Du(Fu.f, h, f), h[f])
    }
});
var wa = v((Sd, Sa) => {
    var Ru = ve(), ju = ce();
...
var at = v(ka => {
    var Hu = ve(), zu = js(), Vu = wa(), jt = Rt(), Na = _s(), Ku = TypeError, Us = Object.defineProperty,
        Wu = Object.getOwnPropertyDescriptor, $s = "enumerable", Hs = "configurable", zs = "writable";
    ka.f = Hu ? Vu ? function (h, f, d) {
        if (jt(h), f = Na(f), jt(d), typeof h == "function" && f === "prototype" && "value" in d && zs in d && !d[zs]) {
            var x = Wu(h, f);
            x && x[zs] && (h[f] = d.value, d = {
                configurable: Hs in d ? d[Hs] : x[Hs],
                enumerable: $s in d ? d[$s] : x[$s],
                writable: !1
            })
        }
        return Us(h, f, d)
    } : Us : function (h, f, d) {
        if (jt(h), f = Na(f), jt(d), zu) try {
            return Us(h, f, d)
        } catch {
        }
        if ("get" in d || "set" in d) throw Ku("Accessors not supported");
...
var Oa = v((kd, La) => {
    var Ks = ve(), Yu = Ie(), Fa = Function.prototype, Qu = Ks && Object.getOwnPropertyDescriptor, Ws = Yu(Fa, "name"),
        Zu = Ws && function () {
...
var Ka = v((Bd, Va) => {
    var lc = Ra(), za = he(), hc = Oe(), uc = Vs(), Ys = Ie(), Qs = _t(), cc = Ua(), pc = Xs(),
        Ha = "Object already initialized", Zs = za.TypeError, fc = za.WeakMap, qt, nt, Ut, dc = function (l) {
            return Ut(l) ? nt(l) : qt(l, {})
        }, mc = function (l) {
            return function (h) {
                var f;
                if (!hc(h) || (f = nt(h)).type !== l) throw Zs("Incompatible receiver, " + l + " required");
                return f
            }
        };
    lc || Qs.state ? (de = Qs.state || (Qs.state = new fc), de.get = de.get, de.has = de.has, de.set = de.set, qt = function (l, h) {
        if (de.has(l)) throw Zs(Ha);
        return h.facade = l, de.set(l, h), h
    }, nt = function (l) {
        return de.get(l) || {}
    }, Ut = function (l) {
        return de.has(l)
    }) : (Me = cc("state"), pc[Me] = !0, qt = function (l, h) {
        if (Ys(l, Me)) throw Zs(Ha);
...
var tr = v((Md, Ga) => {
    var yc = ce(), xc = ie(), $t = Ie(), er = ve(), gc = Oa().CONFIGURABLE, Pc = Js(), Wa = Ka(), Ac = Wa.enforce,
        Tc = Wa.get, Ht = Object.defineProperty, vc = er && !yc(function () {
            return Ht(function () {
            }, "length", {value: 8}).length !== 8
        }), Ec = String(String).split("String"), Cc = Ga.exports = function (l, h, f) {
            String(h).slice(0, 7) === "Symbol(" && (h = "[" + String(h).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), f && f.getter && (h = "get " + h), f && f.setter && (h = "set " + h), (!$t(l, "name") || gc && l.name !== h) && (er ? Ht(l, "name", {
                value: h,
                configurable: !0
            }) : l.name = h), vc && f && $t(f, "arity") && l.length !== f.arity && Ht(l, "length", {value: f.arity});
            try {
...
var Xa = v((_d, Ja) => {
    ...
    Ja.exports = function (l, h, f, d) {
        ...
        if (bc(f) && wc(f, P, d), d.global) x ? l[h] = f : Ic(h, f); else {
            try {
...
var ln = v((Hd, on) => {
    var Rc = Lt(), jc = tn(), qc = zt(), nn = function (l) {
        return function (h, f, d) {
            ...
            if (l && f != f) {
                for (; P > m;) if (E = x[m++], E != E) return !0
            } else for (; P > m; m++) if ((l || m in x) && x[m] === f) return l || m || 0;
            return !l && -1
        }
    };
    on.exports = {includes: nn(!0), indexOf: nn(!1)}
});
var cn = v((zd, un) => {
    var Uc = pe(), rr = Ie(), $c = Lt(), Hc = ln().indexOf, zc = Xs(), hn = Uc([].push);
    un.exports = function (l, h) {
        var f = $c(l), d = 0, x = [], P;
        for (P in f) !rr(zc, P) && rr(f, P) && hn(x, P);
        for (; h.length > d;) rr(f, P = h[d++]) && (~Hc(x, P) || hn(x, P));
        return x
    }
});
var fn = v((Vd, pn) => {
...
var Cn = v((Xd, En) => {
    var rp = ce(), ip = ie(), ap = /#|\.prototype\./, ot = function (l, h) {
        var f = op[np(l)];
        return f == hp ? !0 : f == lp ? !1 : ip(h) ? rp(h) : !!h
...
var ar = v((Yd, bn) => {
    ...
    bn.exports = function (l, h) {
        ...
        if (d ? m = ir : x ? m = ir[f] || fp(f, {}) : m = (ir[f] || {}).prototype, m) for (E in h) {
...
var Sn = v(() => {
    var yp = ar(), nr = he();
    yp({global: !0, forced: nr.globalThis !== nr}, {globalThis: nr})
});
var Nn = v((em, In) => {
    var wn = tr(), xp = at();
    In.exports = function (l, h, f) {
        return f.get && wn(f.get, h, {getter: !0}), f.set && wn(f.set, h, {setter: !0}), xp.f(l, h, f)
    }
});
var Dn = v((tm, kn) => {
    "use strict";
...
var Mn = v((rm, Bn) => {
    ...
    Bn.exports = function (l) {
        if (l > wp) throw Sp("Maximum allowed index exceeded");
        return l
    }
});
var Rn = v((im, _n) => {
...
var zn = v((nm, Hn) => {
    ...
    var Lp = or(), Op = zt(), Bp = Mn(), Mp = Un(), $n = function (l, h, f, d, x, P, m, E) {
        for (var S = x, k = 0, L = m ? Mp(m, E) : !1, N, O; k < d;) k in f && (N = L ? L(f[k], k, h) : f[k], P > 0 && Lp(N) ? (O = Op(N), S = $n(l, h, N, O, S, P - 1) - 1) : (Bp(S + 1), l[S] = N), S++), k++;
        return S
    };
    Hn.exports = $n
});
...
var to = v((hm, eo) => {
    var Kp = pe(), Wp = ce(), Xn = ie(), Gp = Jn(), Jp = rt(), Xp = Js(), Yn = function () {
        }, Yp = [], Qn = Jp("Reflect", "construct"), lr = /^\s*(?:class|function)\b/, Qp = Kp(lr.exec), Zp = !lr.exec(Yn),
        lt = function (h) {
            if (!Xn(h)) return !1;
            try {
                return Qn(Yn, Yp, h), !0
...
Sn();
var Pp = he(), Ap = ve(), Tp = Nn(), vp = Dn(), Ep = ce(), Fn = Pp.RegExp, Ln = Fn.prototype,
    Cp = Ap && Ep(function () {
        var l = !0;
        try {
            Fn(".", "d")
...
nf({target: "Array", proto: !0}, {
    flatMap: function (h) {
        var f = hf(this), d = uf(f), x;
        return lf(h), x = cf(f, 0), x.length = of(x, f, f, d, 0, 1, h, arguments.length > 1 ? arguments[1] : void 0), x
    }
});
var pr = Object.defineProperty, pf = Object.getOwnPropertyDescriptor, fr = Object.getOwnPropertyNames,
    ff = Object.prototype.hasOwnProperty, lo = (l, h) => function () {
        return l && (h = (0, l[fr(l)[0]])(l = 0)), h
    }, $ = (l, h) => function () {
        return h || (0, l[fr(l)[0]])((h = {exports: {}}).exports, h), h.exports
    }, df = (l, h) => {
        for (var f in h) pr(l, f, {get: h[f], enumerable: !0})
    }, mf = (l, h, f, d) => {
        if (h && typeof h == "object" || typeof h == "function") for (let x of fr(h)) !ff.call(l, x) && x !== f && pr(l, x, {
            get: () => h[x],
            enumerable: !(d = pf(h, x)) || d.enumerable
        });
        return l
    }, yf = l => mf(pr({}, "__esModule", {value: !0}), l), U = lo({
        "<define:process>"() {
        }
    }), xf = $({
        "src/utils/try-combinations.js"(l, h) {
            "use strict";
            U();
        ...
        "src/language-js/utils/get-shebang.js"(l, h) {
            "use strict";
            U();
...
`);
        ...
        "src/utils/text/skip-inline-comment.js"(l, h) {
            "use strict";
            U();
        ...
        "src/utils/text/skip-newline.js"(l, h) {
            "use strict";
            U();
...
` || E === "\r" || E === "\u2028" || E === "\u2029") return x + 1
                ...
                return (S, k, L) => {
                    ...
                    for (; A >= 0 && A < O;) {
                        ...
                        if (E instanceof RegExp) {
                            if (!E.test(_)) return A
                        } else if (!E.includes(_)) return A;
                        N ? A-- : A++
                    }
                    return A === -1 || A === O ? A : !1
                }
        ...
        "src/utils/text/skip-trailing-comment.js"(l, h) {
            "use strict";
            U();
            var {skipEverythingButNewLine: f} = uo();

            function d(x, P) {
                return P === !1 ? !1 : x.charAt(P) === "/" && x.charAt(P + 1) === "/" ? f(x, P) : P
            }

            h.exports = d
        }
    }), Tf = $({
        "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l, h) {
            "use strict";
            U();
            ...
            function m(E, S) {
                let k = null, L = S;
                for (; L !== k;) k = L, L = P(E, L), L = f(E, L), L = x(E, L), L = d(E, L);
                return L
            }
...
df(co, {
    ...
    endianness: () => po,
    freemem: () => xo,
    getNetworkInterfaces: () => Eo,
    hostname: () => fo,
    loadavg: () => mo,
    networkInterfaces: () => vo,
    platform: () => Ef,
    release: () => To,
    tmpDir: () => hr,
    tmpdir: () => ur,
...
function po() {
    if (typeof Kt > "u") {
        ...
        if (h[0] = 1, h[1] = 2, f[0] === 258) Kt = "BE"; else if (f[0] === 513) Kt = "LE"; else throw new Error("unable to figure out endianess")
    }
    return Kt
}
...
`, Co = {
    ...
    "node-modules-polyfills-commonjs:os"(l, h) {
        U();
        var f = (Cf(), yf(co));
        if (f && f.default) {
            h.exports = f.default;
            for (let d in f) h.exports[d] = f[d]
        } else f && (h.exports = f)
    }
}), Sf = $({
    "node_modules/detect-newline/index.js"(l, h) {
        "use strict";
        U();
        var f = d => {
...
`
    ...
    "node_modules/jest-docblock/build/index.js"(l) {
        "use strict";
        ...
        function I(M) {
            ...
            let ee = "";
            for (; ee !== M;) ee = M, M = M.replace(k, `${V}$1 $2${V}`);
            M = M.replace(S, "").trimRight();
            let b = Object.create(null), B = M.replace(L, "").replace(S, "").trimRight(), te;
            for (; te = L.exec(M);) {
        ...
        function F(M) {
            let {comments: V = "", pragmas: ee = {}} = M, b = (0, f().default)(V) || h().EOL, B = "/**", te = " *",
                R = " */", ae = Object.keys(ee),
                se = ae.map(H => z(H, ee[H])).reduce((H, X) => H.concat(X), []).map(H => `${te} ${H}${b}`).join("");
            if (!V) {
...
`)
    ...
    "src/language-js/pragma.js"(l, h) {
        ...
        function L(N) {
            let {shebang: O, text: A, pragmas: _, comments: W} = S(N), I = d(A),
                F = P({pragmas: Object.assign({format: ""}, _), comments: W.trimStart()});
            return (O ? `${O}
` : "") + m(F) + (I.startsWith(`
`) ? `
` : `
...
`) + I
    ...
    "src/utils/is-non-empty-array.js"(l, h) {
        "use strict";
        U();
    ...
    "src/language-js/loc.js"(l, h) {
        ...
        function d(S) {
            var k, L;
            let N = S.range ? S.range[0] : S.start,
                O = (k = (L = S.declaration) === null || L === void 0 ? void 0 : L.decorators) !== null && k !== void 0 ? k : S.decorators;
    ...
    "src/language-js/parse/utils/create-parser.js"(l, h) {
        "use strict";
        U();
        var {hasPragma: f} = Nf(), {locStart: d, locEnd: x} = So();

        function P(m) {
            return m = typeof m == "function" ? {parse: m} : m, Object.assign({
                astFormat: "estree",
                hasPragma: f,
                locStart: d,
                locEnd: x
    ...
    "src/common/parser-create-error.js"(l, h) {
        "use strict";
        U();
    ...
    "src/language-js/parse/utils/create-babel-parse-error.js"(l, h) {
        "use strict";
        U();
        var f = dr();
    ...
    "src/language-js/utils/is-ts-keyword-type.js"(l, h) {
        "use strict";
        U();
    ...
    "src/language-js/utils/is-block-comment.js"(l, h) {
        "use strict";
        U();
        var f = new Set(["Block", "CommentBlock", "MultiLine"]), d = x => f.has(x == null ? void 0 : x.type);
        h.exports = d
    }
}), Ff = $({
    "src/language-js/utils/is-type-cast-comment.js"(l, h) {
        "use strict";
        U();
        var f = Df();
    ...
    "src/language-js/parse/postprocess/visit-node.js"(l, h) {
        "use strict";
        U();

        function f(d, x) {
            if (Array.isArray(d)) {
                for (let P = 0; P < d.length; P++) d[P] = f(d[P], x);
                return d
            }
            if (d && typeof d == "object" && typeof d.type == "string") {
                let P = Object.keys(d);
                for (let m = 0; m < P.length; m++) d[P[m]] = f(d[P[m]], x);
                return x(d) || d
            }
            return d
        }
    ...
    "src/language-js/parse/postprocess/throw-syntax-error.js"(l, h) {
        "use strict";
        U();
        var f = dr();
    ...
    "src/language-js/parse/postprocess/index.js"(l, h) {
        "use strict";
        U();
            ...
            if (_.parser !== "typescript" && _.parser !== "flow" && _.parser !== "acorn" && _.parser !== "espree" && _.parser !== "meriyah") {
                ...
                A = E(A, F => {
                    ...
                    if (F.type === "ParenthesizedExpression") {
                        let {expression: z} = F;
                        if (z.type === "TypeCastExpression") return z.range = F.range, z;
                        let M = f(F);
                        if (!I.has(M)) return z.extra = Object.assign(Object.assign({}, z.extra), {}, {parenthesized: !0}), z
                    }
                })
            }
            return A = E(A, I => {
                switch (I.type) {
                    ...
                    case"ExportAllDeclaration": {
                        ...
                        if (_.parser === "meriyah" && F && F.type === "Identifier") {
                            ...
                            (z.startsWith('"') || z.startsWith("'")) && (I.exported = Object.assign(Object.assign({}, I.exported), {}, {
                                type: "Literal",
    ...
    "node_modules/@babel/parser/lib/index.js"(l) {
        "use strict";
        ...
        x.template = new d("`", !0);
        var P = !0, m = !0, E = !0, S = !0, k = !0, L = !0, N = class {
            constructor(t) {
        ...
        function b(t) {
            let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            var e, s, i, a;
            return ++W, F.push(t), z.push((e = r.binop) != null ? e : -1), M.push((s = r.beforeExpr) != null ? s : !1), V.push((i = r.startsExpr) != null ? i : !1), ee.push((a = r.prefix) != null ? a : !1), I.push(new N(t, r)), W
        }

        function B(t) {
            let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
            var e, s, i, a;
            return ++W, O.set(t, W), F.push(t), z.push((e = r.binop) != null ? e : -1), M.push((s = r.beforeExpr) != null ? s : !1), V.push((i = r.startsExpr) != null ? i : !1), ee.push((a = r.prefix) != null ? a : !1), I.push(new N("name", r)), W
        }

        var te = {
            bracketL: b("[", {beforeExpr: P, startsExpr: m}),
            bracketHashL: b("#[", {beforeExpr: P, startsExpr: m}),
            bracketBarL: b("[|", {beforeExpr: P, startsExpr: m}),
            bracketR: b("]"),
            bracketBarR: b("|]"),
            braceL: b("{", {beforeExpr: P, startsExpr: m}),
            braceBarL: b("{|", {beforeExpr: P, startsExpr: m}),
            braceHashL: b("#{", {beforeExpr: P, startsExpr: m}),
            braceR: b("}"),
            braceBarR: b("|}"),
            parenL: b("(", {beforeExpr: P, startsExpr: m}),
            parenR: b(")"),
            comma: b(",", {beforeExpr: P}),
            semi: b(";", {beforeExpr: P}),
            colon: b(":", {beforeExpr: P}),
            doubleColon: b("::", {beforeExpr: P}),
            dot: b("."),
            question: b("?", {beforeExpr: P}),
            questionDot: b("?."),
            arrow: b("=>", {beforeExpr: P}),
            template: b("template"),
            ellipsis: b("...", {beforeExpr: P}),
            backQuote: b("`", {startsExpr: m}),
            dollarBraceL: b("${", {beforeExpr: P, startsExpr: m}),
            templateTail: b("...`", {startsExpr: m}),
            templateNonTail: b("...${", {beforeExpr: P, startsExpr: m}),
            at: b("@"),
            hash: b("#", {startsExpr: m}),
            interpreterDirective: b("#!..."),
            eq: b("=", {beforeExpr: P, isAssign: S}),
            assign: b("_=", {beforeExpr: P, isAssign: S}),
            slashAssign: b("_=", {beforeExpr: P, isAssign: S}),
            xorAssign: b("_=", {beforeExpr: P, isAssign: S}),
            moduloAssign: b("_=", {beforeExpr: P, isAssign: S}),
            incDec: b("++/--", {prefix: k, postfix: L, startsExpr: m}),
            bang: b("!", {beforeExpr: P, prefix: k, startsExpr: m}),
            tilde: b("~", {beforeExpr: P, prefix: k, startsExpr: m}),
            doubleCaret: b("^^", {startsExpr: m}),
            doubleAt: b("@@", {startsExpr: m}),
            pipeline: _("|>", 0),
            ...
            bitShiftL: _("<</>>/>>>", 8),
            bitShiftR: _("<</>>/>>>", 8),
            plusMin: b("+/-", {beforeExpr: P, binop: 9, prefix: k, startsExpr: m}),
            modulo: b("%", {binop: 10, startsExpr: m}),
            star: b("*", {binop: 10}),
            slash: _("/", 10),
            exponent: b("**", {beforeExpr: P, binop: 11, rightAssociative: !0}),
            _in: A("in", {beforeExpr: P, binop: 7}),
            _instanceof: A("instanceof", {beforeExpr: P, binop: 7}),
            _break: A("break"),
            _case: A("case", {beforeExpr: P}),
            _catch: A("catch"),
            _continue: A("continue"),
            _debugger: A("debugger"),
            _default: A("default", {beforeExpr: P}),
            _else: A("else", {beforeExpr: P}),
            _finally: A("finally"),
            _function: A("function", {startsExpr: m}),
            _if: A("if"),
            _return: A("return", {beforeExpr: P}),
            _switch: A("switch"),
            _throw: A("throw", {beforeExpr: P, prefix: k, startsExpr: m}),
            _try: A("try"),
            _var: A("var"),
            _const: A("const"),
            _with: A("with"),
            _new: A("new", {beforeExpr: P, startsExpr: m}),
            _this: A("this", {startsExpr: m}),
            _super: A("super", {startsExpr: m}),
            _class: A("class", {startsExpr: m}),
            _extends: A("extends", {beforeExpr: P}),
            _export: A("export"),
            _import: A("import", {startsExpr: m}),
            _null: A("null", {startsExpr: m}),
            _true: A("true", {startsExpr: m}),
            _false: A("false", {startsExpr: m}),
            _typeof: A("typeof", {beforeExpr: P, prefix: k, startsExpr: m}),
            _void: A("void", {beforeExpr: P, prefix: k, startsExpr: m}),
            _delete: A("delete", {beforeExpr: P, prefix: k, startsExpr: m}),
            _do: A("do", {isLoop: E, beforeExpr: P}),
            _for: A("for", {isLoop: E}),
            ...
            name: b("name", {startsExpr: m}),
            string: b("string", {startsExpr: m}),
            num: b("num", {startsExpr: m}),
            bigint: b("bigint", {startsExpr: m}),
            decimal: b("decimal", {startsExpr: m}),
            regexp: b("regexp", {startsExpr: m}),
            privateName: b("#name", {startsExpr: m}),
            eof: b("eof"),
            jsxName: b("jsxName"),
        ...
        var Jt = {
                ...
                return [i, typeof a == "function" ? {
                    value: a,
                    enumerable: !1
                } : typeof a.reflect == "string" ? Object.assign({}, a, ko(a.reflect.split("."))) : a]
            }).reduce((s, i) => {
                let [a, n] = i;
                return Object.defineProperty(s, a, Object.assign({configurable: !0}, n))
            }, Object.assign(new t, r)), Fo = {
                ...
                DeclarationMissingInitializer: t => {
                    let {kind: r} = t;
...
- Did you mean \`import { "${r}" as foo }\`?`
                ...
                InvalidPrivateFieldResolution: t => {
                    let {identifierName: r} = t;
                ...
                ModuleAttributesWithDuplicateKeys: t => {
                    let {key: r} = t;
            ...
            Bo = new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]),
            Mo = {
            ...
            }, _o = ["toMessage"], Ro = ["message"];

        function jo(t) {
            let {toMessage: r} = t, e = pt(t, _o);
            return function s(i) {
                let {loc: a, details: n} = i;
                return Do(SyntaxError, Object.assign({}, e, {loc: a}), {
                    clone() {
                        let o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, u = o.loc || {};
                        return s({
                            loc: new Ce("line" in u ? u.line : this.loc.line, "column" in u ? u.column : this.loc.column, "index" in u ? u.index : this.loc.index),
        ...
        function ge(t, r) {
            if (Array.isArray(t)) return s => ge(s, t[0]);
            let e = {};
            for (let s of Object.keys(t)) {
                let i = t[s],
                    a = typeof i == "string" ? {message: () => i} : typeof i == "function" ? {message: i} : i, {message: n} = a,
                    o = pt(a, Ro), u = typeof n == "string" ? () => n : n;
                e[s] = jo(Object.assign({
                    code: Jt.SyntaxError,
                    reasonCode: s,
                    toMessage: u
                }, r ? {syntaxPlugin: r} : {}, o))
        ...
        var p = Object.assign({}, ge(Fo), ge(Lo), ge(Oo), ge`pipelineOperator`(Mo)), {defineProperty: qo} = Object,
            yr = (t, r) => qo(t, r, {enumerable: !1, value: t[r]});
        ...
        var Uo = t => class extends t {
                ...
                parseMethod(e, s, i, a, n, o) {
                    let u = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : !1, c = this.startNode();
                    return c.kind = e.kind, c = super.parseMethod(c, s, i, a, n, o, u), c.type = "FunctionExpression", delete c.kind, e.value = c, o === "ClassPrivateMethod" && (e.computed = !1), this.finishNode(e, "MethodDefinition")
                }
            ...
            xr = "\u200C\u200D\xB7\u0300-\u036F\u0387\u0483-\u0487\u0591-\u05BD\u05BF\u05C1\u05C2\u05C4\u05C5\u05C7\u0610-\u061A\u064B-\u0669\u0670\u06D6-\u06DC\u06DF-\u06E4\u06E7\u06E8\u06EA-\u06ED\u06F0-\u06F9\u0711\u0730-\u074A\u07A6-\u07B0\u07C0-\u07C9\u07EB-\u07F3\u07FD\u0816-\u0819\u081B-\u0823\u0825-\u0827\u0829-\u082D\u0859-\u085B\u0898-\u089F\u08CA-\u08E1\u08E3-\u0903\u093A-\u093C\u093E-\u094F\u0951-\u0957\u0962\u0963\u0966-\u096F\u0981-\u0983\u09BC\u09BE-\u09C4\u09C7\u09C8\u09CB-\u09CD\u09D7\u09E2\u09E3\u09E6-\u09EF\u09FE\u0A01-\u0A03\u0A3C\u0A3E-\u0A42\u0A47\u0A48\u0A4B-\u0A4D\u0A51\u0A66-\u0A71\u0A75\u0A81-\u0A83\u0ABC\u0ABE-\u0AC5\u0AC7-\u0AC9\u0ACB-\u0ACD\u0AE2\u0AE3\u0AE6-\u0AEF\u0AFA-\u0AFF\u0B01-\u0B03\u0B3C\u0B3E-\u0B44\u0B47\u0B48\u0B4B-\u0B4D\u0B55-\u0B57\u0B62\u0B63\u0B66-\u0B6F\u0B82\u0BBE-\u0BC2\u0BC6-\u0BC8\u0BCA-\u0BCD\u0BD7\u0BE6-\u0BEF\u0C00-\u0C04\u0C3C\u0C3E-\u0C44\u0C46-\u0C48\u0C4A-\u0C4D\u0C55\u0C56\u0C62\u0C63\u0C66-\u0C6F\u0C81-\u0C83\u0CBC\u0CBE-\u0CC4\u0CC6-\u0CC8\u0CCA-\u0CCD\u0CD5\u0CD6\u0CE2\u0CE3\u0CE6-\u0CEF\u0CF3\u0D00-\u0D03\u0D3B\u0D3C\u0D3E-\u0D44\u0D46-\u0D48\u0D4A-\u0D4D\u0D57\u0D62\u0D63\u0D66-\u0D6F\u0D81-\u0D83\u0DCA\u0DCF-\u0DD4\u0DD6\u0DD8-\u0DDF\u0DE6-\u0DEF\u0DF2\u0DF3\u0E31\u0E34-\u0E3A\u0E47-\u0E4E\u0E50-\u0E59\u0EB1\u0EB4-\u0EBC\u0EC8-\u0ECE\u0ED0-\u0ED9\u0F18\u0F19\u0F20-\u0F29\u0F35\u0F37\u0F39\u0F3E\u0F3F\u0F71-\u0F84\u0F86\u0F87\u0F8D-\u0F97\u0F99-\u0FBC\u0FC6\u102B-\u103E\u1040-\u1049\u1056-\u1059\u105E-\u1060\u1062-\u1064\u1067-\u106D\u1071-\u1074\u1082-\u108D\u108F-\u109D\u135D-\u135F\u1369-\u1371\u1712-\u1715\u1732-\u1734\u1752\u1753\u1772\u1773\u17B4-\u17D3\u17DD\u17E0-\u17E9\u180B-\u180D\u180F-\u1819\u18A9\u1920-\u192B\u1930-\u193B\u1946-\u194F\u19D0-\u19DA\u1A17-\u1A1B\u1A55-\u1A5E\u1A60-\u1A7C\u1A7F-\u1A89\u1A90-\u1A99\u1AB0-\u1ABD\u1ABF-\u1ACE\u1B00-\u1B04\u1B34-\u1B44\u1B50-\u1B59\u1B6B-\u1B73\u1B80-\u1B82\u1BA1-\u1BAD\u1BB0-\u1BB9\u1BE6-\u1BF3\u1C24-\u1C37\u1C40-\u1C49\u1C50-\u1C59\u1CD0-\u1CD2\u1CD4-\u1CE8\u1CED\u1CF4\u1CF7-\u1CF9\u1DC0-\u1DFF\u203F\u2040\u2054\u20D0-\u20DC\u20E1\u20E5-\u20F0\u2CEF-\u2CF1\u2D7F\u2DE0-\u2DFF\u302A-\u302F\u3099\u309A\uA620-\uA629\uA66F\uA674-\uA67D\uA69E\uA69F\uA6F0\uA6F1\uA802\uA806\uA80B\uA823-\uA827\uA82C\uA880\uA881\uA8B4-\uA8C5\uA8D0-\uA8D9\uA8E0-\uA8F1\uA8FF-\uA909\uA926-\uA92D\uA947-\uA953\uA980-\uA983\uA9B3-\uA9C0\uA9D0-\uA9D9\uA9E5\uA9F0-\uA9F9\uAA29-\uAA36\uAA43\uAA4C\uAA4D\uAA50-\uAA59\uAA7B-\uAA7D\uAAB0\uAAB2-\uAAB4\uAAB7\uAAB8\uAABE\uAABF\uAAC1\uAAEB-\uAAEF\uAAF5\uAAF6\uABE3-\uABEA\uABEC\uABED\uABF0-\uABF9\uFB1E\uFE00-\uFE0F\uFE20-\uFE2F\uFE33\uFE34\uFE4D-\uFE4F\uFF10-\uFF19\uFF3F",
            $o = new RegExp("[" + Yt + "]"), Ho = new RegExp("[" + Yt + xr + "]");
        Yt = xr = null;
        ...
        function Pe(t) {
            return t < 65 ? t === 36 : t <= 90 ? !0 : t < 97 ? t === 95 : t <= 122 ? !0 : t <= 65535 ? t >= 170 && $o.test(String.fromCharCode(t)) : Qt(t, gr)
        }

        function je(t) {
            return t < 48 ? t === 36 : t < 58 ? !0 : t < 65 ? !1 : t <= 90 ? !0 : t < 97 ? t === 95 : t <= 122 ? !0 : t <= 65535 ? t >= 170 && Ho.test(String.fromCharCode(t)) : Qt(t, gr) || Qt(t, zo)
        }
        ...
        }, Vo = new Set(Zt.keyword), Ko = new Set(Zt.strict), Wo = new Set(Zt.strictBind);
        ...
        var qe = 0, Ue = 1, Ae = 2, es = 4, Er = 8, dt = 16, Cr = 32, Ne = 64, mt = 128, $e = 256,
            yt = Ue | Ae | mt | $e, me = 1, ke = 2, br = 4, De = 8, xt = 16, Sr = 64, gt = 128, ts = 256, ss = 512,
            rs = 1024, is = 2048, Xe = 4096, Pt = 8192, wr = me | ke | De | gt | Pt, He = me | 0 | De | Pt,
            Qo = me | 0 | De | 0, At = me | 0 | br | 0, Ir = me | 0 | xt | 0, Zo = 0 | ke | 0 | gt, el = 0 | ke | 0 | 0,
            Nr = me | ke | De | ts | Pt, kr = 0 | rs, be = 0 | Sr, tl = me | 0 | 0 | Sr, sl = Nr | ss, rl = 0 | rs,
            Dr = 0 | ke | 0 | Xe, il = is, Tt = 4, as = 2, ns = 1, os = as | ns, al = as | Tt, nl = ns | Tt, ol = as,
            ll = ns, ls = 0, hs = class {
                constructor(t) {
                ...
                declareName(t, r, e) {
                    ...
                    if (r & De || r & xt) this.checkRedeclarationInScope(s, t, r, e), r & xt ? s.functions.add(t) : s.lexical.add(t), r & De && this.maybeExportDefined(s, t); else if (r & br) for (let i = this.scopeStack.length - 1; i >= 0 && (s = this.scopeStack[i], this.checkRedeclarationInScope(s, t, r, e), s.var.add(t), this.maybeExportDefined(s, t), !(s.flags & yt)); --i) ;
                ...
                isRedeclaredInScope(t, r, e) {
                    return e & me ? e & De ? t.lexical.has(r) || t.functions.has(r) || t.var.has(r) : e & xt ? t.lexical.has(r) || !this.treatFunctionsAsVarInScope(t) && t.var.has(r) : t.lexical.has(r) && !(t.flags & Er && t.lexical.values().next().value === r) || !this.treatFunctionsAsVarInScope(t) && t.functions.has(r) : !1
                }
                ...
                isRedeclaredInScope(t, r, e) {
                    return super.isRedeclaredInScope(t, r, e) ? !0 : e & is ? !t.declareFunctions.has(r) && (t.lexical.has(r) || t.functions.has(r)) : !1
                }
                ...
                hasPlugin(t) {
                    if (typeof t == "string") return this.plugins.has(t);
                    {
                        ...
                        for (let i of Object.keys(e)) if ((s == null ? void 0 : s[i]) !== e[i]) return !1;
                        return !0
                    }
                }
        ...
        var fl = class extends cl {
            ...
            finalizeComment(t) {
                let {comments: r} = t;
                if (t.leadingNode !== null || t.trailingNode !== null) t.leadingNode !== null && Fr(t.leadingNode, r), t.trailingNode !== null && pl(t.trailingNode, r); else {
        ...
        var Or = class {
            ...
            init(t) {
                ...
                this.strict = r === !1 ? !1 : r === !0 ? !0 : e === "module", this.curLine = s, this.lineStart = -i, this.startLoc = this.endLoc = new Ce(s, i, 0)
            }
            ...
            return r >= 48 && r <= 57
        }, Br = {decBinOct: new Set([46, 66, 69, 79, 95, 98, 101, 111]), hex: new Set([46, 88, 95, 120])}, Et = {
            bin: t => t === 48 || t === 49,
            oct: t => t >= 48 && t <= 55,
            dec: t => t >= 48 && t <= 57,
        ...
        function Mr(t, r, e, s, i, a) {
            ...
            for (; ;) {
                ...
                if (C === 92) {
                    ...
                    j.ch === null && !y ? y = {pos: e, lineStart: s, curLine: i} : c += j.ch, {
                        pos: e,
                        lineStart: s,
                        curLine: i
                    } = j, g = e
...
`);
                ...
                case 120: {
                    ...
                    return {
                        code: c,
                        pos: r
                    } = fs(t, r, e, s, 2, !1, n, a), o(c === null ? null : String.fromCharCode(c))
                }
                case 117: {
                    let c;
        ...
        function fs(t, r, e, s, i, a, n, o) {
            ...
            return {
                n: c,
                pos: r
            } = _r(t, r, e, s, 16, i, a, !1, o, !n), c === null && (n ? o.invalidEscapeSequence(u, e, s) : r = u - 1), {
                code: c,
                pos: r
            }
        }
        ...
        function _r(t, r, e, s, i, a, n, o, u, c) {
            let y = r, g = i === 16 ? Br.hex : Br.decBinOct,
                T = i === 16 ? Et.hex : i === 10 ? Et.dec : i === 8 ? Et.oct : Et.bin, C = !1, j = 0;
            for (let q = 0, G = a == null ? 1 / 0 : a; q < G; ++q) {
                ...
                if (J >= 97 ? K = J - 97 + 10 : J >= 65 ? K = J - 65 + 10 : yl(J) ? K = J - 48 : K = 1 / 0, K >= i) {
                    if (K <= 9 && c) return {n: null, pos: r};
                    if (K <= 9 && u.invalidDigit(r, e, s, i)) K = 0; else if (n) K = 0, C = !0; else break
                }
                ++r, j = j * i + K
            }
        ...
        function Rr(t, r, e, s, i, a) {
            ...
            if (n === 123) {
                if (++r, {
                    code: o,
                    pos: r
                } = fs(t, r, e, s, t.indexOf("}", r) - r, !0, i, a), ++r, o !== null && o > 1114111) if (i) a.invalidCodePoint(r, e, s); else return {
                    code: null,
                    pos: r
                }
            } else ({code: o, pos: r} = fs(t, r, e, s, 4, !1, i, a));
            return {code: o, pos: r}
        }
        ...
        var Tl = new Set([103, 109, 115, 105, 121, 117, 100, 118]), Se = class {
            constructor(t) {
            ...
            constructor(t, r) {
                super(), this.isLookahead = void 0, this.tokens = [], this.errorHandlers_readInt = {
                    invalidDigit: (e, s, i, a) => this.options.errorRecovery ? (this.raise(p.InvalidDigit, {
                        at: et(e, s, i),
                        radix: a
                    }), !0) : !1,
                ...
                }), this.state = new Or, this.state.init(t), this.input = r, this.length = r.length, this.isLookahead = !1
            }
            ...
            skipBlockComment(t) {
                ...
                if (s === -1) throw this.raise(p.UnterminatedComment, {at: this.state.curPosition()});
                for (this.state.pos = s + t.length, vt.lastIndex = e + 2; vt.test(this.input) && vt.lastIndex <= s;) ++this.state.curLine, this.state.lineStart = vt.lastIndex;
                ...
                let i = {
                    ...
                    loc: new ft(r, this.state.curPosition())
                };
            ...
            skipLineComment(t) {
                ...
                if (this.state.pos < this.length) for (; !Ze(s) && ++this.state.pos < this.length;) s = this.input.charCodeAt(this.state.pos);
                if (this.isLookahead) return;
                let i = this.state.pos, n = {
                    ...
                    loc: new ft(e, this.state.curPosition())
                };
                ...
                e:for (; this.state.pos < this.length;) {
                    ...
                    switch (e) {
                        ...
                        case 47:
                            ...
                            break;
                        default:
                            if (ml(e)) ++this.state.pos; else if (e === 45 && !this.inModule && this.options.annexB) {
            ...
            readToken_numberSign() {
                ...
                if (r >= 48 && r <= 57) throw this.raise(p.UnexpectedDigitAfterHash, {at: this.state.curPosition()});
                if (r === 123 || r === 91 && this.hasPlugin("recordAndTuple")) {
                    if (this.expectPlugin("recordAndTuple"), this.getPluginOption("recordAndTuple", "syntaxType") === "bar") throw this.raise(r === 123 ? p.RecordExpressionHashIncorrectStartSyntaxType : p.TupleExpressionHashIncorrectStartSyntaxType, {at: this.state.curPosition()});
                    this.state.pos += 2, r === 123 ? this.finishToken(7) : this.finishToken(1)
                } else Pe(r) ? (++this.state.pos, this.finishToken(136, this.readWord1(r))) : r === 92 ? (++this.state.pos, this.finishToken(136, this.readWord1())) : this.finishOp(27, 1)
            }
            ...
            readToken_interpreter() {
                ...
                for (this.state.pos += 1; !Ze(t) && ++this.state.pos < this.length;) t = this.input.charCodeAt(this.state.pos);
            ...
            readToken_pipe_amp(t) {
                ...
                if (t === 124) {
                    ...
                    if (this.hasPlugin("recordAndTuple") && r === 125) {
                        if (this.getPluginOption("recordAndTuple", "syntaxType") !== "bar") throw this.raise(p.RecordExpressionBarIncorrectEndSyntaxType, {at: this.state.curPosition()});
                        this.state.pos += 2, this.finishToken(9);
                        return
                    }
                    if (this.hasPlugin("recordAndTuple") && r === 93) {
                        if (this.getPluginOption("recordAndTuple", "syntaxType") !== "bar") throw this.raise(p.TupleExpressionBarIncorrectEndSyntaxType, {at: this.state.curPosition()});
                ...
                switch (t) {
                    ...
                    case 91:
                        if (this.hasPlugin("recordAndTuple") && this.input.charCodeAt(this.state.pos + 1) === 124) {
                            if (this.getPluginOption("recordAndTuple", "syntaxType") !== "bar") throw this.raise(p.TupleExpressionBarIncorrectStartSyntaxType, {at: this.state.curPosition()});
                    ...
                    case 123:
                        if (this.hasPlugin("recordAndTuple") && this.input.charCodeAt(this.state.pos + 1) === 124) {
                            if (this.getPluginOption("recordAndTuple", "syntaxType") !== "bar") throw this.raise(p.RecordExpressionBarIncorrectStartSyntaxType, {at: this.state.curPosition()});
            ...
            readRegexp() {
                ...
                for (; ; ++i) {
                    if (i >= this.length) throw this.raise(p.UnterminatedRegExp, {at: re(t, 1)});
                    let u = this.input.charCodeAt(i);
                    if (Ze(u)) throw this.raise(p.UnterminatedRegExp, {at: re(t, 1)});
                    if (e) e = !1; else {
                ...
                for (; i < this.length;) {
                    ...
                    if (Tl.has(u)) u === 118 ? (this.expectPlugin("regexpUnicodeSets", o()), n.includes("u") && this.raise(p.IncompatibleRegExpUVFlags, {at: o()})) : u === 117 && n.includes("v") && this.raise(p.IncompatibleRegExpUVFlags, {at: o()}), n.includes(c) && this.raise(p.DuplicateRegExpFlags, {at: o()}); else if (je(u) || u === 92) this.raise(p.MalformedRegExpFlags, {at: o()}); else break;
                    ++i, n += c
                }
            ...
            readInt(t, r) {
                let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1,
                    s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, {
                        n: i,
                        pos: a
                    } = _r(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, r, e, s, this.errorHandlers_readInt, !1);
                return this.state.pos = a, i
            }

            readRadixNumber(t) {
                let r = this.state.curPosition(), e = !1;
                this.state.pos += 2;
                let s = this.readInt(t);
                s == null && this.raise(p.InvalidDigit, {at: re(r, 2), radix: t});
                let i = this.input.charCodeAt(this.state.pos);
                if (i === 110) ++this.state.pos, e = !0; else if (i === 109) throw this.raise(p.InvalidDecimal, {at: r});
                if (Pe(this.codePointAtPos(this.state.pos))) throw this.raise(p.NumberIdentifier, {at: this.state.curPosition()});
                if (e) {
            ...
            readNumber(t) {
                let r = this.state.pos, e = this.state.curPosition(), s = !1, i = !1, a = !1, n = !1, o = !1;
                ...
                if (c === 46 && !o && (++this.state.pos, this.readInt(10), s = !0, c = this.input.charCodeAt(this.state.pos)), (c === 69 || c === 101) && !o && (c = this.input.charCodeAt(++this.state.pos), (c === 43 || c === 45) && ++this.state.pos, this.readInt(10) === null && this.raise(p.InvalidOrMissingExponent, {at: e}), s = !0, n = !0, c = this.input.charCodeAt(this.state.pos)), c === 110 && ((s || u) && this.raise(p.InvalidBigIntLiteral, {at: e}), ++this.state.pos, i = !0), c === 109 && (this.expectPlugin("decimal", this.state.curPosition()), (n || u) && this.raise(p.InvalidDecimal, {at: e}), ++this.state.pos, a = !0), Pe(this.codePointAtPos(this.state.pos))) throw this.raise(p.NumberIdentifier, {at: this.state.curPosition()});
            ...
            readCodePoint(t) {
                let {
                    code: r,
                    pos: e
                } = Rr(this.input, this.state.pos, this.state.lineStart, this.state.curLine, t, this.errorHandlers_readCodePoint);
            ...
            readString(t) {
                let {
                    ...
                    curLine: s,
                    lineStart: i
                } = Mr(t === 34 ? "double" : "single", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_string);
            ...
            readTemplateToken() {
                let t = this.input[this.state.pos], {
                    ...
                    curLine: i,
                    lineStart: a
                } = Mr("template", this.input, this.state.pos + 1, this.state.lineStart, this.state.curLine, this.errorHandlers_readStringContents_template);
            ...
            readWord1(t) {
                ...
                for (t !== void 0 && (this.state.pos += t <= 65535 ? 1 : 2); this.state.pos < this.length;) {
                    ...
                    if (je(i)) this.state.pos += i <= 65535 ? 1 : 2; else if (i === 92) {
            ...
            checkKeywordEscapes() {
                ...
                Ee(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, {
            ...
            raiseOverwrite(t, r) {
                let {at: e} = r, s = pt(r, Al), i = e instanceof Ce ? e : e.loc.start, a = i.index,
                    n = this.state.errors;
            ...
            expectOnePlugin(t) {
                if (!t.some(r => this.hasPlugin(r))) throw this.raise(p.MissingOneOfPlugins, {
                    at: this.state.startLoc,
                    missingPlugin: t
                })
            }
            ...
            exit() {
                ...
                for (let [e, s] of Array.from(t.undefinedPrivateNames)) r ? r.undefinedPrivateNames.has(e) || r.undefinedPrivateNames.set(e, s) : this.parser.raise(p.InvalidPrivateFieldResolution, {
                    at: s,
                    identifierName: e
                })
            }
            ...
            usePrivateName(t, r) {
                ...
                e ? e.undefinedPrivateNames.set(t, r) : this.parser.raise(p.InvalidPrivateFieldResolution, {
                    at: r,
                    identifierName: t
                })
            }
            ...
            recordAsyncArrowParametersError(t) {
                ...
                for (; i.canBeArrowParameterDeclaration();) i.type === ds && i.recordDeclarationError(p.AwaitBindingIdentifier, {at: r}), i = e[--s]
            }
        ...
        var Dl = class extends vl {
            ...
            semicolon() {
                ((arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !0) ? this.isLineTerminator() : this.eat(13)) || this.raise(p.MissingSemicolon, {at: this.state.lastTokEndLoc})
            }
            ...
            tryParse(t) {
                let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : this.state.clone(),
                    e = {node: null};
                try {
                    let s = t(function () {
                    ...
                    if (s === e) return {node: e.node, error: null, thrown: !1, aborted: !0, failState: i};
                    throw s
                }
            }
            ...
            checkExpressionErrors(t, r) {
                if (!t) return !1;
                let {shorthandAssignLoc: e, doubleProtoLoc: s, privateKeyLoc: i, optionalParametersLoc: a} = t,
                    n = !!e || !!s || !!a || !!i;
                if (!r) return n;
            ...
            initializeScopes() {
                let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : this.options.sourceType === "module",
                    r = this.state.labels;
                this.state.labels = [];
        ...
        var Ol = class extends Dl {
            ...
            Bl = new Set(["_", "any", "bool", "boolean", "empty", "extends", "false", "interface", "mixed", "null", "number", "static", "string", "true", "typeof", "void"]),
            D = ge`flow`({
                AmbiguousConditionalArrow: "Ambiguous expression: wrap the arrow functions in parentheses to disambiguate.",
                AmbiguousDeclareModuleKind: "Found both `declare module.exports` and `declare export` in the same module. Modules can only have 1 since they are either an ES module or they are a CommonJS module.",
                AssignReservedType: t => {
        ...
        var jl = /\*?\s*@((?:no)?flow)\b/, ql = t => class extends t {
            ...
            flowParseDeclareVariable(e) {
                return this.next(), e.id = this.flowParseTypeAnnotatableIdentifier(!0), this.scope.declareName(e.id.name, At, e.id.loc.start), this.semicolon(), this.finishNode(e, "DeclareVariable")
            }
            ...
            flowParseDeclareModule(e) {
                ...
                for (this.expect(5); !this.match(8);) {
                    ...
                    this.match(83) ? (this.next(), !this.isContextual(128) && !this.match(87) && this.raise(D.InvalidNonTypeImportInDeclareModule, {at: this.state.lastTokStartLoc}), super.parseImport(o)) : (this.expectContextual(123, D.UnsupportedStatementInDeclareModule), o = this.flowParseDeclare(o, !0)), i.push(o)
                }
                this.scope.exit(), this.expect(8), this.finishNode(s, "BlockStatement");
                let a = null, n = !1;
                return i.forEach(o => {
                    Ml(o) ? (a === "CommonJS" && this.raise(D.AmbiguousDeclareModuleKind, {at: o}), a = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(D.DuplicateDeclareModuleExports, {at: o}), a === "ES" && this.raise(D.AmbiguousDeclareModuleKind, {at: o}), a = "CommonJS", n = !0)
            ...
            flowParseInterfaceish(e, s) {
                if (e.id = this.flowParseRestrictedIdentifier(!s, !0), this.scope.declareName(e.id.name, s ? Ir : He, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.extends = [], e.implements = [], e.mixins = [], this.eat(81)) do e.extends.push(this.flowParseInterfaceExtends()); while (!s && this.eat(12));
                if (s) {
                    if (this.eatContextual(115)) do e.mixins.push(this.flowParseInterfaceExtends()); while (this.eat(12));
            ...
            flowParseTypeAlias(e) {
                return e.id = this.flowParseRestrictedIdentifier(!1, !0), this.scope.declareName(e.id.name, He, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.right = this.flowParseTypeInitialiser(29), this.semicolon(), this.finishNode(e, "TypeAlias")
            }

            flowParseOpaqueType(e, s) {
                return this.expectContextual(128), e.id = this.flowParseRestrictedIdentifier(!0, !0), this.scope.declareName(e.id.name, He, e.id.loc.start), this.match(47) ? e.typeParameters = this.flowParseTypeParameterDeclaration() : e.typeParameters = null, e.supertype = null, this.match(14) && (e.supertype = this.flowParseTypeInitialiser(14)), e.impltype = null, s || (e.impltype = this.flowParseTypeInitialiser(29)), this.semicolon(), this.finishNode(e, "OpaqueType")
            }

            flowParseTypeParameter() {
                let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, s = this.state.startLoc,
                    i = this.startNode(), a = this.flowParseVariance(), n = this.flowParseTypeAnnotatableIdentifier();
            ...
            flowParseObjectType(e) {
                let {allowStatic: s, allowExact: i, allowSpread: a, allowProto: n, allowInexact: o} = e,
                    u = this.state.inType;
                this.state.inType = !0;
                ...
                for (i && this.match(6) ? (this.expect(6), y = 9, g = !0) : (this.expect(5), y = 8, g = !1), c.exact = g; !this.match(y);) {
                    let j = !1, q = null, G = null, J = this.startNode();
            ...
            flowParseFunctionTypeParam(e) {
                let s = null, i = !1, a = null, n = this.startNode(), o = this.lookahead(), u = this.state.type === 78;
                return o.type === 14 || o.type === 17 ? (u && !e && this.raise(D.ThisParamMustBeFirst, {at: n}), s = this.parseIdentifier(u), this.eat(17) && (i = !0, u && this.raise(D.ThisParamMayNotBeOptional, {at: n})), a = this.flowParseTypeInitialiser()) : a = this.flowParseType(), n.name = s, n.optional = i, n.typeAnnotation = a, this.finishNode(n, "FunctionTypeParam")
            }
            ...
            flowParsePrimaryType() {
                let e = this.state.startLoc, s = this.startNode(), i, a, n = !1, o = this.state.noAnonFunctionType;
                switch (this.state.type) {
                    ...
                    default:
                        ...
                        } else if (R(this.state.type)) return this.isContextual(127) ? this.flowParseInterfaceType() : this.flowIdentToTypeAnnotation(e, s, this.parseIdentifier())
                }
                this.unexpected()
            }
            ...
            parseConditional(e, s, i) {
                ...
                this.expect(17);
                let a = this.state.clone(), n = this.state.noArrowAt, o = this.startNodeAt(s), {
                    consequent: u,
                    failed: c
                } = this.tryParseConditionalConsequent(), [y, g] = this.getArrowLikeExpressions(u);
                if (c || g.length > 0) {
                    let T = [...n];
                    if (g.length > 0) {
                    ...
                    c && y.length > 1 && this.raise(D.AmbiguousConditionalArrow, {at: a.startLoc}), c && y.length === 1 && (this.state = a, T.push(y[0].start), this.state.noArrowAt = T, {
                        consequent: u,
                        failed: c
                    } = this.tryParseConditionalConsequent())
                }
                return this.getArrowLikeExpressions(u, !0), this.state.noArrowAt = n, this.expect(14), o.test = e, o.consequent = u, o.alternate = this.forwardNoArrowParamsConversionAt(o, () => this.parseMaybeAssign(void 0, void 0)), this.finishNode(o, "ConditionalExpression")
            }
            ...
            getArrowLikeExpressions(e, s) {
                ...
                return s ? (a.forEach(n => this.finishArrowValidation(n)), [a, []]) : Rl(a, n => n.params.every(o => this.isAssignable(o, !0)))
            }

            finishArrowValidation(e) {
                var s;
                this.toAssignableList(e.params, (s = e.extra) == null ? void 0 : s.trailingCommaLoc, !1), this.scope.enter(Ae | es), super.checkParams(e, !1, !0), this.scope.exit()
            }
            ...
            readIterator() {
                ...
                (!this.isIterator(e) || !this.state.inType) && this.raise(p.InvalidIdentifier, {
                    at: this.state.curPosition(),
                    identifierName: s
            ...
            parseImportSpecifierLocal(e, s, i) {
                s.local = ys(e) ? this.flowParseRestrictedIdentifier(!0, !0) : this.parseIdentifier(), e.specifiers.push(this.finishImportSpecifier(s, i))
            }
            ...
            parseImportSpecifier(e, s, i, a, n) {
                ...
                if (this.isContextual(93) && !this.isLookaheadContextual("as")) {
                    ...
                    if (u !== null && se(this.state.type)) e.imported = this.parseIdentifier(!0), e.importKind = u; else {
            ...
            parseSubscripts(e, s, i) {
                if (e.type === "Identifier" && e.name === "async" && this.state.noArrowAt.indexOf(s.index) !== -1) {
                    ...
                    a.callee = e, a.arguments = super.parseCallExpressionArguments(11, !1), e = this.finishNode(a, "CallExpression")
                } else if (e.type === "Identifier" && e.name === "async" && this.match(47)) {
                    let a = this.state.clone(),
                        n = this.tryParse(u => this.parseAsyncArrowWithTypeParameters(s) || u(), a);
            ...
            parseSubscript(e, s, i, a) {
                if (this.match(18) && this.isLookaheadToken_lt()) {
                    ...
                    let n = this.startNodeAt(s);
                    n.callee = e;
                    let o = this.tryParse(() => (n.typeArguments = this.flowParseTypeParameterInstantiationCallOrNew(), this.expect(10), n.arguments = super.parseCallExpressionArguments(11, !1), a.optionalChainMember && (n.optional = !1), this.finishCallExpression(n, a.optionalChainMember)));
            ...
            hasFlowCommentCompletion() {
                if (this.input.indexOf("*/", this.state.pos) === -1) throw this.raise(p.UnterminatedComment, {at: this.state.curPosition()})
            }
            ...
            flowEnumMemberRaw() {
                let e = this.state.startLoc, s = this.parseIdentifier(!0),
            ...
            flowEnumMembers(e) {
                let {enumName: s, explicitType: i} = e, a = new Set,
                    n = {booleanMembers: [], numberMembers: [], stringMembers: [], defaultedMembers: []}, o = !1;
                for (; !this.match(8);) {
                    if (this.eat(21)) {
                        o = !0;
                        break
            ...
            flowEnumParseExplicitType(e) {
                ...
                if (!R(this.state.type)) throw this.raise(D.EnumInvalidExplicitTypeUnknownSupplied, {
                    at: this.state.startLoc,
                    enumName: s
                });
            ...
            flowEnumBody(e, s) {
                ...
                switch (e.hasUnknownMembers = u, n) {
                    ...
                    default: {
                        ...
                        e.explicitType = !1;
                        let y = o.booleanMembers.length, g = o.numberMembers.length, T = o.stringMembers.length,
                        ...
                        if (!g && !T && y >= C) {
                            for (let j of o.defaultedMembers) this.flowEnumErrorBooleanMemberNotInitialized(j.loc.start, {
                                enumName: i,
                                memberName: j.id.name
                            });
                            return e.members = o.booleanMembers, this.expect(8), this.finishNode(e, "EnumBooleanBody")
                        } else if (!y && !T && g >= C) {
                            for (let j of o.defaultedMembers) this.flowEnumErrorNumberMemberNotInitialized(j.loc.start, {
                                enumName: i,
                                memberName: j.id.name
                            });
        ...
        function Ke(t) {
            ...
            if (t.type === "JSXMemberExpression") return Ke(t.object) + "." + Ke(t.property);
        ...
        var $l = t => class extends t {
                jsxReadToken() {
                    ...
                    for (; ;) {
                        if (this.state.pos >= this.length) throw this.raise(Fe.UnterminatedJsxContent, {at: this.state.startLoc});
                        let i = this.input.charCodeAt(this.state.pos);
                        switch (i) {
                            case 60:
                            case 123:
                            ...
                            case 125:
                            default:
                                Ze(i) ? (e += this.input.slice(s, this.state.pos), e += this.jsxReadNewLine(!0), s = this.state.pos) : ++this.state.pos
                        }
                    }
                }
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i
                ...
                jsxReadWord() {
                    let e, s = this.state.pos;
                    do e = this.input.charCodeAt(++this.state.pos); while (je(e) || e === 45);
                ...
                jsxParseElementAt(e) {
                    ...
                    if (!a.selfClosing) {
                        ...
                        we(a) && !we(n) && n !== null ? this.raise(Fe.MissingClosingTagFragment, {at: n}) : !we(a) && we(n) ? this.raise(Fe.MissingClosingTagElement, {
                            at: n,
                            openingTagName: Ke(a.name)
                        }) : !we(a) && !we(n) && Ke(n.name) !== Ke(a.name) && this.raise(Fe.MissingClosingTagElement, {
                            at: n,
                            openingTagName: Ke(a.name)
                        })
                    }
                    if (we(a) ? (s.openingFragment = a, s.closingFragment = n) : (s.openingElement = a, s.closingElement = n), s.children = i, this.match(47)) throw this.raise(Fe.UnwrappedAdjacentJSXElements, {at: this.state.startLoc});
                ...
                updateContext(e) {
                    ...
                    } else this.state.canStartJSXElement = H(i)
                }
            }, Hl = class extends hs {
                constructor() {
                ...
                createScope(t) {
                    return this.importsStack.push(new Set), new Hl(t)
                }

                enter(t) {
                    t == $e && this.importsStack.push(new Set), super.enter(t)
                }
                ...
                hasImport(t, r) {
                    ...
                    if (!r && e > 1) {
                        for (let s = 0; s < e - 1; s++) if (this.importsStack[s].has(t)) return !0
                    }
                    return !1
                }
                ...
                declareName(t, r, e) {
                    if (r & Xe) {
                        this.hasImport(t, !0) && this.parser.raise(p.VarRedeclaration, {
                            at: e,
                            identifierName: t
                ...
                isRedeclaredInScope(t, r, e) {
                    ...
                    return e & gt && t.classes.has(r) ? t.lexical.has(r) ? !!(e & me) : !1 : e & ke && t.types.has(r) ? !0 : super.isRedeclaredInScope(t, r, e)
                }
            ...
            Kr = t => t.type === "ParenthesizedExpression" ? Kr(t.expression) : t, Kl = class extends Ol {
                toAssignable(t) {
                ...
                toAssignableObjectExpressionProp(t, r, e) {
                    if (t.type === "ObjectMethod") this.raise(t.kind === "get" || t.kind === "set" ? p.PatternHasAccessor : p.PatternHasMethod, {at: t.key}); else if (t.type === "SpreadElement") {
                        t.type = "RestElement";
                        let s = t.argument;
                ...
                parseBindingList(t, r, e) {
                    ...
                    for (; !this.eat(t);) if (a ? a = !1 : this.expect(12), s && this.match(12)) i.push(null); else {
                        ...
                        if (this.match(21)) {
                            ...
                            let n = [];
                            for (this.match(26) && this.hasPlugin("decorators") && this.raise(p.UnsupportedParameterDecorator, {at: this.state.startLoc}); this.match(26);) n.push(this.parseDecorator());
                ...
                checkLVal(t, r) {
                    ...
                    let [y, g] = Array.isArray(c) ? c : [c, u === "ParenthesizedExpression"],
                        T = u === "ArrayPattern" || u === "ObjectPattern" || u === "ParenthesizedExpression" ? {type: u} : e;
                    for (let C of [].concat(t[y])) C && this.checkLVal(C, {
                        in: T,
                        binding: s,
                        checkClashes: i,
                        strictModeChanged: a,
                ...
                checkIdentifier(t, r) {
                    let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
                    this.state.strict && (e ? vr(t.name, this.inModule) : Tr(t.name)) && (r === be ? this.raise(p.StrictEvalArguments, {
                        at: t,
                        referenceName: t.name
                    }) : this.raise(p.StrictEvalArgumentsBinding, {
                        at: t,
                        bindingName: t.name
                    })), r & Pt && t.name === "let" && this.raise(p.LetInLexicalBinding, {at: t}), r & be || this.declareNameFromIdentifier(t, r)
                }
        ...
        var w = ge`typescript`({
            ...
            DuplicateAccessibilityModifier: t => {
                let {modifier: r} = t;
        ...
        var Yl = t => class extends t {
            ...
            tsParseModifiers(e, s) {
                let {
                    allowedModifiers: i,
                    disallowedModifiers: a,
                    stopOnStartOfClassStaticBlock: n,
                    errorTemplate: o = w.InvalidModifierOnTypeMember
                } = e, u = (y, g, T, C) => {
                    g === T && s[C] && this.raise(w.InvalidModifiersOrder, {at: y, orderedModifiers: [T, C]})
                }, c = (y, g, T, C) => {
                    (s[T] && g === C || s[C] && g === T) && this.raise(w.IncompatibleModifiers, {
                        at: y,
                        modifiers: [T, C]
                    })
                };
                for (; ;) {
                    ...
                    if (!g) break;
                    Gr(g) ? s.accessibility ? this.raise(w.DuplicateAccessibilityModifier, {
                        at: y,
                        modifier: g
                    }) : (u(y, g, g, "override"), u(y, g, g, "static"), u(y, g, g, "readonly"), s.accessibility = g) : Xl(g) ? (s[g] && this.raise(w.DuplicateModifier, {
                        at: y,
                        modifier: g
                    }), s[g] = !0, u(y, g, "in", "out")) : (Object.hasOwnProperty.call(s, g) ? this.raise(w.DuplicateModifier, {
                        at: y,
                        modifier: g
            ...
            tsParseDelimitedList(e, s, i) {
                return Gl(this.tsParseDelimitedListWorker(e, s, !0, i))
            }
            ...
            tsParseTypeParameters(e) {
                ...
                let i = {value: -1};
                return s.params = this.tsParseBracketedList("TypeParametersOrArguments", this.tsParseTypeParameter.bind(this, e), !1, !0, i), s.params.length === 0 && this.raise(w.EmptyTypeParameters, {at: s}), i.value !== -1 && this.addExtra(s, "trailingComma", i.value), this.finishNode(s, "TSTypeParameterDeclaration")
            }
            ...
            tsParseBindingListForSignature() {
                return super.parseBindingList(11, 41, 2).map(e => (e.type !== "Identifier" && e.type !== "RestElement" && e.type !== "ObjectPattern" && e.type !== "ArrayPattern" && this.raise(w.UnsupportedSignatureParameterKind, {
                    at: e,
                    type: e.type
                }), e))
            }
            ...
            tsParsePropertyOrMethodSignature(e, s) {
                ...
                if (this.match(10) || this.match(47)) {
                    ...
                    if (a.kind === "get") a[n].length > 0 && (this.raise(p.BadGetterArity, {at: this.state.curPosition()}), this.isThisParam(a[n][0]) && this.raise(w.AccesorCannotDeclareThisParameter, {at: this.state.curPosition()})); else if (a.kind === "set") {
                        if (a[n].length !== 1) this.raise(p.BadSetterArity, {at: this.state.curPosition()}); else {
                            let u = a[n][0];
            ...
            tsParseTupleElementType() {
                let {startLoc: e} = this.state, s = this.eat(21), i, a, n, o,
                    c = se(this.state.type) ? this.lookaheadCharCode() : null;
            ...
            tsParseTypeOrTypePredicateAnnotation(e) {
                return this.tsInType(() => {
                    ...
                    if (!n) return a ? (i.parameterName = this.parseIdentifier(), i.asserts = a, i.typeAnnotation = null, s.typeAnnotation = this.finishNode(i, "TSTypePredicate"), this.finishNode(s, "TSTypeAnnotation")) : this.tsParseTypeAnnotation(!1, s);
            ...
            tsParseTypePredicateAsserts() {
                ...
                return this.next(), !R(this.state.type) && !this.match(78) ? !1 : (e && this.raise(p.InvalidEscapedReservedWord, {
            ...
            tsParseInterfaceDeclaration(e) {
                ...
                this.expectContextual(127), s.declare && (e.declare = !0), R(this.state.type) ? (e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Zo)) : (e.id = null, this.raise(w.MissingInterfaceName, {at: this.state.startLoc})), e.typeParameters = this.tsTryParseTypeParameters(this.tsParseInOutConstModifiers), this.eat(81) && (e.extends = this.tsParseHeritageClause("extends"));
                let i = this.startNode();
            ...
            tsParseEnumDeclaration(e) {
                let s = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
                return s.const && (e.const = !0), s.declare && (e.declare = !0), this.expectContextual(124), e.id = this.parseIdentifier(), this.checkIdentifier(e.id, e.const ? sl : Nr), this.expect(5), e.members = this.tsParseDelimitedList("EnumMembers", this.tsParseEnumMember.bind(this)), this.expect(8), this.finishNode(e, "TSEnumDeclaration")
            }

            tsParseModuleBlock() {
                let e = this.startNode();
                return this.scope.enter(qe), this.expect(5), super.parseBlockOrModuleBlockBody(e.body = [], void 0, !0, 8), this.scope.exit(), this.finishNode(e, "TSModuleBlock")
            }
            ...
            tsParseModuleOrNamespaceDeclaration(e) {
                ...
                } else this.scope.enter($e), this.prodParam.enter(ze), e.body = this.tsParseModuleBlock(), this.prodParam.exit(), this.scope.exit();
            ...
            tsParseImportEqualsDeclaration(e, s) {
                e.isExport = s || !1, e.id = this.parseIdentifier(), this.checkIdentifier(e.id, Xe), this.expect(29);
            ...
            tsTryParseDeclare(e) {
                ...
                return this.isContextual(99) && (s = 74, i = "let"), this.tsInAmbientContext(() => {
                    if (s === 68) return e.declare = !0, super.parseFunctionStatement(e, !1, !1);
                    if (s === 80) return e.declare = !0, this.parseClass(e, !0, !1);
                    if (s === 124) return this.tsParseEnumDeclaration(e, {declare: !0});
                    if (s === 110) return this.tsParseAmbientExternalModuleDeclaration(e);
                    if (s === 75 || s === 74) return !this.match(75) || !this.isLookaheadContextual("enum") ? (e.declare = !0, this.parseVarStatement(e, i || this.state.value, !0)) : (this.expect(75), this.tsParseEnumDeclaration(e, {
                        const: !0,
                        declare: !0
                    }));
                    if (s === 127) {
                        let a = this.tsParseInterfaceDeclaration(e, {declare: !0});
                        if (a) return a
                    }
                    if (R(s)) return this.tsParseDeclaration(e, this.state.value, !0, null)
                })
            }
            ...
            tsParseDeclaration(e, s, i, a) {
                switch (s) {
                    case"abstract":
                        if (this.tsCheckLineTerminator(i) && (this.match(80) || R(this.state.type))) return this.tsParseAbstractDeclaration(e, a);
                        break;
                    case"module":
                        if (this.tsCheckLineTerminator(i)) {
                            if (this.match(131)) return this.tsParseAmbientExternalModuleDeclaration(e);
                            if (R(this.state.type)) return this.tsParseModuleOrNamespaceDeclaration(e)
                        }
                        break;
                    case"namespace":
                        if (this.tsCheckLineTerminator(i) && R(this.state.type)) return this.tsParseModuleOrNamespaceDeclaration(e);
                        break;
                    case"type":
                        if (this.tsCheckLineTerminator(i) && R(this.state.type)) return this.tsParseTypeAliasDeclaration(e);
                        break
                }
            }
            ...
            tsDisallowOptionalPattern(e) {
                for (let s of e.params) s.type !== "Identifier" && s.optional && !this.state.isAmbientContext && this.raise(w.PatternIsOptional, {at: s})
            }
                ...
                if (this.match(47) || this.match(51)) {
                    let o, u = this.tsTryParseAndCatch(() => {
                        ...
                        if (!i && this.eat(10)) {
                            ...
                            return T.callee = e, T.arguments = this.parseCallExpressionArguments(11, !1), this.tsCheckForInvalidTypeCasts(T.arguments), T.typeParameters = c, a.optionalChainMember && (T.optional = n), this.finishCallExpression(T, a.optionalChainMember)
                        }
                        let y = this.state.type;
                        if (y === 48 || y === 52 || y !== 10 && X(y) && !this.hasPrecedingLineBreak()) return;
                        let g = this.startNodeAt(s);
                        return g.expression = e, g.typeParameters = c, this.finishNode(g, "TSInstantiationExpression")
                    });
                    if (o && this.unexpected(o, 10), u) return u.type === "TSInstantiationExpression" && (this.match(16) || this.match(18) && this.lookaheadCharCode() !== 40) && this.raise(w.InvalidPropertyAccessAfterInstantiationExpression, {at: this.state.startLoc}), u
                }
                return super.parseSubscript(e, s, i, a)
            }
            ...
            parseExprOp(e, s, i) {
                ...
                if (Re(58) > i && !this.hasPrecedingLineBreak() && (this.isContextual(93) || (a = this.isContextual(118)))) {
                    let n = this.startNodeAt(s);
                    return n.expression = e, n.typeAnnotation = this.tsInType(() => (this.next(), this.match(75) ? (a && this.raise(p.UnexpectedKeyword, {
                        at: this.state.startLoc,
                        keyword: "const"
                    }), this.tsParseTypeReference()) : this.tsParseType())), this.finishNode(n, a ? "TSSatisfiesExpression" : "TSAsExpression"), this.reScan_lt_gt(), this.parseExprOp(n, s, i)
                }
            ...
            parseImport(e) {
                if (e.importKind = "value", R(this.state.type) || this.match(55) || this.match(5)) {
                    let i = this.lookahead();
                    if (this.isContextual(128) && i.type !== 12 && i.type !== 97 && i.type !== 29 && (e.importKind = "type", this.next(), i = this.lookahead()), R(this.state.type) && i.type === 29) return this.tsParseImportEqualsDeclaration(e)
                }
            ...
            parseVarStatement(e, s) {
                let i = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, {isAmbientContext: a} = this.state,
                    n = super.parseVarStatement(e, s, i || a);
                if (!a) return n;
                for (let {
                    id: o,
                    init: u
                } of n.declarations) u && (s !== "const" || o.typeAnnotation ? this.raise(w.InitializerNotAllowedInAmbientContext, {at: u}) : Zl(u, this.hasPlugin("estree")) || this.raise(w.ConstInitiailizerMustBeStringOrNumericLiteralOrLiteralEnumReference, {at: u}));
                return n
            }
            ...
            parseClassMemberWithIsStatic(e, s, i, a) {
                ...
                if (n) {
                    e.body.push(n), s.abstract && this.raise(w.IndexSignatureHasAbstract, {at: s}), s.accessibility && this.raise(w.IndexSignatureHasAccessibility, {
                        at: s,
                        modifier: s.accessibility
                    }), s.declare && this.raise(w.IndexSignatureHasDeclare, {at: s}), s.override && this.raise(w.IndexSignatureHasOverride, {at: s});
                    return
                }
            ...
            parsePostMemberNameModifiers(e) {
                this.eat(17) && (e.optional = !0), e.readonly && this.match(10) && this.raise(w.ClassMethodHasReadonly, {at: e}), e.declare && this.match(10) && this.raise(w.ClassMethodHasDeclare, {at: e})
            }
            ...
            parseExportDeclaration(e) {
                ...
                if (i && (this.isContextual(123) || !this.shouldParseExportDeclaration())) throw this.raise(w.ExpectedAmbientAfterExportDeclare, {at: this.state.startLoc});
            ...
            parseClassProperty(e) {
                if (this.parseClassPropertyAnnotation(e), this.state.isAmbientContext && !(e.readonly && !e.typeAnnotation) && this.match(29) && this.raise(w.DeclareClassFieldHasInitializer, {at: this.state.startLoc}), e.abstract && this.match(29)) {
                    let {key: s} = e;
                    this.raise(w.AbstractPropertyHasInitializer, {
                        at: this.state.startLoc,
            ...
            parseClassPrivateProperty(e) {
                return e.abstract && this.raise(w.PrivateElementHasAbstract, {at: e}), e.accessibility && this.raise(w.PrivateElementHasAccessibility, {
                    at: e,
            ...
            pushClassMethod(e, s, i, a, n, o) {
                ...
                let {declare: c = !1, kind: y} = s;
                c && (y === "get" || y === "set") && this.raise(w.DeclareAccessor, {
                    at: s,
                    kind: y
                }), u && (s.typeParameters = u), super.pushClassMethod(e, s, i, a, n, o)
            }
            ...
            parseMaybeAssign(e, s) {
                ...
                if (!q.error && !q.aborted) return j && this.reportReservedArrowTypeParam(j), q.node;
                if (!T && (Wr(!this.hasPlugin("jsx")), C = this.tryParse(() => super.parseMaybeAssign(e, s), g), !C.error)) return C.node;
                if ((a = T) != null && a.node) return this.state = T.failState, T.node;
                if (q.node) return this.state = q.failState, j && this.reportReservedArrowTypeParam(j), q.node;
            ...
            isValidLVal(e, s, i) {
                return Wl({
                    ...
                    TSAsExpression: (i !== be || !s) && ["expression", !0],
                    TSSatisfiesExpression: (i !== be || !s) && ["expression", !0],
                    TSTypeAssertion: (i !== be || !s) && ["expression", !0]
            ...
            tsParseAbstractDeclaration(e, s) {
                ...
                if (this.isContextual(127)) {
                    if (!this.hasFollowingLineBreak()) return e.abstract = !0, this.raise(w.NonClassMethodPropertyHasAbstractModifer, {at: e}), this.tsParseInterfaceDeclaration(e)
            ...
            parseMethod(e, s, i, a, n, o, u) {
                ...
                if (c.abstract && (this.hasPlugin("estree") ? !!c.value.body : !!c.body)) {
                    let {key: g} = c;
                    this.raise(w.AbstractMethodHasImplementation, {
                        at: c,
            ...
            parseExportSpecifier(e, s, i, a) {
                return !s && a ? (this.parseTypeOnlyImportExportSpecifier(e, !1, i), this.finishNode(e, "ExportSpecifier")) : (e.exportKind = "value", super.parseExportSpecifier(e, s, i, a))
            }

            parseImportSpecifier(e, s, i, a, n) {
                return !s && a ? (this.parseTypeOnlyImportExportSpecifier(e, !0, i), this.finishNode(e, "ImportSpecifier")) : (e.importKind = "value", super.parseImportSpecifier(e, s, i, a, i ? Dr : Xe))
            }

            parseTypeOnlyImportExportSpecifier(e, s, i) {
                let a = s ? "imported" : "local", n = s ? "local" : "exported", o = e[a], u, c = !1, y = !0,
                    g = o.loc.start;
                if (this.isContextual(93)) {
                    ...
                    } else se(this.state.type) ? (y = !1, u = s ? this.parseIdentifier() : this.parseModuleExportName()) : (c = !0, o = C)
                } else se(this.state.type) && (c = !0, s ? (o = this.parseIdentifier(!0), this.isContextual(93) || this.checkReservedWord(o.name, o.loc.start, !0, !0)) : o = this.parseModuleExportName());
        ...
        function Ql(t) {
            ...
            return r && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? !1 : Xr(t.object)
        }
        ...
        var Yr = ge`placeholders`({
            ClassNameIsRequired: "A class name is required.",
            UnexpectedSpace: "Unexpected space in placeholder."
        }), th = t => class extends t {
            parsePlaceholder(e) {
                if (this.match(142)) {
                    let s = this.startNode();
            ...
            parseClass(e, s, i) {
                ...
                if (o) if (this.match(81) || this.match(142) || this.match(5)) e.id = o; else {
            ...
            isExportDefaultSpecifier() {
                if (this.match(65)) {
                    let e = this.nextTokenStart();
                    if (this.isUnparsedContextual(e, "from") && this.input.startsWith(Y(142), this.nextTokenStartSince(e + 4))) return !0
                }
        ...
        function Q(t, r) {
            ...
            return t.some(n => {
                if (typeof n == "string") return a && n === e;
                {
                    let [o, u] = n;
                    if (o !== e) return !1;
                    for (let c of i) if (u[c] !== s[c]) return !1;
                    return !0
                }
            })
        }
        ...
        function rh(t) {
            if (Q(t, "decorators")) {
                if (Q(t, "decorators-legacy")) throw new Error("Cannot use the decorators and decorators-legacy plugin together");
            ...
            if (Q(t, "flow") && Q(t, "typescript")) throw new Error("Cannot combine flow and typescript plugins.");
            if (Q(t, "placeholders") && Q(t, "v8intrinsic")) throw new Error("Cannot combine placeholders and v8intrinsic plugins.");
            if (Q(t, "pipelineOperator")) {
                ...
                if (r === "hack") {
                    if (Q(t, "placeholders")) throw new Error("Cannot combine placeholders plugin and Hack-style pipes.");
                    if (Q(t, "v8intrinsic")) throw new Error("Cannot combine v8intrinsic plugin and Hack-style pipes.");
            ...
            if (Q(t, "moduleAttributes")) {
                if (Q(t, "importAssertions")) throw new Error("Cannot combine importAssertions and moduleAttributes plugins.");
                if (Le(t, "moduleAttributes", "version") !== "may-2020") throw new Error("The 'moduleAttributes' plugin requires a 'version' option, representing the last proposal update. Currently, the only supported value is 'may-2020'.")
            }
            if (Q(t, "recordAndTuple") && Le(t, "recordAndTuple", "syntaxType") != null && !ei.includes(Le(t, "recordAndTuple", "syntaxType"))) throw new Error("The 'syntaxType' option of the 'recordAndTuple' plugin must be one of: " + ei.map(r => `'${r}'`).join(", "));
        ...
        var ti = {estree: Uo, jsx: $l, flow: ql, typescript: Yl, v8intrinsic: sh, placeholders: th},
            ih = Object.keys(ti), ah = class extends Kl {
                checkProto(t, r, e, s) {
                ...
                parseExprOp(t, r, e) {
                    if (this.isPrivateName(t)) {
                        ...
                        (e >= Re(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, {
                            at: t,
                            identifierName: i
                    ...
                    if (le(s) && (this.prodParam.hasIn || !this.match(58))) {
                        ...
                        if (i > e) {
                            ...
                            if (o && (i = Re(42)), this.next(), s === 39 && this.hasPlugin(["pipelineOperator", {proposal: "minimal"}]) && this.state.type === 96 && this.prodParam.hasAwait) throw this.raise(p.UnexpectedAwaitAfterPipelineBody, {at: this.state.startLoc});
                            a.right = this.parseExprOpRightExpr(s, i);
                            let u = this.finishNode(a, n || o ? "LogicalExpression" : "BinaryExpression"),
                                c = this.state.type;
                            if (o && (c === 41 || c === 42) || n && c === 40) throw this.raise(p.MixingCoalesceWithLogical, {at: this.state.startLoc});
                            ...
                            switch (this.getPluginOption("pipelineOperator", "proposal")) {
                                ...
                                case"smart":
                                    return this.withTopicBindingContext(() => {
                                        if (this.prodParam.hasYield && this.isContextual(106)) throw this.raise(p.PipeBodyIsTighter, {at: this.state.startLoc});
                ...
                parseHackPipeBody() {
                    ...
                    return Bo.has(e.type) && !((t = e.extra) != null && t.parenthesized) && this.raise(p.PipeUnparenthesizedBody, {
                        at: r,
                        type: e.type
                    }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, {at: r}), e
                }
                ...
                parseMaybeUnary(t, r) {
                    ...
                    if (s) {
                        ...
                        if ((this.hasPlugin("v8intrinsic") ? X(o) : X(o) && !this.match(54)) && !this.isAmbiguousAwait()) return this.raiseOverwrite(p.AwaitNotInAsyncContext, {at: e}), this.parseAwait(e)
                    }
                    return n
                }
                ...
                parseSubscripts(t, r, e) {
                    ...
                    do t = this.parseSubscript(t, r, e, s), s.maybeAsyncArrow = !1; while (!s.stop);
                    return t
                }
                ...
                parseSubscript(t, r, e, s) {
                    ...
                    if (ct(i)) return this.parseTaggedTemplateExpression(t, r, s);
                    let a = !1;
                    if (i === 18) {
                        if (e && (this.raise(p.OptionalChainingNoNew, {at: this.state.startLoc}), this.lookaheadCharCode() === 40)) return s.stop = !0, t;
                ...
                parseTaggedTemplateExpression(t, r, e) {
                    let s = this.startNodeAt(r);
                    return s.tag = t, s.quasi = this.parseTemplate(!0), e.optionalChainMember && this.raise(p.OptionalChainingNoTemplate, {at: r}), this.finishNode(s, "TaggedTemplateExpression")
                }
                ...
                finishCallExpression(t, r) {
                    if (t.callee.type === "Import") if (t.arguments.length === 2 && (this.hasPlugin("moduleAttributes") || this.expectPlugin("importAssertions")), t.arguments.length === 0 || t.arguments.length > 2) this.raise(p.ImportCallArity, {
                        at: t,
                        maxArgumentCount: this.hasPlugin("importAssertions") || this.hasPlugin("moduleAttributes") ? 2 : 1
                    }); else for (let e of t.arguments) e.type === "SpreadElement" && this.raise(p.ImportCallSpreadArgument, {at: e});
                ...
                parseAsyncArrowFromCallExpression(t, r) {
                    var e;
                    return this.resetPreviousNodeTrailingComments(r), this.expect(19), this.parseArrowExpression(t, r.arguments, !0, (e = r.extra) == null ? void 0 : e.trailingCommaLoc), r.innerComments && Ye(t, r.innerComments), r.callee.trailingComments && Ye(t, r.callee.trailingComments), t
                }
                ...
                parseExprAtom(t) {
                    ...
                    switch (s) {
                        ...
                        case 136:
                            return this.raise(p.PrivateInExpectedIn, {
                                at: this.state.startLoc,
                        ...
                        default:
                            if (R(s)) {
                                ...
                                if (!a && n.name === "async" && !this.canInsertSemicolon()) {
                                    ...
                                    if (R(o)) return this.lookaheadCharCode() === 61 ? this.parseAsyncArrowUnaryFunction(this.startNodeAtNode(n)) : n;
                ...
                parseTopicReferenceThenEqualsSign(t, r) {
                    ...
                    if (e) return this.state.type = t, this.state.value = r, this.state.pos--, this.state.end--, this.state.endLoc = re(this.state.endLoc, -1), this.parseTopicReference(e);
                    this.unexpected()
                }
                ...
                finishTopicReference(t, r, e, s) {
                    ...
                    } else throw this.raise(p.PipeTopicUnconfiguredToken, {at: r, token: Y(s)})
                }
                ...
                parseAsyncArrowUnaryFunction(t) {
                    ...
                    return this.prodParam.exit(), this.hasPrecedingLineBreak() && this.raise(p.LineTerminatorBeforeArrow, {at: this.state.curPosition()}), this.expect(19), this.parseArrowExpression(t, r, !0)
                }
                ...
                parseMetaProperty(t, r, e) {
                    ...
                    return t.property = this.parseIdentifier(!0), (t.property.name !== e || s) && this.raise(p.UnsupportedMetaProperty, {
                        at: t.property,
                        target: r.name,
                ...
                parseImportMetaProperty(t) {
                    ...
                    return this.next(), this.isContextual(100) && (this.inModule || this.raise(p.ImportMetaOutsideModule, {at: r}), this.sawUnambiguousESM = !0), this.parseMetaProperty(t, r, "meta")
                }
                ...
                parseParenAndDistinguishExpression(t) {
                    ...
                    let a = this.state.startLoc, n = [], o = new wt, u = !0, c, y;
                    for (; !this.match(11);) {
...
`), cooked: i === null ? null : i.slice(1, u)
                ...
                parseObjectLike(t, r, e, s) {
                    ...
                    let a = Object.create(null), n = !0, o = this.startNode();
                ...
                parsePropertyDefinition(t) {
                    let r = [];
                    if (this.match(26)) for (this.hasPlugin("decorators") && this.raise(p.UnsupportedPropertyDecorator, {at: this.state.startLoc}); this.match(26);) r.push(this.parseDecorator());
                    let e = this.startNode(), s = !1, i = !1, a;
                    ...
                    if (!n && !o && this.maybeAsyncOrAccessorProp(e)) {
                        let c = u.name;
                        c === "async" && !this.hasPrecedingLineBreak() && (s = !0, this.resetPreviousNodeTrailingComments(u), n = this.eat(55), this.parsePropertyName(e)), (c === "get" || c === "set") && (i = !0, this.resetPreviousNodeTrailingComments(u), e.kind = c, this.match(55) && (n = !0, this.raise(p.AccessorIsGenerator, {
                            at: this.state.curPosition(),
                            kind: c
                ...
                parseObjectProperty(t, r, e, s) {
                    ...
                    if (!t.computed && t.key.type === "Identifier") {
                        if (this.checkReservedWord(t.key.name, t.key.loc.start, !0, !1), e) t.value = this.parseMaybeDefault(r, Te(t.key)); else if (this.match(29)) {
                ...
                parsePropertyName(t, r) {
                    if (this.eat(0)) t.computed = !0, t.key = this.parseMaybeAssignAllowIn(), this.expect(3); else {
                        ...
                        if (se(e)) i = this.parseIdentifier(!0); else switch (e) {
                            case 132:
                ...
                parseFunctionBody(t, r) {
                    let e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1, s = r && !this.match(5);
                    if (this.expressionScope.enter($r()), s) t.body = this.parseMaybeAssign(), this.checkParams(t, !1, r, !1); else {
                        let i = this.state.strict, a = this.state.labels;
                        this.state.labels = [], this.prodParam.enter(this.prodParam.currentFlags() | zr), t.body = this.parseBlock(!0, !1, n => {
                ...
                isSimpleParamList(t) {
                    for (let r = 0, e = t.length; r < e; r++) if (!this.isSimpleParameter(t[r])) return !1;
                    return !0
                }

                checkParams(t, r, e) {
                    let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !0, i = !r && new Set,
                        a = {type: "FormalParameters"};
                    for (let n of t.params) this.checkLVal(n, {in: a, binding: At, checkClashes: i, strictModeChanged: s})
                }
                ...
                parseExprListItem(t, r, e) {
                    let s;
                    if (this.match(12)) t || this.raise(p.UnexpectedToken, {
                        at: this.state.curPosition(),
                        unexpected: ","
                ...
                if (typeof i == "number") {
                    {
                        if (i === 136) {
                            ...
                            t.splice(e, 1, new Se({
                                ...
                                startLoc: a.start,
                                endLoc: y
                            }), new Se({type: xe(130), value: o, start: c, end: u, startLoc: y, endLoc: a.end})), e++;
                            continue
                        }
                        if (ct(i)) {
                            let {loc: a, start: n, value: o, end: u} = s, c = n + 1, y = re(a.start, 1), g;
                            r.charCodeAt(n) === 96 ? g = new Se({
                                type: xe(22),
                                value: "`",
                                start: n,
                                end: c,
                                startLoc: a.start,
                                endLoc: y
                            }) : g = new Se({type: xe(8), value: "}", start: n, end: c, startLoc: a.start, endLoc: y});
                            let T, C, j, q;
                            i === 24 ? (C = u - 1, j = re(a.end, -1), T = o === null ? null : o.slice(1, -1), q = new Se({
                                type: xe(22),
                                value: "`",
                                start: C,
                                end: u,
                                startLoc: j,
                                endLoc: a.end
                            })) : (C = u - 2, j = re(a.end, -2), T = o === null ? null : o.slice(1, -2), q = new Se({
                                type: xe(23),
                                value: "${",
                                start: C,
                                end: u,
        ...
        var hh = class extends ah {
            ...
            parseProgram(t) {
                let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 137,
                    e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : this.options.sourceType;
                if (t.sourceType = e, t.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(t, !0, !0, r), this.inModule && !this.options.allowUndeclaredExports && this.scope.undefinedExports.size > 0) for (let [i, a] of Array.from(this.scope.undefinedExports)) this.raise(p.ModuleExportUndefined, {
                    at: a,
                    localName: i
                });
                let s;
            ...
            parseStatementOrSloppyAnnexBFunctionDeclaration() {
                let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1, r = 0;
            ...
            parseStatementContent(t, r) {
                ...
                switch (e) {
                    ...
                    default:
                        if (this.isAsyncFunction()) return i || this.raise(p.AsyncFunctionInSingleStatementContext, {at: this.state.startLoc}), this.next(), this.parseFunctionStatement(s, !0, !i && a)
                }
            ...
            parseDecorators(t) {
                ...
                if (this.match(82)) t || this.unexpected(), this.decoratorsEnabledBeforeExport() || this.raise(p.DecoratorExportClass, {at: this.state.startLoc}); else if (!this.canHaveLeadingDecorator()) throw this.raise(p.UnexpectedLeadingDecorator, {at: this.state.startLoc});
                return r
            }
            ...
            parseForStatement(t) {
                ...
                let r = null;
                if (this.isAwaitAllowed() && this.eatContextual(96) && (r = this.state.lastTokStartLoc), this.scope.enter(qe), this.expect(10), this.match(13)) return r !== null && this.unexpected(r), this.parseFor(t, null);
                let e = this.isContextual(99), s = this.isContextual(105) && !this.hasFollowingLineBreak(),
                ...
                let a = this.isContextual(95), n = new wt, o = this.parseExpression(!0, n), u = this.isContextual(101);
            ...
            parseCatchClauseParam() {
                ...
                return this.scope.enter(this.options.annexB && t.type === "Identifier" ? Er : 0), this.checkLVal(t, {
                    in: {type: "CatchClause"},
                    binding: Qo
                }), t
            }
            ...
            parseTryStatement(t) {
                if (this.next(), t.block = this.parseBlock(), t.handler = null, this.match(62)) {
                    let r = this.startNode();
                    this.next(), this.match(10) ? (this.expect(10), r.param = this.parseCatchClauseParam(), this.expect(11)) : (r.param = null, this.scope.enter(qe)), r.body = this.withSmartMixTopicForbiddingContext(() => this.parseBlock(!1, !1)), this.scope.exit(), t.handler = this.finishNode(r, "CatchClause")
                }
            ...
            parseLabeledStatement(t, r, e, s) {
                for (let a of this.state.labels) a.name === r && this.raise(p.LabelRedeclaration, {
                    at: e,
                    labelName: r
                });
            ...
            parseBlock() {
                let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : !1,
                    ...
                    e = arguments.length > 2 ? arguments[2] : void 0, s = this.startNode();
                return t && this.state.strictErrors.clear(), this.expect(5), r && this.scope.enter(qe), this.parseBlockBody(s, t, !1, 8, e), r && this.scope.exit(), this.finishNode(s, "BlockStatement")
            }
            ...
            parseForIn(t, r, e) {
                let s = this.match(58);
                return this.next(), s ? e !== null && this.unexpected(e) : t.await = e !== null, r.type === "VariableDeclaration" && r.declarations[0].init != null && (!s || !this.options.annexB || this.state.strict || r.kind !== "var" || r.declarations[0].id.type !== "Identifier") && this.raise(p.ForInOfLoopInitializer, {
                    at: r,
                    type: s ? "ForInStatement" : "ForOfStatement"
                }), r.type === "AssignmentPattern" && this.raise(p.InvalidLhs, {
                    at: r,
            ...
            parseVar(t, r, e) {
                let s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1, i = t.declarations = [];
                for (t.kind = e; ;) {
                    let a = this.startNode();
                    if (this.parseVarId(a, e), a.init = this.eat(29) ? r ? this.parseMaybeAssignDisallowIn() : this.parseMaybeAssignAllowIn() : null, a.init === null && !s && (a.id.type !== "Identifier" && !(r && (this.match(58) || this.isContextual(101))) ? this.raise(p.DeclarationMissingInitializer, {
                        at: this.state.lastTokEndLoc,
                        kind: "destructuring"
                    }) : e === "const" && !(this.match(58) || this.isContextual(101)) && this.raise(p.DeclarationMissingInitializer, {
                        at: this.state.lastTokEndLoc,
                        kind: "const"
            ...
            parseFunction(t) {
                let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0, e = r & 2, s = !!(r & 1),
                    i = s && !(r & 4), a = !!(r & 8);
                ...
                return this.state.maybeInArrowParameters = !1, this.scope.enter(Ae), this.prodParam.enter(St(a, t.generator)), s || (t.id = this.parseFunctionId()), this.parseFunctionParams(t, !1), this.withSmartMixTopicForbiddingContext(() => {
            ...
            parseClassBody(t, r) {
                ...
                let e = {hadConstructor: !1, hadSuperClass: t}, s = [], i = this.startNode();
                if (i.body = [], this.expect(5), this.withSmartMixTopicForbiddingContext(() => {
                    for (; !this.match(8);) {
                        if (this.eat(13)) {
                            if (s.length > 0) throw this.raise(p.DecoratorSemicolon, {at: this.state.lastTokEndLoc});
                            continue
                        }
                        if (this.match(26)) {
                ...
                }), this.state.strict = r, this.next(), s.length) throw this.raise(p.TrailingDecorator, {at: this.state.startLoc});
            ...
            parseClassMemberWithIsStatic(t, r, e, s) {
                ...
                let g = R(this.state.type) && !this.state.containsEsc, T = this.match(136),
                    C = this.parseClassElementName(r), j = this.state.startLoc;
                if (this.parsePostMemberNameModifiers(y), this.isClassMethod()) {
                    if (c.kind = "method", T) {
                        this.pushClassPrivateMethod(t, a, !1, !1);
                        return
                    }
                    let q = this.isNonstaticConstructor(i), G = !1;
            ...
            parseClassStaticBlock(t, r) {
                ...
                let i = r.body = [];
                this.parseBlockOrModuleBlockBody(i, void 0, !1, 8), this.prodParam.exit(), this.scope.exit(), this.state.labels = s, t.body.push(this.finishNode(r, "StaticBlock")), (e = r.decorators) != null && e.length && this.raise(p.DecoratorStaticBlock, {at: r})
            }
            ...
            pushClassPrivateMethod(t, r, e, s) {
                let i = this.parseMethod(r, e, s, !1, !1, "ClassPrivateMethod", !0);
                t.body.push(i);
            ...
            parseClassId(t, r, e) {
                ...
                if (R(this.state.type)) t.id = this.parseIdentifier(), r && this.declareNameFromIdentifier(t.id, s); else if (e || !r) t.id = null; else throw this.raise(p.MissingClassName, {at: this.state.startLoc})
            }
            ...
            parseExport(t, r) {
                let e = this.maybeParseExportDefaultSpecifier(t), s = !e || this.eat(12),
                    i = s && this.eatExportStar(t), a = i && this.maybeParseExportNamespaceSpecifier(t),
                    n = s && (!a || this.eat(12)), o = e || i;
                if (i && !a) {
                    if (e && this.unexpected(), r) throw this.raise(p.UnsupportedDecoratorExport, {at: t});
                ...
                let c;
                if (o || u) {
                    if (c = !1, r) throw this.raise(p.UnsupportedDecoratorExport, {at: t});
                    this.parseExportFrom(t, o)
                } else c = this.maybeParseExportDeclaration(t);
                if (o || u || c) {
                    var y;
                    let g = t;
                    if (this.checkExport(g, !0, !1, !!g.source), ((y = g.declaration) == null ? void 0 : y.type) === "ClassDeclaration") this.maybeTakeDecorators(r, g.declaration, g); else if (r) throw this.raise(p.UnsupportedDecoratorExport, {at: t});
                    return this.finishNode(g, "ExportNamedDeclaration")
                }
                if (this.eat(65)) {
                    let g = t, T = this.parseExportDefaultExpression();
                    if (g.declaration = T, T.type === "ClassDeclaration") this.maybeTakeDecorators(r, T, g); else if (r) throw this.raise(p.UnsupportedDecoratorExport, {at: t});
            ...
            parseExportDefaultExpression() {
                ...
                if (this.match(26)) return this.hasPlugin("decorators") && this.getPluginOption("decorators", "decoratorsBeforeExport") === !0 && this.raise(p.DecoratorBeforeExport, {at: this.state.startLoc}), this.parseClass(this.maybeTakeDecorators(this.parseDecorators(!1), this.startNode()), !0, !0);
                if (this.match(75) || this.match(74) || this.isLet()) throw this.raise(p.UnsupportedDefaultExport, {at: this.state.startLoc});
            ...
            isExportDefaultSpecifier() {
                ...
                if (R(t)) {
                    ...
                    if ((t === 128 || t === 127) && !this.state.containsEsc) {
                        ...
                        if (R(s) && s !== 97 || s === 5) return this.expectOnePlugin(["flow", "typescript"]), !1
                    }
                ...
                if (r) {
                    if (e) {
                        ...
                        if (this.checkDuplicateExports(a, o), !s && a.local) {
                            let {local: u} = a;
                            u.type !== "Identifier" ? this.raise(p.ExportBindingIsString, {
                                at: a,
                                localName: u.value,
                                exportName: o
            ...
            checkDuplicateExports(t, r) {
                this.exportedIdentifiers.has(r) && (r === "default" ? this.raise(p.DuplicateDefaultExport, {at: t}) : this.raise(p.DuplicateExport, {
                    at: t,
                    exportName: r
            ...
            parseModuleExportName() {
                if (this.match(131)) {
                    ...
                    return r && this.raise(p.ModuleExportNameHasLoneSurrogate, {
                        at: t,
            ...
            parseImport(t) {
                if (t.specifiers = [], !this.match(131)) {
                    ...
                    let s = !this.maybeParseDefaultImportSpecifier(t) || this.eat(12),
            ...
            parseAssertEntries() {
                ...
                do {
                    ...
                    let e = this.startNode(), s = this.state.value;
                    if (r.has(s) && this.raise(p.ModuleAttributesWithDuplicateKeys, {
                        at: this.state.startLoc,
                        key: s
                    }), r.add(s), this.match(131) ? e.key = this.parseStringLiteral(s) : e.key = this.parseIdentifier(!0), this.expect(14), !this.match(131)) throw this.raise(p.ModuleAttributeInvalidValue, {at: this.state.startLoc});
            ...
            maybeParseModuleAttributes() {
                ...
                do {
                    let e = this.startNode();
                    if (e.key = this.parseIdentifier(!0), e.key.name !== "type" && this.raise(p.ModuleAttributeDifferentFromType, {at: e.key}), r.has(e.key.name) && this.raise(p.ModuleAttributesWithDuplicateKeys, {
                        at: e.key,
                        key: e.key.name
                    }), r.add(e.key.name), this.expect(14), !this.match(131)) throw this.raise(p.ModuleAttributeInvalidValue, {at: this.state.startLoc});
            ...
            parseImportSpecifier(t, r, e, s, i) {
                if (this.eatContextual(93)) t.local = this.parseIdentifier(); else {
                    let {imported: a} = t;
                    if (r) throw this.raise(p.ImportBindingIsString, {at: t, importName: a.value});
        ...
        function fh(t) {
            let r = {};
            for (let e of Object.keys(t)) r[e] = xe(t[e]);
            return r
        }
    ...
    "src/language-js/parse/json.js"(l, h) {
        "use strict";
        U();
        var f = bo(), d = dr(), x = wo(), P = Io();

        function m() {
            let N = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, {allowComments: O = !0} = N;
            return function (_) {
                ...
                if (!O && f(I.comments)) throw E(I.comments[0], "Comment");
                return S(I), I
            }
        }
        ...
        function S(N) {
            switch (N.type) {
                case"ArrayExpression":
                    for (let O of N.elements) O !== null && S(O);
                    return;
                case"ObjectExpression":
                    for (let O of N.properties) S(O);
                    return;
                case"ObjectProperty":
                    if (N.computed) throw E(N.key, "Computed key");
                    if (N.shorthand) throw E(N.key, "Shorthand property");
                    N.key.type !== "Identifier" && S(N.key), S(N.value);
                    return;
                case"UnaryExpression": {
                    let {operator: O, argument: A} = N;
                    if (O !== "+" && O !== "-") throw E(N, `Operator '${N.operator}'`);
                    if (A.type === "NumericLiteral" || A.type === "Identifier" && (A.name === "Infinity" || A.name === "NaN")) return;
                    throw E(A, `Operator '${O}' before '${A.type}'`)
                }
                case"Identifier":
                    if (N.name !== "Infinity" && N.name !== "NaN" && N.name !== "undefined") throw E(N, `Identifier '${N.name}'`);
                    return;
                case"TemplateLiteral":
                    if (f(N.expressions)) throw E(N.expressions[0], "'TemplateLiteral' with expression");
                    for (let O of N.quasis) S(O);
                    return;
                case"NullLiteral":
                case"BooleanLiteral":
                case"NumericLiteral":
        ...
        var k = m(), L = {
            ...
            }), json5: x(k), "json-stringify": x({parse: m({allowComments: !1}), astFormat: "estree-json"})
        };
        h.exports = L
    }
}), Rf = $({
    "src/language-js/parse/babel.js"(l, h) {
        U();
        var f = xf(), d = ho(), x = Tf(), P = wo(), m = Io(), E = Mf(), S = _f(), k = {
            sourceType: "module",
            ...
            plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", ["decorators", {decoratorsBeforeExport: !1}], "importAssertions", "decimal", "moduleBlocks", "asyncDoExpressions", "regexpUnicodeSets", "destructuringPrivate", "decoratorAutoAccessors"],
            tokens: !0,
            ranges: !0
        }, L = ["recordAndTuple", {syntaxType: "hash"}], N = "v8intrinsic", O = [["pipelineOperator", {
            proposal: "hack",
            topicToken: "%"
        }], ["pipelineOperator", {proposal: "minimal"}], ["pipelineOperator", {proposal: "fsharp"}]], A = function (H) {
            let X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : k;
            return Object.assign(Object.assign({}, X), {}, {plugins: [...X.plugins, ...H]})
        }, _ = /@(?:no)?flow\b/;

        function W(H, X) {
            if (X.filepath && X.filepath.endsWith(".js.flow")) return !0;
            let ye = d(H);
            ye && (H = H.slice(ye.length));
            let ne = x(H, 0);
            return ne !== !1 && (H = H.slice(0, ne)), _.test(H)
        }
        ...
        function F(H) {
            for (var X = arguments.length, ye = new Array(X > 1 ? X - 1 : 0), ne = 1; ne < X; ne++) ye[ne - 1] = arguments[ne];
            return function (oe, Ee) {
                let le = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
                if ((le.parser === "babel" || le.parser === "__babel_estree") && W(oe, le)) return le.parser = "babel-flow", M(oe, Ee, le);
                let ue = ye;
        ...
        var z = F("parse", A(["jsx", "flow"])), M = F("parse", A(["jsx", ["flow", {all: !0, enums: !0}]])),
            V = F("parse", A(["jsx", "typescript"]), A(["typescript"])), ee = F("parse", A(["jsx", "flow", "estree"])),
            b = F("parseExpression", A(["jsx"])), B = F("parseExpression", A(["typescript"])),
            te = new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]),
        ...
        h.exports = {
            parsers: Object.assign(Object.assign({
                ...
                __js_expression: se,
                __vue_expression: se,
                __vue_ts_expression: _e,
                __vue_event_binding: R,
                __vue_ts_event_binding: ae,
                __babel_estree: P(ee)
            })
        }
    }
